...
There are **6** videos in this module.  You must watch the videos and complete the quiz questions in order to complete the module.The debt schedule is probably the most complex of all the schedules that you will need to build during the exam, so make sure that you are really clear on your approach going into the exam and do lots of practice well in advance.

**Step 1:** Download the Course Materials

-   [Revolver Exercise;](https://plumsolutions.com.au/wp-content/uploads/2020/07/Revolver-Exercise.xlsx) this accompanies the video on “Modelling the Revolver Line of Credit” (the completed version is on a hidden tab)
-   [Henderson Debt (blank)](https://plumsolutions.com.au/wp-content/uploads/2020/07/Henderson-Debt-blank.xlsx); this is the ending model from the last module, so you can continue with your own model, or pick this one up to begin with the last three videos in this module.
-   [Henderson Debt (completed)](https://plumsolutions.com.au/wp-content/uploads/2020/09/Henderson-Debt-completed.zip); this is the completed version of what the model should look like by the end of this module. Because it is a macro-enabled file, it has been uploaded via a zip folder.
