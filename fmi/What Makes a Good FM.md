...
-   We take a look at the attributes of a good model in terms of features and structure
-   You should also download the file “Model Assessment Checklist” which can be used to rate your models against the criteria outlined in this video

_Video length: 5 min 18 sec_

### Templates

[Download the Excel template](https://plumsolutions.com.au/wp-content/uploads/2017/12/Model-Assessment-Checklist.xls) for this video. Follow along with the video demonstration, and save your model. In this particular module you do not need to submit this model for review, however you do need to complete the quiz questions once you have completed the module.

### Additional Resources

-   See the section on “What Makes a Good Financial Model” in Chapter 3, **Page 65** of [Using Excel for Business and Financial Modelling](https://plumsolutions.com.au/using-excel-for-business-and-financial-modelling/).

### Transcript

[Download the Transcript](https://plumsolutions.com.au/wp-content/uploads/2018/01/4.2-What-Makes-a-Good-Financial-Model.pdf) for this video.
