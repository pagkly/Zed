...
MiFID II is a legislative framework instituted by the European Union (EU) to regulate financial markets in the bloc and improve protections for investors. Its aim is to standardize practices across the EU and restore confidence in the industry, especially after the [2008 financial crisis](https://www.investopedia.com/articles/economics/09/financial-crisis-review.asp). A revised version of the original MiFID, it rolled out on January 3, 2018, more than six years after the European Commission, the EU's executive branch, adopted a legislative proposal for it.
...
MiFID II harmonizes the application of oversight among member nations and broadens the scope of the regulations. In particular, it imposes more reporting requirements and tests in order to increase transparency and reduce the use of [dark pools](https://www.investopedia.com/terms/d/dark-pool.asp) (private financial exchanges that allow investors to trade without revealing their identities) and [over-the-counter (OTC) trading.](https://www.investopedia.com/terms/o/otc.asp) Under the new rules, the trading volume of a stock in a dark pool is limited to 8% over 12 months. The new regulations also target high-frequency trading. Algorithms used for automated trading have to be registered, tested and have circuit breakers included. 
