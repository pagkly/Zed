...
- Previous:
	- [[2020-08 ➡️ In what ways can we form useful relationships between notes#2020-06-26 - Ways we can form useful relationships between notes]]
	- [[2020-08 ➡️ In what ways can we form useful relationships between notes#2020-05-28 - In what ways can we form useful relationships between notes]]
%%
...
#### Tags with Saved Boolean Search
Saved Searches are another partial and robust solution. You can save a tag search like `#PermanentNotes` AND `#habits`. It could be saved in the app you are using, or in a special note, like an MOC or index [[+Home|The Index]].
