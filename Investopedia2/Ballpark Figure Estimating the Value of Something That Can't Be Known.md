...
> ## Excerpt
> A ballpark figure is a numerical approximation that is used in business or daily life as a stand-in when a more accurate reading is not available.

---

Ballpark Figure: Estimating the Value of Something That Can't Be Known
## What Is a Ballpark Figure?

A ballpark figure is a rough numerical estimate or approximation of the value of something that is otherwise unknown. Ballpark figures are commonly used by [accountants](https://www.investopedia.com/terms/a/accountant.asp), salespersons, and other professionals to estimate current or future results. A stockbroker could use a ballpark figure to estimate how much money a client might have at some point in the future, given a certain rate of growth. A salesperson could use a ballpark figure to estimate how long a product a customer was thinking about buying might be viable.
...
Ballpark figures are also used everywhere in the [business world](https://www.investopedia.com/articles/active-trading/111115/why-all-worlds-top-10-companies-are-american.asp), such as estimating how much it might cost to expand into a certain market, or how many years it might take for a company to be profitable or for sales to justify a large purchase. It can also be used to estimate public adoption of a concept, technology, or product, as in how many people are likely to buy a certain phone and how long it might take them to upgrade that phone, once purchased.
...
While ballpark figures are used frequently and can be helpful in establishing a baseline for discussion, they should be treated as nothing more than [estimates](https://www.investopedia.com/articles/stocks/06/earningsforecasts.asp); they are not hard numbers. These figures are frequently blown out of proportion by salespersons and other professionals who must use persuasion to generate income or close deals. Major business and financial decisions should probably not be made based on these numbers; however, they could first serve as estimates to be refined through more thorough analysis.
