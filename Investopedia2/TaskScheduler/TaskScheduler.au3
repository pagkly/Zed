...
; Author(s) .....: allow2010, AdamUL, water
...
Func _TS_ErrorText($iErrorNumber, $bPrefix = True)
	...
	; Aliases for the same error message
...
Func _TS_TaskDelete($oService, $sTaskPath)
	Local $iPos = StringInStr($sTaskPath, "\", 0, -1)
...
Func _TS_VersionInfo()
	Local $aVersionInfo[9] = [8, "V", 1, 5, 2.0, "20201113", "3.3.14.5", "allow2010, AdmUL, water", ""]
	Return $aVersionInfo
