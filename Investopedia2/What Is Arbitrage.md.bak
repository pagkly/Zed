...
Arbitrage exists as a result of market [inefficiencies](https://www.investopedia.com/terms/i/inefficientmarket.asp) and it both exploits those inefficiencies and resolves them.
...
Arbitrage provides a mechanism to ensure that prices do not deviate substantially from [fair value](https://www.investopedia.com/terms/f/fairvalue.asp) for long periods of time. With advancements in technology, it has become extremely difficult to profit from pricing errors in the market. Many traders have computerized trading systems set to monitor [fluctuations](https://www.investopedia.com/ask/answers/121714/what-are-differences-between-divergence-and-convergence.asp) in similar [financial instruments](https://www.investopedia.com/terms/f/financialinstrument.asp). Any inefficient pricing setups are usually acted upon quickly, and the opportunity is eliminated, often in a matter of seconds.
...
A trickier example can be found in [triangular arbitrage](https://www.investopedia.com/terms/t/triangulararbitrage.asp). In this case, the trader converts one currency into another at one bank, converts that second currency to another at a second bank, and finally converts the third currency back to the original currency at a third bank.
...
There are more complicated variations on this scenario, but all depend on identifying market "inefficiencies."

Arbitrageurs, as arbitrage traders are called, are usually working on behalf of large financial institutions. It usually involves trading a substantial amount of money, and the split-second opportunities it offers can be identified and acted upon only with highly sophisticated software.1
...
However, the word arbitrage is also sometimes used to describe other trading activities. [Merger arbitrage](https://www.investopedia.com/terms/m/mergerarbitrage.asp), which involves buying shares in companies prior to an announced or expected merger, is one strategy that is popular among hedge fund investors.
...
In this manner, arbitrage resolves inefficiencies in the market’s pricing and adds liquidity to the market.
