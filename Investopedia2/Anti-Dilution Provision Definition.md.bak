---
alias: [Anti-Dilution Provision Definition]
...
Anti-dilution provisions are clauses built into [convertible preferred stocks](https://www.investopedia.com/terms/c/convertiblepreferredstock.asp) and some [options](https://www.investopedia.com/terms/o/option.asp) to help shield investors from their investment potentially losing value. When new issues of a stock hit the market at a cheaper price than that paid by earlier investors in the same stock, then equity [dilution](https://www.investopedia.com/terms/d/dilution.asp) can occur. Anti-dilution provisions are also referred to as anti-dilution clauses, subscription rights, subscription privileges, or preemptive rights.

## Understanding Anti-Dilution Provisions

Anti-dilution provisions act as a buffer to protect investors against their equity ownership positions becoming diluted or less valuable. This can happen when the percentage of an owner's stake in a company decreases because of an increase in the total number of [shares outstanding](https://www.investopedia.com/terms/o/outstandingshares.asp). Total shares outstanding may increase because of new share issuance based on a round of equity financing. Dilution can also occur when holders of [stock options](https://www.investopedia.com/terms/s/stockoption.asp), such as company employees, or holders of other optionable securities [exercise](https://www.investopedia.com/terms/e/exercise.asp) their options.
...
Dilution can be particularly vexing to preferred shareholders of [venture capital](https://www.investopedia.com/terms/v/venturecapital.asp) deals, whose stock ownership may become diluted when later issues of the same stock hit the market at a cheaper price. Anti-dilution provisions can discourage this from happening by tweaking the [conversion price](https://www.investopedia.com/terms/c/conversionprice.asp) between convertible securities, such as corporate bonds or [preferred shares](https://www.investopedia.com/terms/p/preferredstock.asp), and common stocks. In this way, anti-dilution clauses can keep an investor's original ownership percentage intact.
...
With a [**full ratchet**](https://www.investopedia.com/terms/f/fullratchet.asp) provision, the conversion price of the existing preferred shares is adjusted downward to the price at which new shares are issued in later rounds. Very simply, if the original conversion price was $5 and in a later round the conversion price is $2.50, the investor's original conversion price would adjust to $2.50.

The [**weighted average**](https://www.investopedia.com/terms/w/weightedaverage.asp) provision uses the following formula to determine new conversion prices:
