...
The backorder is an indication that demand for a company's product outweighs its supply. They may also be known as the company's [backlog](https://www.investopedia.com/terms/b/backlog.asp).
...
Backorders represent any amount of [stock](https://www.investopedia.com/articles/investing/082614/how-stock-market-works.asp) a company's customers have ordered but have not yet received because it currently isn't available in stock.
...
A company's backorders are an important factor in its [inventory management](https://www.investopedia.com/terms/i/inventory-management.asp) analysis. The number of items on backorder and how long it takes to fulfill these customer orders can provide insight into how well the company manages its inventory. A relatively manageable number of orders and there a short turnaround time to fulfill orders generally means the company is performing well. On the other hand, longer wait times and large backorders may be problematic.

Apple had to put its iPhone X on backorder just after its release in 2017. Even though the initial supply of the phone sold out, demand remained high. According to CNBC_,_ customers whose orders were on hold were told their wait time for delivery was roughly six weeks.1
...
The term backorder may conjure up negative images, but there can be positives to [businesses](https://www.investopedia.com/articles/pf/08/make-money-in-business.asp) that have these orders on the books.
