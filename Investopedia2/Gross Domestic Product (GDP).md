---
alias: [Gross Domestic Product (GDP) Definition]
...
Of all the components that make up a country's GDP, the foreign balance of trade is especially important. The GDP of a country tends to increase when the total value of goods and services that domestic producers sell to foreign countries exceeds the total value of foreign goods and services that domestic consumers buy. When this situation occurs, a country is said to have a [trade surplus](https://www.investopedia.com/terms/t/trade-surplus.asp). If the opposite situation occurs–if the amount that domestic consumers spend on foreign products is greater than the total sum of what domestic producers are able to sell to foreign consumers–it is called [a trade deficit](https://www.investopedia.com/ask/answers/trade-deficit-effects-on-stock-market/). In this situation, the GDP of a country tends to decrease.
...
The income approach represents a kind of middle ground between the two other approaches to calculating GDP. The income approach calculates the income earned by all the [factors of production](https://www.investopedia.com/terms/f/factors-production.asp) in an economy, including the wages paid to labor, the rent earned by land, the return on capital in the form of interest, and corporate profits. 
...
Investors watch GDP since it provides a framework for decision-making. The "corporate profits" and "inventory" data in the GDP report are a great resource for equity investors, as both categories show total growth during the period; corporate profits data also displays pre-tax profits, [operating cash flows](https://www.investopedia.com/terms/o/operatingcashflow.asp) and breakdowns for all major sectors of the economy. Comparing the GDP growth rates of different countries can play a part in asset allocation, aiding decisions about whether to invest in fast-growing economies abroad and if so, which ones.

One interesting metric that investors can use to get some sense of the valuation of an equity market is the [ratio](https://www.investopedia.com/terms/i/icor.asp) of [total market capitalization to GDP](https://www.investopedia.com/terms/m/marketcapgdp.asp), expressed as a percentage. The closest equivalent to this in terms of stock valuation is a company's market cap to total sales (or revenues), which in per-share terms is the well-known [price-to-sales ratio](https://www.investopedia.com/terms/p/price-to-salesratio.asp).

Just as stocks in different sectors trade at widely divergent price-to-sales ratios, different nations trade at market-cap-to-GDP ratios that are literally all over the map. For example, [according to the World Bank](https://data.worldbank.org/indicator/CM.MKT.LCAP.GD.ZS), the U.S. had a market-cap-to-GDP ratio of nearly 165% for 2017 (the latest year for available figures), while China had a ratio of just over 71% and Hong Kong had a ratio of 1274%.
...
[The Bureau of Economic Analysis (BEA),](https://www.investopedia.com/terms/b/bea.asp) a division of the U.S. [Department of Commerce,](https://www.investopedia.com/terms/d/department-of-commerce.asp) issues its own analysis document with each GDP release, which is a great investor tool for analyzing figures and trends and reading highlights of the very lengthy full release.
