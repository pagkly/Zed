...
What Adjusted EBITDA Tells Us
## What Is Adjusted EBITDA?

Adjusted EBITDA (earnings before interest, taxes, [depreciation](https://www.investopedia.com/terms/d/depreciation.asp), and [amortization](https://www.investopedia.com/terms/a/amortization.asp)) is a measure computed for a company that takes its earnings and adds back interest expenses, taxes, and depreciation charges, plus other adjustments to the metric.

Standardizing [EBITDA](https://www.investopedia.com/terms/e/ebitda.asp) by removing anomalies means the resulting adjusted or normalized EBITDA is more accurately and easily comparable to the EBITDA of other companies, and to the EBITDA of a company's industry as a whole.
...
NI+IT+DA\=EBITDAEBITDA+/−A\=Adjusted EBITDAwhere:NI \= Net incomeIT \= Interest & taxesDA \= Depreciation & amortizationA \= Adjustments\\begin{aligned} &NI+IT+DA=EBITDA\\\\ &EBITDA +\\!\\!/\\!\\!-A = \\text{Adjusted }EBITDA\\\\ &\\textbf{where:}\\\\ &NI\\ =\\ \\text{Net income}\\\\ &IT\\ =\\ \\text{Interest \\& taxes}\\\\ &DA\\ =\\ \\text{Depreciation \\& amortization}\\\\ &A\\ =\\ \\text{Adjustments} \\end{aligned}
...
Adjusted EBITDA is used to assess and compare related companies for valuation analysis and for other purposes. Adjusted EBITDA differs from the standard EBITDA measure in that a company's adjusted EBITDA is used to [normalize](https://www.investopedia.com/terms/n/normalizedearnings.asp) its income and expenses since different companies may have several types of expense items that are unique to them. Adjusted EBITDA, as opposed to the non-adjusted version, will attempt to normalize income, standardize cash flows, and eliminate abnormalities or idiosyncrasies (such as redundant assets, [bonuses](https://www.investopedia.com/terms/b/bonus.asp) paid to owners, rentals above or below fair market value, etc.), which makes it easier to compare multiple business units or companies in a given industry.
...
Adjusted EBITDA should not be used in isolation and makes more sense as part of a suite of analytical tools used to value a company or companies. Ratios that rely on adjusted EBITDA can also be used to compare companies of different sizes and in different industries, such as the [enterprise value](https://www.investopedia.com/terms/e/enterprisevalue.asp)/adjusted EBITDA ratio. 

## Example of How to Use Adjusted EBITDA

The adjusted EBITDA metric is most helpful when used in determining the value of a company for transactions such as [mergers](https://www.investopedia.com/terms/m/merger.asp), acquisitions or raising capital. For example, if a company is valued using a multiple of EBITDA, the value could change significantly after add-backs.
...
Analysts often use a three-year or five-year average adjusted EBITDA to [smooth out the data](https://www.investopedia.com/terms/d/data-smoothing.asp). The higher the adjusted EBITDA margin, the better. Different firms or analysts may arrive at slightly different adjusted EBITDA due to differences in their methodology and assumptions in making the adjustments.

These figures are often not made available to the public, while non-normalized EBITDA is typically public information. It is important to note that adjusted EBITDA is not a [generally accepted accounting principles](https://www.investopedia.com/terms/g/gaap.asp) (GAAP)-standard line item on a company's income statement.
