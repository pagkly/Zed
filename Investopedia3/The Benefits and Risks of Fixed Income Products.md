...
tags: [Fixed Income Definition, The Benefits and Risks of Fixed Income Products]
source: https://www.investopedia.com/terms/f/fixedincome.asp
author: James Chen
---
...
-   In the event of a company's bankruptcy, fixed-income investors are often paid before common stockholders.1
...
-   **Treasury bills ([T-bills](https://www.investopedia.com/terms/t/treasurybill.asp))** are short-term fixed-income securities that mature within one year that do not pay coupon returns. Investors buy the bill at a price less than its face value and investors earn that difference at the maturity.2
-   **Treasury notes ([T-notes](https://www.investopedia.com/terms/t/treasurynote.asp))** come in maturities between two and 10 years, pay a fixed interest rate, and are sold in multiples of $100. At the end of the maturity, investors are repaid the principal but earn semiannual interest payments until maturity.3
-   **The Treasury bond ([T-bonds](https://www.investopedia.com/terms/t/treasurybond.asp))** are similar to the T-note except that it matures in 20 or 30 years. Treasury bonds can be purchased in multiples of $100.4
-   **Treasury Inflation-Protected Securities ([TIPS](https://www.investopedia.com/terms/t/tips.asp))** protects investors from inflation. The principal amount of a TIPS bond adjusts with inflation and deflation.5
-   A [**municipal bond**](https://www.investopedia.com/terms/m/municipalbond.asp) is similar to a Treasury since it is government-issued, except it is issued and backed by a state, municipality, or county, instead of the federal government, and is used to raise capital to finance local expenditures. Muni bonds can have tax-free benefits to investors as well.6
-   [**Corporate bonds**](https://www.investopedia.com/terms/c/corporatebond.asp) come in various types, and the price and interest rate offered largely depends on the company’s financial stability and its creditworthiness. Bonds with higher credit ratings typically pay lower coupon rates.
-   [**Junk bonds**](https://www.investopedia.com/terms/j/junkbond.asp)—also called high-yield bonds—are corporate issues that pay a greater coupon due to the higher risk of default. Default is when a company fails to pay back the principal and interest on a bond or debt security.
-   A **certificate of deposit ([CD](https://www.investopedia.com/terms/c/certificateofdeposit.asp))** is a fixed income vehicle offered by financial institutions with maturities of less than five years. The rate is higher than a typical saving account, and CDs carry FDIC or National Credit Union Administration (NCUA) protection.7 8
-   **Fixed-income mutual funds ([bond funds](https://www.investopedia.com/terms/b/bondfund.asp))**—such as those offered by Vanguard—invest in various bonds and debt instruments. These funds allow the investor to have an income stream with the professional management of the portfolio. However, they will pay a fee for the convenience.
