...
> ## Excerpt
> Oil sands are found in parts of Canada, Venezuela, Kazakhstan, and Russia, and produce a thick form of crude oil that can be extracted from the earth.
...
Oil sands, or tar sands, are sand and rock material that contain crude [bitumen](https://www.investopedia.com/terms/b/bitumen.asp)_—_a dense, viscous form of [crude oil](https://www.investopedia.com/terms/c/crude-oil.asp). Bitumen is too thick to flow on its own, so extraction methods are necessary. Bitumen is extracted and processed using two methods: mining and in-situ recovery.

Oil sands are found primarily in the Athabasca, Cold Lake, and Peace River regions of northern Alberta and Saskatchewan, Canada, and in areas of Venezuela, Kazakhstan, and Russia. Oil sands trade as part of crude oil [commodities](https://www.investopedia.com/terms/c/commodity.asp).
...
Despite the negative environmental impact, oil sands produce significant [revenue](https://www.investopedia.com/terms/r/revenue.asp) for Canada, which relies on oil sands as a significant portion of its economic health.

Canada has an estimated 171 billion barrels of proven [oil reserves](https://www.investopedia.com/terms/o/oil-reserves.asp), of which 166.3 billion barrels are found in Alberta's oil sands. At the end of 2014, Canada ranked third in the world in proven reserves after Venezuela and Saudi Arabia.1 This means oil sands are a significant component of Canada's economy in terms of investment, employment, and revenue.

## Process of Extracting Oil From Oil Sands

In surface mining oil sands, clearing large land areas of trees and brush is the first step. The topsoil and clay are removed to expose the oil sand. This surface mining method uses large trucks and shovels to remove the sand, which can have a volume of anywhere from 1% to 20% of actual bitumen. After processing and upgrading, the results travel to refineries for refining into gasoline, jet fuel, and other [petroleum](https://www.investopedia.com/terms/p/petroleum.asp) products.

The mining method is considered to be very damaging to the environment, as it involves leveling hundreds of square miles of land, trees, and wildlife. Oil sands operators must develop a plan to reclaim the land and have this approved by the government. Since oil sands operations began in Canada in the 1960s, just 8% of total mining area has been reclaimed or is in the process of reclamation.2
...
Organizations, such as Canada's Oil Sands Innovation Alliance (COSIA), are focused on reducing the environmental impact of mining oil sands for oil. They provide funding for research initiatives related to mitigating the environmental impact of mining for oil sands. The organization provides in-depth information related to mining, wildfire risks, vegetation, industry reports, research reports, and more.4
