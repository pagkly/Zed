...
This method of [regression](https://www.investopedia.com/terms/r/regression.asp) analysis begins with a set of data points to be plotted on an x- and y-axis graph. An analyst using the least squares method will generate a line of best fit that explains the potential relationship between independent and dependent variables.
...
An example of the least squares method is an analyst who wishes to test the relationship between a company’s [stock returns](https://www.investopedia.com/articles/investing/011416/how-evaluate-stock-performance.asp), and the returns of the index for which the stock is a component. In this example, the analyst seeks to test the dependence of the stock returns on the index returns. To achieve this, all of the returns are plotted on a chart. The index returns are then designated as the independent variable, and the stock returns are the dependent variable. The line of best fit provides the analyst with coefficients explaining the level of dependence.
...
The Least Squares Method is used in a wide variety of fields, including finance and investing. For financial analysts, the Least Squares Method can help to quantify the relationship between two or more variables: such as a stock’s share price and its [earnings per share (EPS)](https://www.investopedia.com/terms/e/eps.asp). By performing this type of analysis, investors may attempt to forecast the future behavior of stock prices or other factors.
