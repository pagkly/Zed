...
A loan contract, on the other hand, usually states the lender's right to recourse—such as [foreclosure](https://www.investopedia.com/terms/f/foreclosure.asp)—in the event of default by the borrower; such provisions are generally absent in a promissory note. While it might make note of the consequences of non-payment or untimely payments (such as late fees), it does not usually explain methods of recourse if the issuer does not pay on time.
