...
> ## Excerpt
> A unified managed household account (UMHA) is privately managed and grants immediate family access to combined unaffiliated products.
...
Unified managed household accounts (UMHAs) operate on a single, integrated system, which allows a financial advisor to view various assets and product types to create performance reports. This holistic view also will enable [financial advisors](https://www.investopedia.com/terms/f/financial-advisor.asp) to customize investment decisions for each client in the context of their household and to simplify operational procedures that are typically complex and cumbersome. In some UMHA programs, clients can create account groups for each investment goal. The system supports groupings with individual performance reports, billing and statements.
...
Consumers should be aware of several factors when consolidating accounts into a UMHA. Often, UMHAs are discretionary programs, meaning the financial advisor has the authority to make investing decisions. As with mutual-fund advisory programs, the investor selects a model based on risk tolerance and goals, and the firm takes care of [rebalancing](https://www.investopedia.com/terms/r/rebalancing.asp) or even changing asset allocations altogether, depending on the degree of discretion inherent in a particular program. Therefore, a UMHA's performance will depend largely on the company's success in selecting securities and making adjustments to the [allocation](https://www.investopedia.com/terms/a/assetallocation.asp). Investors should be selective when choosing the firm that will manage their UMHA.
