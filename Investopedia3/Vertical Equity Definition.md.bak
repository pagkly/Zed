...
> ## Excerpt
> Vertical equity is a method of collecting income tax in which the taxes paid increase with the amount of earned income.
...
Progressive taxation includes tax brackets, in which people pay taxes based on the tax bracket that their income places them. Each tax bracket will have a different tax rate, with higher income brackets paying the highest percentages. Under this taxation system, effective average tax rates increase with income, so that the rich pay a higher share of their income in taxes than do the poor. For example, in the United States, a single taxpayer that earns $100,000 has a top marginal tax rate of 24%, as of 2019.1 His tax liability would be $18,174.50 for an effective tax rate of 18.17%.2 The top marginal tax rate for a single taxpayer whose annual income is $50,000 is 22%.1 In this case, this taxpayer would pay $6,864 for an effective tax rate of 13.73%.3

The other yardstick that is used to measure equity in a taxation system is the horizontal equity, which states that people with similar abilities to pay should contribute the same amount in taxes to the economy. The basis behind this notion is that people in the same income group are equal in their contribution capacity to society and, thus, should be treated the same by imposing the same level of income tax. For example, if two taxpayers earn $50,000, they should both be taxed the same rate since they both have the same wealth or fall within the same income bracket. However, horizontal equity is hard to achieve in a tax system with [loopholes](https://www.investopedia.com/terms/l/loophole.asp), [deductions](https://www.investopedia.com/terms/t/tax-deduction.asp) and incentives, because the provision of any tax break means that similar individuals effectively do not pay the same rate.
