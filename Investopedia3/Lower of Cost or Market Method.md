...
> ## Excerpt
> The lower of cost or market method is a way to record the value of inventory which places an emphasis on not overstating the value of the assets.
...
The value of a good can shift over time. This holds significance, because if the price at which the inventory can be sold falls below the [[net realizable value]](https://www.investopedia.com/terms/n/nrv.asp) of the item, thus triggering a loss for the company, then the lower of cost or market method can be employed to record the loss.
...
The LCM method is part of the [[GAAP]](https://www.investopedia.com/terms/g/gaap.asp) rules used in the U.S. and in international commerce. Almost all assets enter the accounting system with a value equal to acquisition cost. GAAP prescribes many different methods for adjusting asset values in subsequent reporting periods.
...
-   **Hedges**: In cases where inventory is [[hedged]](https://www.investopedia.com/articles/optioninvestor/07/hedging-intro.asp) by a fair value hedge, the hedge's effects should be added to the inventory's cost, which may obliterate the need for LCM adjustments.
...
-   **Recovery**: A [[write-down]](https://www.investopedia.com/terms/c/capital-recovery.asp) to the LCM may be avoided if ample evidence exists that market prices will climb, prior to the sale of inventory.
