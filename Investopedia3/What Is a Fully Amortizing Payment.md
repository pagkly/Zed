...
A fully amortizing payment refers to a type of periodic repayment on a debt. If the borrower makes payments according to the loan's [[amortization schedule]](https://www.investopedia.com/terms/a/amortization_schedule.asp), the debt is fully paid off by the end of its set term. If the loan is a fixed-rate loan, each fully [[amortizing]](https://www.investopedia.com/terms/a/amortization.asp) payment is an equal dollar amount. If the loan is an adjustable-rate loan, the fully amortizing payment changes as the interest rate on the loan changes.
