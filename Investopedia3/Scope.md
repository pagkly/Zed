...
tags: [Scope Definition, Scope]
source: https://www.investopedia.com/terms/s/scope.asp
...
Scope is a term used in [project management](https://www.investopedia.com/terms/p/project-management.asp). Project management involves the planning and organization of a company's resources to complete a specific task, event, or action and is usually a one-time event. Scope describes the required processes and resources to complete a project or produce a product. By identifying and recognizing different variables of a project through scope management, companies are able to save money.
