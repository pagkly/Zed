...
Tangible net worth is most commonly a calculation of the net worth of a company that excludes any value derived from [intangible assets](https://www.investopedia.com/terms/i/intangibleasset.asp) such as copyrights, patents, and [intellectual property](https://www.investopedia.com/terms/i/intellectualproperty.asp).
...
1.  Locate the company's total assets, total liabilities, and intangible assets, which are all listed on the [balance sheet](https://www.investopedia.com/terms/b/balancesheet.asp).
...
The tangible net worth calculation is designed to represent the total value of a company's [physical assets](https://www.investopedia.com/terms/p/physicalasset.asp) net of its outstanding liabilities, as based on figures shown in the company's balance sheet. In effect, it indicates an approximation of the [liquidation](https://www.investopedia.com/terms/l/liquidation.asp) value of the company in the event of [bankruptcy](https://www.investopedia.com/terms/b/bankruptcy.asp) or sale.
...
A drawback of using tangible net worth is that it may fall substantially short as a representation of actual net worth in cases where a company or an individual has intangible assets of considerable value. For example, a major computer software firm such as Microsoft Corporation (NASDAQ: [MSFT](https://www.investopedia.com/markets/quote?tvwidgetsymbol=msft)) may possess a wealth of intellectual property rights and other intangible assets that are worth billions of dollars, which would be excluded from the tangible net worth calculation.

One item that can complicate the tangible net worth calculation is [subordinated debt](https://www.investopedia.com/terms/s/subordinateddebt.asp), debt that in the event of a default or liquidation is only repaid after all debt obligations to senior debt holders have been satisfied. A simple example of subordinated debt is a secondary mortgage held on real estate.
