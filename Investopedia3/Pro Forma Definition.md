...
tags: [Pro Forma Definition, Pro Forma Definition]
source: https://www.investopedia.com/terms/p/proforma.asp
...
-   They can also be used internally by management for business decisions.
...
In [financial accounting](https://www.investopedia.com/terms/f/financialaccounting.asp), pro forma refers to a report of the company's earnings that excludes [[unusual]](https://www.investopedia.com/terms/u/unusual-item.asp) or nonrecurring transactions. Excluded expenses could include declining investment values, restructuring costs, and adjustments made on the company’s balance sheet that fix accounting errors from prior years.

In [managerial accounting](https://www.investopedia.com/terms/m/managerialaccounting.asp), meanwhile, accountants design financial statements prepared in the pro forma method ahead of a planned transaction such as an acquisition, merger, change in [[capital structure]](https://www.investopedia.com/terms/c/capitalstructure.asp), or new capital investment. These models forecast the expected result of the proposed transaction, with emphasis placed on estimated net revenues, cash flows, and taxes. Managers are then able to make business decisions based on the potential benefits and costs.

## History of Pro Forma

Pro forma financials in the United States boomed in the late 1990s when [[dot-com]](https://www.investopedia.com/terms/d/dotcom.asp) companies used the method to make losses appear like [[profits]](https://www.investopedia.com/terms/p/profit.asp) or, at a minimum, to reveal much greater gains than indicated through U.S. GAAP accounting methods.

The U.S. [[Securities and Exchange Commission]](https://www.investopedia.com/terms/s/sec.asp) (SEC) responded by [cautioning that publicly traded companies](https://www.sec.gov/rules/other/33-8039.htm) report and make public U.S. GAAP-based financial results as well. The SEC also clarified that it would deem using pro forma results to grossly misconstrue GAAP-based results and mislead investors fraudulent and punishable by law.1
