...
tags: [Covariance Definition, Covariance]
source: https://www.investopedia.com/terms/c/covariance.asp
author: James Chen
---
...
While the covariance does measure the directional relationship between two assets, it does not show the strength of the relationship between the two assets; the [coefficient of correlation](https://www.investopedia.com/terms/c/correlationcoefficient.asp) is a more appropriate indicator of this strength.
...
Assume an analyst in a company has a five-quarter data set that shows quarterly gross domestic product ([GDP](https://www.investopedia.com/terms/g/gdp.asp)) growth in percentages (x) and a company's new product line growth in percentages (y). The data set may look like:
