...
Net operating income\=RR−OEwhere:RR\=real estate revenueOE\=operating expenses\\begin{aligned} &\\text{Net operating income} = RR - OE \\\\ &\\textbf{where:}\\\\ &RR=\\text{real estate revenue}\\\\ &OE=\\text{operating expenses}\\\\ \\end{aligned}
...
-   _NOI = real estate revenue - operating expenses_
