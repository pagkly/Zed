---
alias: [Fair Market Value (FMV)]
created: 2021-03-02T19:50:26 (UTC +11:00)
tags: [Fair Market Value (FMV) Definition, Fair Market Value (FMV)]
source: https://www.investopedia.com/terms/f/fairmarketvalue.asp
author: James Chen
---
...
The term, fair market value, is intentionally distinct from similar terms such as market value or appraised value because it considers the economic principles of free and open market activity, whereas the term, [market value](https://www.investopedia.com/terms/m/marketvalue.asp), simply refers to the price of an asset in the marketplace. Therefore, while a home's market value can easily be found on a listing, the fair market value is more difficult to determine. Similarly, the term, [appraised value](https://www.investopedia.com/terms/a/appraised_value.asp), refers to an asset's value in the opinion of a single appraiser, thus not immediately qualifying the appraisal as fair market value. In cases where a fair market value is needed, however, an appraisal will usually suffice. 

Due to the thorough considerations made by the term, fair market value, it's often used in legal settings. For example, fair market value in real estate is commonly used in divorce settlements and to calculate compensation related to the government's use of [eminent domain](https://www.investopedia.com/terms/e/eminent-domain.asp). Fair market values are also often utilized in taxation, such as when determining the fair market value of a property for a tax deduction after a [casualty loss](https://www.investopedia.com/terms/c/casualty-loss.asp). 

## Practical Uses of Fair Market Value (FMV)

Municipal [property taxes](https://www.investopedia.com/terms/p/propertytax.asp) are often assessed based on the FMV of the owner's property. Depending on how long the owner has owned the home, the difference between the [purchase price](https://www.investopedia.com/terms/p/purchaseprice.asp) and the residence's FMV can be substantial. Professional appraisers use standards, guidelines, and national and local regulations to determine a home's FMV.

FMV is also often used in the insurance industry. For example, when an [insurance claim](https://www.investopedia.com/terms/i/insurance_claim.asp) is made as a result of a car accident, the insurance company covering the damage to the owner's vehicle usually covers damages up to the vehicle's FMV.

## Fair Market Value (FMV) and Taxation

Worldwide tax authorities are always ensuring that transactions are realized at FMV, at least for tax purposes. For example, a father who is retiring may sell the shares of his business to his daughter for $1 so that she can carry on as the owner of the family business. However, if the FMV of the shares is higher, tax authorities such as the [Internal Revenue Service](https://www.investopedia.com/terms/i/irs.asp) (IRS) may well recharacterize the transaction for tax purposes, and the father will need to pay taxes on the [disposition](https://www.investopedia.com/terms/d/disposition.asp) of the shares as though he had sold them at FMV to a third party.

Another field of taxation where FMV regularly comes into play is the [donation](https://www.investopedia.com/terms/c/charitabledonation.asp) of property, such as artwork to charities. In these cases, the donor usually receives a [tax credit for the value of the donation](https://www.investopedia.com/terms/c/charitable-contributions-deduction.asp). Tax authorities need to ensure that the credit given is for the true FMV of the object and often ask donors to provide independent valuations for their donations.
