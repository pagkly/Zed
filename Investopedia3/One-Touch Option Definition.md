...
A one-touch option pays a [[premium]](https://www.investopedia.com/terms/o/option-premium.asp) to the holder of the [[option]](https://www.investopedia.com/terms/o/option.asp) if the [[spot rate]](https://www.investopedia.com/terms/s/spot_rate.asp) reaches the [[strike price]](https://www.investopedia.com/terms/s/strikeprice.asp) at any time prior to option [[expiration]](https://www.investopedia.com/terms/e/expirationdate.asp).
...
One-touch options allow investors to choose the target price, time to expiration, and the premium to be received when the target price is reached. Compared to vanilla [[calls]](https://www.investopedia.com/terms/c/calloption.asp) and [[puts]](https://www.investopedia.com/terms/p/putoption.asp), one-touch options allow investors to profit from a simplified yes-or-no market forecast. Only two outcomes are possible with a one-touch option if an investor holds the contract all the way through expiration:
