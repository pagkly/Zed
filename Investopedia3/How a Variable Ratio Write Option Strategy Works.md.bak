...
> ## Excerpt
> A variable ratio write option strategy is defined as a long position in the underlying asset while simultaneously writing call options at varying strike prices.
...
The variable ratio write is an [options strategy](https://www.investopedia.com/trading/options-strategies/) defined by an investor or trader holding a long position in the underlying asset while simultaneously writing multiple call options at varying [strike prices](https://www.investopedia.com/terms/s/strikeprice.asp). It is essentially a ratio [buy-write](https://www.investopedia.com/terms/b/buy-write.asp) strategy.
...
In ratio call writing, the ratio represents the number of options sold for every 100 shares owned in the underlying stock. This strategy is similar to a ratio call write, but instead of writing [at-the-money](https://www.investopedia.com/terms/a/atthemoney.asp) calls, the trader will write both in the money and out of the money calls. For example, in a 2:1 variable ratio write, the trader will be long 100 shares of the underlying stock. Two calls are written: one is out of the money and one is in the money. The payoff in a variable ratio write resembles that of a reverse strangle.
