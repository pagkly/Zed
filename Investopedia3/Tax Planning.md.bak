...
tags: [Tax Planning Definition, Tax Planning]
source: https://www.investopedia.com/terms/t/tax-planning.asp
author: Julia Kagan
---
...
Using the same example as above, the 52-year-old could contribute up to $26,000 into their 401(k). For 2020 and 2021, if under age 50, the salary contribution can be up to $19,500, or up to $26,000 if age 50 or older due to the allowed additional $6,000 catch-up contribution. This 401(k) deposit reduces adjusted gross income from $50,000 to $24,000.2

## Tax Gain-Loss Harvesting

[Tax gain-loss harvesting](https://www.investopedia.com/terms/t/taxgainlossharvesting.asp) is another form of tax planning or management relating to investments. It is helpful because it can use a portfolio's losses to offset overall capital gains. According to the IRS, short and long-term capital losses must first be used to offset capital gains of the same type. In other words, long-term losses offset long-term gains before offsetting short-term gains. Short-term capital gains, or earnings from assets owned for less than one year, are taxed at ordinary income rates.3 

As of 2020, long-term capital gains are taxed as follows: 

-   0% tax for taxpayers whose income is less than $78,750
...
For example, if the 52-year-old investor had $3,000 in net capital losses for the year, the $50,000 income will be adjusted to $47,000. Remaining capital losses can be carried over with no expiration to offset future capital gains.
