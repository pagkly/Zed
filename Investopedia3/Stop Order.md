...
Also referred to as a "stop," a stop order to sell that is linked to a limit order is referred to as a "[stop-loss order](https://www.investopedia.com/articles/stocks/09/use-stop-loss.asp)."
...
Some investors, however, anticipate that a stock that does eventually climb above the line of resistance, in what is known as a [breakout](https://www.investopedia.com/terms/b/breakout.asp), will continue to climb. A buy stop order can be very useful to profit from this phenomenon. The investor will open a buy stop order just above the line of resistance to capture the profits available once a breakout has occurred. A stop loss order can protect against a subsequent decline in share price.

## Types of Stop Orders

For example, if on January 5, 2018, AAPL was trading for $175 per share at 1:00 p.m., a market order does not guarantee that an investor’s buy or sell price will be [[filled]](https://www.investopedia.com/terms/f/fill.asp) at $175. The investor may get a price lower or higher than $175, depending on the time of fill. In the case of [[illiquid]](https://www.investopedia.com/terms/i/illiquid.asp) or extremely volatile securities, placing a market order may result in a fill price that significantly differs from $175.
