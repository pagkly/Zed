...
-   _Settlement dates_ – 10 in all, the first one coinciding with the first interest payment and the 10th and final one coinciding with the final interest payment plus principal repayment.
-   _Contract rates for the swap (F)_ – For the sake of simplicity, say a contract rate of 6 (pesos per dollar) for the interest payments and 7 for the principal repayment.
