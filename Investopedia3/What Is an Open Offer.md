...
> ## Excerpt
> An open offer is a secondary market offering, similar to a rights issue. Discover more about what it means when a stock is sold at an open offer price.

---

What Is an Open Offer?
An open offer is a [secondary market](https://www.investopedia.com/terms/s/secondarymarket.asp) offering, similar to a rights issue. In an open offer, a shareholder is allowed to purchase stock at a price that is lower than the current [market price](https://www.investopedia.com/terms/m/market-price.asp). The purpose of such an offer is to raise cash for the company efficiently.

## Understanding Open Offer

An open offer differs from a [rights issue (offering)](https://www.investopedia.com/terms/r/rightsoffering.asp) in that investors are unable to sell the rights that come with their purchases to other parties. In a traditional rights issue, the trading of transferable rights, connected with shares, occurs on the [exchange](https://www.investopedia.com/financial-edge/1212/stock-exchanges-around-the-world.aspx) that currently lists the issuer's common stock (e.g., NYSE or Nasdaq). These can also be listed over the counter (OTC). Some investors see a secondary market offering as a harbinger of bad news as it causes stock [dilution](https://www.investopedia.com/terms/d/dilution.asp). Also, the open offer could signal that the company stock is currently overvalued.
