...
source: https://www.investopedia.com/terms/p/payee.asp
author: Will Kenton
---
...
> ## Excerpt
> The payee is the party in an exchange who receives payment for goods and/or services of some type.
...
A payee is a party in an exchange of goods or services who receives payment. The payee is paid by cash, check, or another transfer medium by a payer. The payer receives goods or services in return. The name of the payee is included in the [[bill of exchange]](https://www.investopedia.com/terms/b/billofexchange.asp) and it usually refers to a natural person or an entity such as a business, [[trust]](https://www.investopedia.com/terms/t/trust.asp), or custodian.
...
In the case of a [[promissory note]](https://www.investopedia.com/terms/p/promissorynote.asp), through which one party promises to pay another party a predetermined sum, the party receiving the payment is known as the payee. The party making the payment is known as the payer. For [[coupon]](https://www.investopedia.com/terms/c/coupon.asp) payments from bonds, the party receiving the coupon is the payee and the bond [[issuer]](https://www.investopedia.com/terms/i/issuer.asp) is referred to as the payer.

Payees have the ability to accept or reject amounts being paid to them, based on an agreement or contract.

[Investment management](https://www.investopedia.com/terms/i/investment-management.asp) transactions frequently have payee accounts that receive payments for the benefit of a client's separate account. For example, in contributing to an [[individual retirement account]](https://www.investopedia.com/terms/i/ira.asp) (IRA), a customer (e.g., John Smith) may write a check from their checking account to their [[investment management company]](https://www.investopedia.com/terms/m/management-investment-company.asp), with the payee being the company's name receiving the funds "For the Benefit of" (FBO) the client. This would appear as "XYZ Management FBO John Smith." The funds will ultimately be deposited into John Smith's account as the payee, with XYZ Management being the custodian.
...
[Social Security](https://www.investopedia.com/terms/s/socialsecurity.asp) and [[Supplemental Security Income]](https://www.investopedia.com/terms/s/ssi.asp) (SSI) benefit payments are often payable to a “representative payee” rather than the ultimate beneficiary (the person entitled to receive benefits). The Social Security Administration (SSA) may designate a representative payee if it believes the beneficiary can’t manage funds on their own.

The [[SSA outlines]](https://www.ssa.gov/payee/faqrep.htm) an entire process on how to become a representative payee, what the duties are, and how the process should be managed and reported.

A representative payee has rights and powers similar to that of a conventional payee, but a representative payee must manage money for the benefit of the actual beneficiary. Funds must be spent on (or saved for) only in ways that help the beneficiary. In this aspect, the representative is acting as the [[fiduciary]](https://www.investopedia.com/terms/f/fiduciary.asp) to the actual payee.
