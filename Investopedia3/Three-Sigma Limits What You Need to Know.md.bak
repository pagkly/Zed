...
Three-sigma limits are used to set the upper and lower control limits in statistical [quality control charts](https://www.investopedia.com/terms/q/quality-control-chart.asp). Control charts are used to establish limits for a manufacturing or business process that is in a state of statistical control.
...
To understand this measurement, consider the normal [bell curve](https://www.investopedia.com/terms/b/bell-curve.asp), which has a normal distribution. The farther to the right or left a data point is recorded on the bell curve, the higher or lower, respectively, the data is than the mean. From another point of view, low values indicate that the data points fall close to the mean; high values indicate the data is widespread and not close to the average.
...
3.  Third, **calculate the standard deviation,** which is simply the square root of the variance. So, the standard deviation = √0.2564 = 0.5064.
4.  Fourth, **calculate three-sigma,** which is three standard deviations above the mean. In numerical format, this is (3 x 0.5064) + 9.34 = 10.9. Since none of the data is at such a high point, the manufacturing testing process has not yet reached three-sigma quality levels.
