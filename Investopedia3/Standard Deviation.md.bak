...
tags: [Standard Deviation Definition, Standard Deviation]
...
A standard deviation is a statistic that measures the dispersion of a dataset relative to its [mean](https://www.investopedia.com/terms/m/mean.asp) and is calculated as the square root of the [variance](https://www.investopedia.com/terms/v/variance.asp). The standard deviation is [calculated](https://www.investopedia.com/ask/answers/021115/what-difference-between-standard-deviation-and-z-score.asp) as the square root of variance by determining each data point's deviation relative to the mean. If the data points are further from the mean, there is a higher deviation within the data set; thus, the more spread out the data, the higher the standard deviation.
...
Standard deviation is a statistical measurement in finance that, when applied to the annual rate of return of an investment, sheds light on that investment's [historical volatility](https://www.investopedia.com/terms/h/historicalvolatility.asp). The greater the standard deviation of securities, the greater the variance between each price and the mean, which shows a larger price range. For example, a volatile stock has a high standard deviation, while the deviation of a stable [blue-chip](https://www.investopedia.com/terms/b/bluechip.asp) stock is usually rather low.

### The Formula for Standard Deviation

Standard Deviation\=∑i\=1n(xi−x‾)2n−1where:xi\=Value of the ith point in the data setx‾\=The mean value of the data setn\=The number of data points in the data set\\begin{aligned} &\\text{Standard Deviation} = \\sqrt{ \\frac{\\sum\_{i=1}^{n}\\left(x\_i - \\overline{x}\\right)^2} {n-1} }\\\\ &\\textbf{where:}\\\\ &x\_i = \\text{Value of the } i^{th} \\text{ point in the data set}\\\\ &\\overline{x}= \\text{The mean value of the data set}\\\\ &n = \\text{The number of data points in the data set} \\end{aligned}
