...
source: https://www.investopedia.com/terms/z/zspread.asp
author: James Chen
---
...
P\=C1(1+r1+Z2)2n+C2(1+r2+Z2)2n+Cn(1+rn+Z2)2nwhere:P\=Current price of the bond plus any accrued interestCx\=Bond coupon paymentrx\=Spot rate at each maturityZ\=Z-spreadn\=Relevant time period\\begin{aligned} &\\text{P} = \\frac { C\_1 }{ \\left ( 1 + \\frac { r\_1 + Z }{ 2 } \\right ) ^ {2n} } + \\frac { C\_2 }{ \\left ( 1 + \\frac { r\_2 + Z }{ 2 } \\right ) ^ {2n} } + \\frac { C\_n }{ \\left ( 1 + \\frac { r\_n + Z }{ 2 } \\right ) ^ {2n} } \\\\ &\\textbf{where:} \\\\ &\\text{P} = \\text{Current price of the bond plus any accrued interest} \\\\ &C\_x = \\text{Bond coupon payment} \\\\ &r\_x = \\text{Spot rate at each maturity} \\\\ &Z = \\text{Z-spread} \\\\ &n = \\text{Relevant time period} \\\\ \\end{aligned}
