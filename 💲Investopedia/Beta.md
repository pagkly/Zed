...
## How  [[Beta]]  Works
A [[#Formulae|Beta coefficient]] can measure the volatility of an individual stock compared to the [[systematic risk]] of the entire market. In statistical terms,  [[Beta]]  represents the slope of the line through a regression of data points. In finance, each of these data points represents an individual stock's returns against those of the market as a whole.
...
[[Beta]]  to determine the degree of systematic risk, a security with a high R-squared value, in relation to its benchmark, could indicate a more relevant benchmark.
