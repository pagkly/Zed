...
> ## Excerpt
> The NYSE Composite Index serves as a gauge of the performance of stocks listed on the New York Stock Exchange.
...
-   The NYSE Composite Index is a trackable index that reflects the performance of all the stocks listed on the New York Stock Exchange.1
...
-   The NYSE lists more than 2,400 companies, of which international companies constitute about one-third of total market capitalization.2
...
Under the current methodology, the composite index no longer considers a variety of security classes eligible for inclusion: closed-end funds, ETFs, preferred stocks, derivatives, shares of beneficial interest, trust units, and limited partnerships.1
