...
source: https://www.investopedia.com/terms/x/xetra.asp
author: James Chen
---
...
Xetra is a trading technology platform that is operated by Frankfurter Wertpapierbörse (FWB), the Frankfurt Stock Exchange. It offers electronic trading in stocks, funds, bonds, [warrants](https://www.investopedia.com/terms/w/warrant.asp), and [commodities](https://www.investopedia.com/terms/c/commodity.asp) contracts.
...
Xetra was one of the first global electronic trading systems; it has grown to account for the majority of all stock trades on the [Frankfurt Exchange](https://www.investopedia.com/terms/f/frankfurt-stock-exchange-fra-.f.asp) (FRA). The FRA is one of the oldest exchanges in the world and includes notable indices, such as the [DAX](https://www.investopedia.com/terms/d/dax.asp), the VDAX, and the Eurostoxx 50. FRA hours are from 9:00 am to 5:30 pm on weekdays. The [DAX 30](https://www.investopedia.com/terms/d/deutsche-aktien-xchange.asp) is Germany's benchmark stock market index and is run on the Xetra platform, where it is sometimes referred to as the Xetra DAX.
...
Shortly thereafter, the New York Stock Exchange (NYSE) launched its [Designated Order Turnaround](https://www.investopedia.com/terms/d/dot.asp) (DOT) system. This allowed brokers to route orders directly to specialists on the floor. In 1984, SuperDOT emerged, which effectively expanded the number of shares sent to the floor at one time to nearly 100,000. Nasdaq soon offered the Small Order Execution System (SOES) to compete with NYSE.
