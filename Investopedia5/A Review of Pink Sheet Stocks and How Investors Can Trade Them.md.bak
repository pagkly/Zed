...
> ## Excerpt
> Pink sheets are listings for stocks that trade over-the-counter (OTC) in the U.S. rather than on a major stock exchange. Most are penny stocks.
...
Over-the-counter (OTC) refers to the process of trading for the securities of unlisted companies. The shares trade via a [broker-dealer network](https://www.investopedia.com/terms/b/broker-dealer.asp) rather than on a centralized stock exchange.
...
Many OTC stocks are issued by companies that are too small in size to be listed on a major U.S. exchange. They may find the $500,000 NYSE listing fee, or the $75,000 Nasdaq fee, to be a financial barrier.45
...
These companies are even smaller than those that list on the OTCBB. Pink sheet penny stocks can trade infrequently resulting in a lack of liquidity.6 Because of the low liquidity, investors might have difficulty finding an accurate price and may find it difficult to buy or sell when they want to enter into a trade.
