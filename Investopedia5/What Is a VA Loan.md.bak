...
> ## Excerpt
> A VA loan is a mortgage loan available through the U.S. Department of Veterans Affairs to assist service members, veterans and eligible surviving spouses.
...
-   [Interest rate reduction refinance loans](https://www.investopedia.com/terms/i/interest-rate-reduction-refinance-loan-irrrl.asp) (IRRRLs), also known as streamline refinance loans, help borrowers obtain a lower interest rate by refinancing an existing VA loan. This is a VA-loan-to-VA-loan process that allows homeowners to refinance a fixed loan at a lower interest rate or convert an adjustable-rate mortgage (ARM) into a fixed-rate mortgage.
