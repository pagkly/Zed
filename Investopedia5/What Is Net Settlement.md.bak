...
> ## Excerpt
> Net settlement refers to the resolution of all of a bank's transactions at the end of the day, including all cash, checks and electronic transfers.
...
The bank then sends its settlement file to a Federal Reserve Bank, which credits it with any funds that are due to be paid to it via the interbank settlement system.1
...
In banking, gross settlement is not the same as net settlement. In particular, a [real-time gross settlement system](https://www.investopedia.com/terms/r/rtgs.asp) differs from a net settlement .
