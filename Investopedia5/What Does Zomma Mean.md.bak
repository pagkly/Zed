...
source: https://www.investopedia.com/terms/z/zomma.asp
...
> ## Excerpt
> Zomma is a measure of the degree to which the gamma of a derivative is sensitive to changes in implied volatility. It is also known as DgammaDvol.
...
Zomma is a third-order risk measure of the degree to which the [gamma](https://www.investopedia.com/terms/g/gamma.asp) of an options contract is sensitive to changes in [implied volatility](https://www.investopedia.com/terms/i/iv.asp). It is also referred to as "D-gamma/D-vol." Gamma itself is a second-order risk measure of an option's sensitivity of its [delta](https://www.investopedia.com/terms/d/delta.asp) to changes in the underlying price.

Zomma is part of a category of measurements used to assess the price sensitivity of a derivative to various factors, such as changes in [interest rates](https://www.investopedia.com/terms/i/interestrate.asp), [volatility](https://www.investopedia.com/terms/v/volatility.asp), or the [spot price](https://www.investopedia.com/terms/s/spotprice.asp) of the derivative's [underlying asset](https://www.investopedia.com/terms/u/underlying-asset.asp). These measurements are commonly referred to as "[Greeks](https://www.investopedia.com/terms/g/greeks.asp)" because they are denoted by Greek symbols; however, the word "zomma" was made up by traders to sound like a Greek letter and is not part of the Greek alphabet.

### Key Takeaways

-   Zomma is an option's sensitivity of gamma to changes in implied volatility, where a higher zomma indicates small changes in IV translate into large changes in gamma.
-   It is one of the so-called minor Greeks used to manage higher-order risk in derivative trading, most commonly in the context of options trading.
-   Zomma is a highly abstract concept that can only be understood in relation to other measurements used to evaluate an option's risk position.
...
Derivative traders and portfolio managers often use zomma to determine the effectiveness of a [gamma hedged](https://www.investopedia.com/terms/g/gamma-hedging.asp) portfolio. In this context, zomma would measure fluctuations in the volatility and/or the underlying assets of that portfolio.
