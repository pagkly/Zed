...
A doji—or more accurately, "dо̄ji"—is a name for a session in which the candlestick for a security has an open and close that are virtually equal and are often components in patterns. Doji candlesticks look like a cross, inverted cross or plus sign. Alone, doji are neutral patterns that are also featured [in a number of important patterns](https://www.investopedia.com/articles/trading/05/playinggaps.asp).

A doji candlestick forms when a security's open and close are virtually equal for the given time period and generally signals a [reversal](https://www.investopedia.com/terms/r/reversal.asp) pattern for [technical analysts](https://www.investopedia.com/terms/t/technical-analyst.asp). In Japanese, "doji" means blunder or mistake, referring to the rarity of having the open and close price be exactly the same.1
...
Depending on where the open/close line falls, a doji can be described as a [gravestone](https://www.investopedia.com/terms/g/gravestone-doji.asp), [long-legged](https://www.investopedia.com/terms/l/long-legged-doji.asp), or [dragonfly](https://www.investopedia.com/terms/d/dragonfly-doji.asp).
...
Some analysts interpret this as a sign of reversal. However, it may also be a time when buyers or sellers are gaining [momentum](https://www.investopedia.com/terms/m/momentum.asp) for a continuation trend. Doji are commonly seen in periods of consolidation and can help analysts identify potential price [breakouts](https://www.investopedia.com/terms/b/breakout.asp).2

## Example of How to Use a Doji

The following chart shows a gravestone doji in Cyanotech Corp.'s stock from February 2018 following a significant high-volume uptrend, which could indicate a bearish reversal over the near-term following the [breakout](https://www.investopedia.com/terms/b/breakout.asp).
...
[Spinning tops](https://www.investopedia.com/terms/s/spinning-top.asp) are quite similar to doji, but their bodies are larger, where the open and close are relatively close. A candle's real body can generally represent up to 5% of the size of the entire candle's range in order to be classified as a doji. Any more than that, it becomes a spinning top.
