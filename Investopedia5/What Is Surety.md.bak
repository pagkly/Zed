...
The party that guarantees the debt is referred to as the surety, or as the [guarantor](https://www.investopedia.com/terms/g/guarantor.asp).
...
A surety is most common in contracts in which one party questions whether the [counterparty](https://www.investopedia.com/terms/c/counterparty.asp) in the contract will be able to fulfill all requirements. The party may require the counterparty to come forward with a guarantor [in order to reduce risk](https://www.investopedia.com/terms/c/counterpartyrisk.asp), with the guarantor entering into a contract of suretyship. This is intended to lower risk to the [lender](https://www.investopedia.com/terms/l/lender.asp), which might, in turn, lower interest rates for the borrower. A surety can be in the form of a "surety bond."
...
A surety is not a [bank guarantee](https://www.investopedia.com/terms/b/bankguarantee.asp). Where the surety is liable for any performance risk posed by the principal, the bank guarantee is liable for the financial risk of the contracted project.
