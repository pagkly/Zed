...
Operating cash flow represents the cash impact of a company's net income (NI) from its primary business activities. Operating cash flow, also referred to as [[Cash Flow From Operating Activities (CFO) Definition|cash flow from operating activities]], is the first section presented on the cash flow statement.
