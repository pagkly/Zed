...
While realized gains are actualized, an unrealized gain is a potential profit that exists on paper, resulting from an investment. It is an increase in the value of an [asset](https://www.investopedia.com/terms/a/asset.asp) that has yet to be sold for cash, such as a stock position that has increased in value but still remains open. A gain becomes realized once the position is sold for a profit.
...
For example, if an investor holds a stock for longer than one year, his tax rate is reduced to the long-term [capital gains tax](https://www.investopedia.com/terms/c/capital_gains_tax.asp). Further, if an investor wants to move the capital gains tax burden to another tax year, he can sell the stock in January of a proceeding year, rather than selling in the current year.
