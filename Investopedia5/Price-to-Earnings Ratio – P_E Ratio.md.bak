---
alias: [Price-to-Earnings Ratio – P/E Ratio Definition, Formula and Examples]
created: 2021-03-02T22:49:52 (UTC +11:00)
tags: [Price-to-Earnings Ratio – P/E Ratio Definition, Formula and Examples, Price-to-Earnings Ratio – P/E Ratio]
...
To [determine the P/E value](https://www.investopedia.com/ask/answers/070314/how-do-i-calculate-pe-ratio-company.asp), one simply must divide the current stock price by the [earnings per share (EPS)](https://www.investopedia.com/terms/e/eps.asp). The current stock price (P) can be gleaned by plugging a stock’s ticker symbol into any finance website, and although this concrete value reflects what investors must currently pay for a stock, the EPS is a slightly more nebulous figure.

EPS comes in two main varieties. The first is a metric listed in the fundamentals section of most finance sites; with the notation "P/E (TTM)," where “TTM” is a Wall Street acronym for “[trailing 12 months](https://www.investopedia.com/terms/t/ttm.asp).” This number signals the company's performance over the past 12 months. The second type of EPS is found in a company's earnings release, which often provides EPS [guidance](https://www.investopedia.com/terms/g/guidance.asp). This is the company's best-educated guess of what it expects to earn in the future.

Sometimes, analysts are interested in long term valuation trends and consider the P/E 10 or P/E 30 measures, which average the past 10 or past 30 years of earnings, respectively. These measures are often used when trying to gauge the overall value of a stock index, such as the S&P 500 since these longer term measures can compensate for changes in the [business cycle](https://www.investopedia.com/terms/b/businesscycle.asp). The P/E ratio of the S&P 500 has fluctuated from a low of around 6x (in 1949) to over 120x (in 2009). The long-term average P/E for the S&P 500 is around 15x, meaning that the stocks that make up the index collectively command a premium 15 times greater than their weighted average earnings.1

## Forward Price-To-Earnings

These two types of EPS metrics factor into the most common types of P/E ratios: the [forward P/E](https://www.investopedia.com/terms/f/forwardpe.asp) and the [trailing P/E](https://www.investopedia.com/terms/t/trailingpe.asp). A third and less common variation uses the sum of the last two actual quarters and the estimates of the next two quarters.

The forward (or leading) P/E uses [future earnings guidance](https://www.investopedia.com/articles/analyst/03/012903.asp) rather than trailing figures. Sometimes called "estimated price to earnings," this forward-looking indicator is useful for comparing current earnings to future earnings and helps provide a clearer picture of what earnings will look like – without changes and other accounting adjustments.

However, there are inherent problems with the forward P/E metric – namely, companies could underestimate earnings in order to beat the estimate P/E when the next quarter's earnings are announced. Other companies may overstate the estimate and later adjust it going into their next [earnings announcement](https://www.investopedia.com/terms/e/earnings-announcement.asp). Furthermore, external analysts may also provide estimates, which may diverge from the company estimates, creating confusion.

## Trailing Price-To-Earnings

The trailing P/E relies on past performance by dividing the [current share price](https://www.investopedia.com/ask/answers/061615/how-companys-share-price-determined.asp) by the total EPS earnings over the past 12 months. It's the most popular P/E metric because it's the most objective – assuming the company reported earnings accurately. Some investors prefer to look at the trailing P/E because they don't trust another individual’s [earnings estimates](https://www.investopedia.com/terms/e/earningsestimate.asp). But the trailing P/E also has its share of shortcomings – namely, a company’s past performance doesn’t signal future behavior.

Investors should thus commit money based on future [earnings power](https://www.investopedia.com/terms/e/earnings-power.asp), not the past. The fact that the EPS number remains constant, while the stock prices fluctuate, is also a problem. If a major company event drives the stock price significantly higher or lower, the trailing P/E will be less reflective of those changes.
...
<iframe id="mntl-sc-block-iframe__uri_1-0" data-src="https://www.youtube.com/embed/AuxGYz5nsGQ" frameborder="0" allowfullscreen="false"></iframe>

## P/E vs. Earnings Yield

The inverse of the P/E ratio is the [earnings yield](https://www.investopedia.com/terms/e/earningsyield.asp) (which can be thought of like the E/P ratio). The earnings yield is thus defined as EPS divided by the stock price, expressed as a percentage.
...
Analysts may also make a distinction between absolute P/E and [relative P/E](https://www.investopedia.com/terms/p/price-earningsrelative.asp) ratios in their analysis.
...
Like any other fundamental designed to inform investors on whether or not a stock is worth buying, the price-to-earnings ratio comes with a few important [limitations](https://www.investopedia.com/ask/answers/070214/how-can-pricetoearnings-pe-ratio-mislead-investors.asp) that are important to take into account, as investors may often be led to believe that there is one single metric that will provide complete insight into an investment decision, which is virtually never the case. Companies that aren't profitable, and consequently have no earnings—or negative earnings per share, pose a challenge when it comes to calculating their P/E. Opinions vary on how to deal with this. Some say there is a negative P/E, others assign a P/E of 0, while most just say the P/E doesn't exist ([not available](https://www.investopedia.com/ask/answers/09/price-earnings-pe-not-applicable.asp)—N/A) or is not interpretable until a company becomes profitable for purposes of comparison.
...
Moreover, because a company’s debt can affect both the prices of shares and the company’s earnings, [leverage](https://www.investopedia.com/terms/l/leverage.asp) can skew P/E ratios as well. For example, suppose there are two similar companies that differ primarily in the amount of debt they take on. The one with more debt will likely have a lower P/E value than the one with less debt. However, if business is good, the one with more debt stands to see higher earnings because of the risks it has taken.
...
The question of what is a good or bad price to earnings ratio will necessarily depend on the industry in which the company is operating. Some industries will have higher average price to earnings ratios, while others will have lower ratios. For example, as of January 2020, publicly-traded US coal companies had an average P/E ratio of only about 7, compared to more than 60 for software companies.4 If you want to get a general idea of whether a particular P/E ratio is high or low, you can compare it to the average P/E of the competitors within its industry.
