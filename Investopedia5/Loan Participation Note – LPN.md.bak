...
> ## Excerpt
> A loan participation note (LPN) is a type of debt instrument that allows for portions of an outstanding loan to be purchased instead of as a whole.
...
A loan participation note (LPN) is a [fixed-income security](https://www.investopedia.com/terms/f/fixed-incomesecurity.asp) that permits investors to buy portions of an outstanding loan or package of loans. LPN holders participate on a [pro-rata basis](https://www.investopedia.com/terms/p/pro-rata.asp) in collecting interest and principal payments, and are similarly exposed to a proportional risk of default.
...
One of the purposes of loan participation notes is to help meet the needs of borrowers within a local community. Several other institutions have also sprung up for similar reasons. [Credit unions](https://www.investopedia.com/terms/c/creditunion.asp) are one such example. A credit union is a financial cooperative that is created, owned and operated by their participants. While some credit unions can be large and national in scale, such as the Navy Federal Credit Union (NFCU), others are smaller in scope.
