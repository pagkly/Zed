...
> ## Excerpt
> Revenue cap regulation seeks to limit the amount of total revenue received by a company which holds [[Monopoly|monopoly]] status in the industry.
...
Governmental regulatory authorities impose revenue cap regulations on industries that have regulated monopolies, such as gas, water, and electric utility producers. Because these industries [[Supply|supply]] essential services to the populace, regulators seeking to balance the availability, affordability, and quality of the service with the costs incurred by producers to provide the service.

Revenue cap regulation is similar to [[price cap regulation]](https://www.investopedia.com/terms/p/price-cap-regulation.asp), which seeks to control the prices companies can charge, and [[rate of return regulation]](https://www.investopedia.com/terms/r/rate-of-[[Return|return]]-regulation.asp), which seeks to control the rate of return earned by companies.
