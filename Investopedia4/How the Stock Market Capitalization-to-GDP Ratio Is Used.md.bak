...
> ## Excerpt
> The [[Stock|stock]] [[Market Capitalization|market capitalization]] to GDP ratio is used to determine whether an overall market is under- or overvalued compared to historical averages.
...
The [[Stock|stock]] [[Market Capitalization|market capitalization]]-to-GDP ratio is a ratio used to determine whether an overall market is undervalued or overvalued compared to a historical average. The ratio can be used to focus on specific markets, such as the U.S. market, or it can be applied to the [[global market]](https://www.investopedia.com/trump-tweets-topple-global-markets-4686394), depending on what values are used in the calculation. It is calculated by dividing the stock market cap by [[gross domestic product]](https://www.investopedia.com/terms/g/gdp.asp) (GDP). The stock market capitalization-to-GDP ratio is also known as the Buffett Indicator—after investor [[Warren Buffett]](https://www.investopedia.com/ask/answers/022715/whats-best-way-contact-warren-buffett.asp), who popularized its use.
...
-   The [[Stock|stock]] [[Market Capitalization|market capitalization]]-to-GDP ratio is a ratio used to determine whether an overall market is undervalued or overvalued compared to a historical average.
...
-   The [[Stock|stock]] [[Market Capitalization|market capitalization]]-to-GDP ratio is also known as the Buffett Indicator—after investor Warren Buffett, who popularized its use.

## What the [[Stock]] [[Market Capitalization]]-to-GDP Ratio Can Tell You

The use of the [[Stock|stock]] [[Market Capitalization|market capitalization]]-to-GDP ratio increased in prominence after Warren Buffett once commented that it was "probably the best single measure of where valuations stand at any given moment."1

It is a measure of the total value of all publicly traded [[Stocks|stocks]] in a market divided by that economy's [[gross domestic product]](https://www.investopedia.com/terms/g/gdp.asp) (GDP). The ratio compares the value of all stocks at an aggregate level to the value of the country's total output. The result of this calculation is the percentage of GDP that represents [[Stock|stock]] market value.

To calculate the total value of all publicly traded [[Stocks|stocks]] in the U.S., most analysts use [[The Wilshire 5000 Total Market Index]](https://www.investopedia.com/terms/w/wilshire5000equityindex.asp), which is an index that represents the value of all stocks in the U.S. markets. The quarterly GDP is used as the denominator in the ratio calculation.
...
In this case, 151.7% of GDP represents the overall [[Stock|stock]] market value and indicates it is overvalued.
