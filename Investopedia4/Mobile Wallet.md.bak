...
> ## Excerpt
> A [[Mobile Wallet|mobile wallet]] is a virtual wallet that stores payment card information on a mobile device.
...
A [[Mobile Wallet|mobile wallet]] is a virtual wallet that stores payment card information on a mobile device. Mobile wallets are a convenient way for a user to make in-store payments and can be used at merchants [[Listed|listed]] with the mobile wallet service provider.

## Understanding a [[Mobile Wallet]]

The business-consumer relationship is swiftly becoming digital. From [[e-commerce platforms]](https://www.investopedia.com/articles/investing/102814/navigating-ecommerce-alibaba-ebay-and-amazon.asp) to [[robo-advisors]](https://www.investopedia.com/terms/r/roboadvisor-roboadviser.asp), businesses are transforming the way they operate to meet the ever-changing needs of their clients and the increasing use of mobile phones and devices. Companies in the financial sector are emerging that [[Offer|offer]] digital platforms and solutions and recognized as members of the [[Fintech]](https://www.investopedia.com/terms/f/fintech.asp) sector. These emerging companies create disruptive tools and services that are easily accessible at a low cost. One area of the financial industry that is rife with innovations is the payments sector. Using mobile technology such as smartphones, tablets or smartwatches, companies and users are adapting to online and offline transactions using devices such as a [[Mobile Wallet|mobile wallet]].

The [[Mobile Wallet|mobile wallet]] is an app that can be installed on a smartphone or it is an existing built-in feature of a smartphone. A mobile wallet stores credit card, debit card, coupons, or reward cards information. Once the app is installed and the user inputs payment information, the wallet stores this information by linking a [[personal identification format]](https://www.investopedia.com/terms/p/personally-identifiable-information-pii.asp) such as a number or key, QR code or an image of the owner to each card that is stored.
