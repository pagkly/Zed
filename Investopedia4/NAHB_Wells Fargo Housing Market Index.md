...
The HMI is produced by the [[Economics|economics]] arm of the NAHB, one-third of whose members are home builders or remodelers. The remaining members are in closely related sectors such as building materials, housing [[Finance|finance]], and [[real estate]](https://www.investopedia.com/terms/r/realestate.asp) sales. NAHB’s builder members annually construct approximately 80% of the new homes built in the U.S.
...
A diffusion index is then calculated for each series by applying these formulas, after which each resulting index is seasonally adjusted and [[Weighted|weighted]] to generate the HMI.

## The Housing [[Market Index]] as an [[Economic Indicator]]

The HMI displays a close [[Correlation|correlation]] with U.S. single-family [[housing starts]](https://www.investopedia.com/terms/h/housingstarts.asp), which refers to the start of construction on privately-owned homes. [[Housing Starts|Housing starts]] data are key indicators of how the U.S. economy is faring and are supplied monthly by the U.S. [[Census Bureau]](https://www.investopedia.com/terms/b/bureauofcensus.asp).

The HMI is a gauge of homebuyers’ intentions; it provides valuable clues on the near-term direction of [[Housing Starts|housing starts]]. The HMI is released monthly at 10 a.m. EST the day before housing starts data are released by the Census Bureau, which is typically mid-month.

The NAHB/Wells Fargo HMI has significant power in predicting single-family [[Housing Starts|housing starts]] and permits. The information provided by the HMI is as useful today as it has been over the past two decades.
