...
[[Risk]] analysis is the process of assessing the likelihood of an [[adverse event]](https://www.investopedia.com/terms/m/maximum-foreseeable-loss.asp) occurring within the corporate, government, or environmental sector. Risk analysis is the study of the [[Underlying|underlying]] uncertainty of a given course of action and refers to the uncertainty of forecasted [[cash flow]](https://www.investopedia.com/terms/c/cashflow.asp) streams, the variance of [[Portfolio|portfolio]] or [[Stock|stock]] returns, the probability of a project's success or failure, and possible future economic states.
...
-   Quantitative [[Risk|risk]] analysis uses mathematical models and simulations to assign numerical values to risk.
-   Qualitative [[Risk|risk]] analysis relies on a person's subjective judgment to build a theoretical model of risk for a given scenario.
-   [[Risk]] analysis is often both an art and a science.

## Understanding [[Risk]] Analysis

[[Risk Assessment|Risk assessment]] enables corporations, governments, and investors to assess the probability that an adverse event might negatively impact a business, economy, project, or [[investment]](https://www.investopedia.com/terms/i/investment.asp).  Assessing [[Risk|risk]] is essential for determining how worthwhile a specific project or investment is and the best process(es) to mitigate those risks. Risk analysis provides different approaches that can be used to assess the [[risk and reward tradeoff]](https://www.investopedia.com/terms/r/riskreturntradeoff.asp) of a potential investment opportunity.

A [[Risk|risk]] analyst starts by identifying what could potentially go wrong. These negatives must be weighed against a probability metric that measures the likelihood of the event occurring.

Finally, [[Risk|risk]] analysis attempts to estimate the extent of the impact that [[Will|will]] be made if the event happens. Many risks that are identified, such as [[market risk]](https://www.investopedia.com/terms/m/marketrisk.asp), credit risk, currency risk, and so on, can be reduced through [[hedging]](https://www.investopedia.com/trading/hedging-beginners-guide/) or by purchasing insurance.

Almost all sorts of large businesses require a minimum sort of [[Risk|risk]] analysis. For example, commercial banks need to properly [[Hedge|hedge]] foreign exchange exposure of overseas loans, while large department stores must factor in the possibility of reduced revenues due to a global [[recession]](https://www.investopedia.com/terms/r/recession.asp). It is important to know that risk analysis allows professionals to identify and mitigate risks, but not avoid them completely.
...
Elsewhere, a [[portfolio manager]](https://www.investopedia.com/terms/p/portfoliomanager.asp) might use a sensitivity table to assess how changes to the different values of each [[security]](https://www.investopedia.com/terms/s/[[Security|security]].asp) in a [[Portfolio|portfolio]] [[Will|will]] impact the variance of the portfolio. Other types of [[Risk|risk]] management tools include decision trees and break-even analysis.

### Qualitative [[Risk]] Analysis

[Qualitative](https://www.investopedia.com/terms/q/qualitativeanalysis.asp) [[Risk|risk]] analysis is an analytical method that does not identify and evaluate risks with numerical and quantitative ratings. [[Qualitative Analysis|Qualitative analysis]] involves a written definition of the uncertainties, an evaluation of the extent of the impact (if the risk ensues), and countermeasure plans in the case of a negative event occurring.

Examples of qualitative [[Risk|risk]] tools include [[SWOT analysis]](https://www.investopedia.com/terms/s/swot.asp), cause and effect diagrams, decision matrix, [[game theory]](https://www.investopedia.com/terms/g/gametheory.asp), etc. A firm that wants to measure the impact of a [[Security|security]] breach on its servers may use a qualitative risk technique to help prepare it for any lost income that may occur from a data breach.

While most investors are concerned about downside [[Risk|risk]], mathematically, the risk is the variance both to the downside and the [[Upside|upside]].

## Example of [[Risk]] Analysis: Value at Risk (VaR)

[Value at risk](https://www.investopedia.com/terms/v/var.asp) (VaR) is a statistic that measures and quantifies the level of financial [[Risk|risk]] within a firm, [[portfolio]](https://www.investopedia.com/terms/p/[[Portfolio|portfolio]].asp), or position over a specific time frame. This metric is most commonly used by investment and commercial banks to determine the extent and occurrence ratio of potential losses in their institutional portfolios. Risk managers use VaR to measure and control the level of risk exposure. One can apply VaR calculations to specific positions or whole portfolios or to measure firm-wide risk exposure.

VaR is calculated by shifting [[historical returns]](https://www.investopedia.com/terms/h/historical-returns.asp) from worst to best with the assumption that returns [[Will|will]] be repeated, especially where it concerns [[Risk|risk]]. As a historical example, let's look at the [[Nasdaq]] 100 [[ETF]](https://www.investopedia.com/terms/e/etf.asp), which trades under the symbol QQQ (sometimes called the "cubes") and which started trading in March of 1999. If we calculate each daily [[Return|return]], we produce a rich data set of more than 1,400 points. The worst are generally visualized on the left, while the best returns are placed on the right.

For more than 250 days, the daily [[Return|return]] for the ETF was calculated between 0% and 1%. In January 2000, the ETF returned 12.4%. But there are points at which the ETF resulted in losses as well. At its worst, the ETF ran daily losses of 4% to 8%. This period is referred to as the ETF's worst 5%. Based on these historic returns, we can assume with 95% certainty that the ETF's largest losses won't go beyond 4%. So if we invest $100, we can say with 95% certainty that our losses won't go beyond $4.

One important thing to keep in mind is that VaR doesn't provide analysts with absolute certainty. Instead, it's an estimate based on probabilities. The probability gets higher if you consider the higher returns, and only consider the worst 1% of the returns. The [[Nasdaq]] 100 ETF's losses of 7% to 8% represent the worst 1% of its performance. We can thus assume with 99% certainty that our worst [[Return|return]] won't lose us $7 on our investment. We can also say with 99% certainty that a $100 investment [[Will|will]] only lose us a maximum of $7.

## Limitations of [[Risk]] Analysis

[[Risk]] is a probabilistic measure and so can never tell you for sure what your precise risk exposure is at a given time, only what the distribution of possible losses are likely to be if and when they occur. There are also no standard methods for calculating and analyzing risk, and even VaR can have several different ways of approaching the task. Risk is often assumed to occur using [[Normal Distribution|normal distribution]] probabilities, which in reality rarely occur and cannot account for extreme or "[black swan](https://www.investopedia.com/terms/b/blackswan.asp)" events.

The [financial crisis of](https://www.investopedia.com/terms/f/financial-crisis.asp) [2008](https://www.investopedia.com/articles/[[Economics|economics]]/09/financial-crisis-review.asp), for example, exposed these problems as relatively benign VaR calculations greatly understated the potential occurrence of [[Risk|risk]] events posed by portfolios of [[subprime mortgages]](https://www.investopedia.com/terms/s/subprime_mortgage.asp).
