...
-   A hanging man is a [[bearish]](https://www.investopedia.com/terms/b/bear.asp) [[Reversal|reversal]] candlestick pattern that occurs after a price advance. The advance can be small or large, but should be composed of at least a few price bars moving higher overall.
...
-   The hanging man pattern is just a warning. The price must move lower on the next candle in order for the hanging man to be a valid [[Reversal|reversal]] pattern. This is called confirmation.
...
The example highlights that the hanging man doesn't need to come after a prolonged advance. Rather it can potentially mark the end of a short-term [[Rally|rally]] within a longer-term downtrend.
...
One of the limitations of the hanging man, and many candlestick patterns, is that waiting for confirmation can result in a poor entry point. The price can move so quickly within the two periods that the potential reward from the trade may no longer justify the [[Risk|risk]].
...
There is also no assurance the price [[Will|will]] decline after a hanging man forms, even if there is a confirmation candle. This is why placing a stop loss, to control [[Risk|risk]], above the high of the hanging man is recommend when a short trade is initiated.
