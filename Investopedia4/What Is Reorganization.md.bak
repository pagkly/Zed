...
To get the approval of a bankruptcy judge, the reorganization plan must include drastic steps to reduce costs and increase revenue. If the plan is rejected or is approved but does not succeed, the company is forced into liquidation. Its assets [[Will|will]] be sold and distributed to its creditors.

A reorganization requires a [[restatement]](https://www.investopedia.com/terms/r/restatement.asp) of the company's assets and liabilities as well as negotiations with major [[creditors]](https://www.investopedia.com/terms/c/[[Creditor|creditor]].asp) to set schedules for repayment.
...
Once the bankruptcy court approves the reorganization plan, the company [[Will|will]] restructure its finances, operations, management and whatever else is deemed necessary to revive it. It also will begin paying its creditors according to a revised schedule.
...
Even if the company emerges successfully from the reorganization, it may issue new [[Shares|shares]], which [[Will|will]] wipe out the previous shareholders.

If the reorganization is unsuccessful, the company [[Will|will]] [[Liquidate|liquidate]] and sell off any remaining assets. Shareholders are last in line to receive any proceeds and receive nothing unless money is left over after repaying creditors, senior lenders, bondholders, and [[preferred stock]](https://www.investopedia.com/terms/p/preferredstock.asp) shareholders in full.
