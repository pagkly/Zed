...
A required minimum distribution (RMD) is the amount of money that must be withdrawn from an employer-sponsored retirement plan, [[traditional IRA]](https://www.investopedia.com/terms/t/traditionalira.asp), SEP, or [[SIMPLE]](https://www.investopedia.com/terms/s/simple-ira.asp) individual retirement account (IRA) by owners and [[Qualified Retirement Plan|qualified retirement plan]] participants of retirement age.
...
-   If you have multiple accounts, you [[Will|will]] usually need to calculate the RMD for each separately and may have to take an RMD from each.
-   The SECURE Act of 2019 changed the distribution rules for some inherited IRAs, effectively eliminating the "stretch IRA"—an [[Estate Planning|estate planning]] strategy that extended the tax-deferral benefits of IRAs.
...
2.  Find the distribution factor [[Listed|listed]] on the calculation tables that corresponds to your age on your birthday of the current year. For most people, this factor number ranges from 27.4 all the way down to 1.9. As a person gets older, the factor number goes down.
