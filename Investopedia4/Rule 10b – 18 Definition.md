...
> ## Excerpt
> Rule 10b – 18 is an SEC rule that protects companies and affiliated purchasers by providing a safe harbor when they repurchase the company's [[Stock|stock]].
...
Rule 10B-18 is a [[Securities and Exchange Commission]](https://www.investopedia.com/terms/s/sec.asp) (SEC) rule that is intended to reduce [[Liability|liability]] for companies (and their affiliated purchasers) when the company repurchases [[Shares|shares]] of the company's [[Common Stock|common stock]]. Rule 10B-18 is considered a safe harbor provision. A safe harbor is a legal provision to reduce or eliminate legal or regulatory liability in certain situations as long as certain conditions are met. If the company abides by the four conditions of Rule 10B-18 when it is repurchasing the shares, the SEC [[Will|will]] not deem the transactions in violation of anti-fraud provisions of the [[Securities Exchange Act of 1934]].

## Understanding Rule 10b – 18

Rule 10B-18 provides information about the manner, timing, price, and volume of repurchases by an issuer. While compliance with the rule is voluntary, if an issuer wants to reduce or eliminate their regulatory [[Liability|liability]], they must satisfy each of the four conditions daily. Otherwise, repurchases [[Will|will]] not fall under the safe harbor for that day.

### Key Takeaways

-   Rule 10B-18 is a [[Securities and Exchange Commission (SEC)]] rule that is intended to reduce [[Liability|liability]] for companies (and their affiliated purchasers) when the company repurchases [[Shares|shares]] of the company's [[Common Stock|common stock]].
-   Rule 10B-18 is considered a safe harbor provision; it is not mandatory that a company follows the conditions of the rule, but in order to reduce their [[Liability|liability]], companies may adhere by its guidance regarding the manner, timing, price, and volume of repurchases.
...
-   The total number of [[Shares|shares]] purchased
-   The average price paid per share
-   The total number of [[Shares|shares]] purchased under publicly-announced repurchase programs
-   The maximum number of [[Shares|shares]] (or maximum dollar amount) it can repurchase under these programs
