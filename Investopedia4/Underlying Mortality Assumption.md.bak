...
This is based on mortality tables, which are statistical tables of expected annual mortality rates. Because of the critical importance of the [[Underlying Mortality Assumption|underlying mortality assumption]], actuaries have to follow guidelines set by pension and insurance regulators in deciding on an appropriate assumption, also called the mortality assumption.

## Understanding the [[Underlying Mortality Assumption]]

The [[Underlying Mortality Assumption|underlying mortality assumption]] is a key variable in estimating [[life expectancies]](https://www.investopedia.com/terms/l/lifeexpectancy.asp), which in turn determines the cost of insurance for an insurer and the long-term obligations of a pension fund. If the [[Underlying|underlying]] mortality assumption is too low, a life insurer may underestimate the actual cost of insurance and may have to pay out more in [death benefit claims](https://www.investopedia.com/terms/d/deathbenefit.asp) than it had forecast. Conversely, if the underlying mortality assumption is too high, the actuary may underestimate life expectancies of the [[pension plan]](https://www.investopedia.com/terms/p/pensionplan.asp) members and hence, the long-term obligations of the pension fund.
...
According to the Centers for Disease Control 2019 data, there were 2,854,838 deaths in the U.S. and a death rate of 869.7 deaths per 100,000 population. [[Life Expectancy|Life expectancy]] at birth was 78.8 years, and the infant mortality rate was 5.58 deaths per 1,000 live births.1
