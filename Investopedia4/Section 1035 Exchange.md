...
> ## Excerpt
> A 1035 exchange is a tax-free exchange of an existing annuity contract, life insurance policy, or [[Endowment|endowment]] for another of like kind.
...
A 1035 exchange is a provision in the Internal Revenue Service (IRS) code allowing for a tax-free transfer of an existing annuity contract, life insurance policy, long-term care product, or [[Endowment|endowment]] for another one of like kind. To qualify for a [[Section 1035 Exchange|Section 1035 exchange]], the contract or policy owner must also meet certain other requirements.

Both full and partial 1035 exchanges are permitted, although some rules [[Will|will]] vary by company. Typically, 1035 exchanges between products within the same company are not reportable for tax purposes as long as the IRS criteria for the exchange are satisfied.1
...
-   Life insurance policyholders can use a [[Section 1035 Exchange|section 1035 exchange]] to trade an old policy in on a new one with better features.
...
The new product for which a [modified [[Endowment|endowment]] contract (MEC)](https://www.investopedia.com/terms/m/modified-endowment-contract.asp) was exchanged [[Will|will]] also be a MEC. The 1035 exchange does not change that status.

Under a 1035 exchange, the contract or policy owner cannot take constructive receipt of the funds and then use them to buy a new policy. The money must be transferred directly.5 To further qualify, the annuitant or policyholder must remain the same. For example, a 1035 exchange from an annuity owned by Joe Sample cannot be exchanged into an annuity owned by Jane Sample or into a [[Joint|joint]] annuity owned by Joe and Jane Sample.3
