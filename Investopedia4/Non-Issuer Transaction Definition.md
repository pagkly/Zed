...
> ## Excerpt
> Non-issuer transactions refer to any [[Disposition|disposition]] of a [[Security|security]] that does not confer a benefit to the issuing company.
...
A non-issuer transaction is a transaction involving a [[Security|security]] that is not directly or indirectly executed for the benefit of the [[issuing]](https://www.investopedia.com/terms/i/issuer.asp) company. Most deals that occur on the [[secondary market]](https://www.investopedia.com/terms/s/secondarymarket.asp), such as [[Stock|stock]] exchanges, involve non-issuer transactions; with the exception of initial public offerings (IPOs); secondary offerings; or share buybacks that [[Will|will]] involve the issuer.
...
-   An isolated non-issuer transaction involves an ad-hoc exchange of securities between two private parties, often on an [[Over-The-Counter (OTC)|over-the-counter (OTC)]] basis, exempting it from registration.
...
Isolated non-issuer transactions are exempt from the registration requirements of the [[Securities and Exchange Commission]](https://www.investopedia.com/terms/s/sec.asp) (SEC). For instance, if Joe sells 100 [[Shares|shares]] of XYZ [[Stock|stock]] to his brother, this transaction would be exempt from registration requirements.

However, once Joe sells those 100 [[Shares|shares]] to his brother, he officially becomes what's known as a non-issuer [[broker-dealer]](https://www.investopedia.com/terms/b/broker-dealer.asp). Non-issuers can be described as a person or company that doesn't issue securities or have plans to do so and a broker-dealer is a person or firm that buys and sells [[securities]](https://www.investopedia.com/terms/s/[[Security|security]].asp) for its own account or on behalf of its customers.
