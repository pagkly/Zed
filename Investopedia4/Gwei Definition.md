...
source: https://www.investopedia.com/terms/g/gwei-[[Ethereum|ethereum]].asp
author: Carla Tardi
---
...
> ## Excerpt
> Gwei is a denomination of the [[Cryptocurrency|cryptocurrency]] [[Ether (ETH)|ether (ETH)]], which is used on the [[Ethereum]] network.
...
Gwei is a denomination of the [[Cryptocurrency|cryptocurrency]] [[Ether (ETH)|ether (ETH)]], which is used on the [[Ethereum]](https://www.investopedia.com/terms/e/[[Ethereum|ethereum]].asp) network. Ethereum is a blockchain platform, like Bitcoin, where users transact with each other to buy and sell goods and services without a middle man or interference from a [[Third Party|third party]].

## More About Gwei

### Gwei is Barely Perceptible

Gwei is also called nanoether, or simply nano, to denote the ninth power of the fractional ETH. If you try to imagine the physical size of a gwei—the way you can visualize 100 pennies—you likely [[Will|will]] not succeed, because measurements in ether are essentially imperceptible, like digital dust. As with other [[cryptocurrencies]](https://www.investopedia.com/terms/c/[[Cryptocurrency|cryptocurrency]].asp), ether is really only used for technical cases and writing code.
...
-   Gwei is a denomination of the [[Cryptocurrency|cryptocurrency]] [[Ether (ETH)|ether (ETH)]], which is used on the [[Ethereum]] network to buy and sell goods and services.
...
-   **Twei (szabo)**—for Nick Szabo computer scientist, legal scholar, and cryptographer known for his pioneering research in digital contracts and [[Digital Currency|digital currency]].
