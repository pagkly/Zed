...
A hybrid [[annuity]](https://www.investopedia.com/investing/overview-of-annuities/) is a retirement income investment that allows investors to split their funds between fixed-rate and variable-rate components. Investors can divide their savings between conservative assets that [[Offer|offer]] a low but guaranteed rate of [[Return|return]] and riskier assets that offer the potential for higher returns. As in any annuity, the goal is to create a steady stream of income during retirement.

### Key Takeaways

-   Hybrid annuities allow investors to divide savings between fixed- and variable-rate products. 
-   They are meant to [[Offer|offer]] both growth and income; however, most annuities already offer those perks. 
...
As in any annuity, hybrids can begin paying out immediately or be deferred with fixed or flexible premiums. Among other positives, hybrid annuities [[Offer|offer]] the possibility of increasing the investor's income and hedging the assets against inflation. The mix of fixed and variable components lowers the [[downside risk]](https://www.investopedia.com/terms/d/downsiderisk.asp).
