...
Drugs for which NDAs are submitted [[Will|will]] have already passed through several [[clinical trials]](https://www.investopedia.com/terms/c/clinical-trials.asp). As such, drugs that reach the NDA phase typically have a high probability of securing FDA approval.
...
Yet, reaching the NDA stage is far from easy. Each NDA document must contain 15 sections containing detailed experimental evidence (including both animal and human studies). The document must extensively demonstrate the proposed drug’s pharmacology, toxicology, and dosage requirements as well as the intended process for [[Manufacturing|manufacturing]] the drug. 
...
Suppose that XYZ Pharma is an [[early-stage]](https://www.investopedia.com/terms/d/developmentstage.asp) pharmaceutical company that has recently submitted its first NDA. Prior to reaching this stage, XYZ invested several years—and tens of millions of invested capital—into a series of clinical trials on both animal and human subjects. The results of these trials are among the most critical information contained in its NDA and [[Will|will]] be central to the FDA’s decision about whether or not to approve its new product.
...
So far, XYZ has obtained favorable results from each of the first three phases. In response, XYZ’s share price has risen substantially, and the company is now ready to file its NDA. Although most investors believe that the application [[Will|will]] be approved, there is still a reasonable chance that the NDA will be rejected. If this occurs, it is likely that XYZ’s share price will rapidly decline.
