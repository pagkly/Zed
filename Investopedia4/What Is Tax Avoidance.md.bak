...
In fact, more than 90% of individuals now use the [[Standard Deduction|standard deduction]] rather than itemizing deductions.3 In part, that is because the standard deduction has increased to $12,400 for individuals and $24,800 for couples as of $10,000.4 For most Americans since 2018, that negates the usefulness even of the [[Mortgage Interest Deduction|mortgage interest deduction]]—especially now that the same tax bill that increased the standard deduction capped deductions for state and local taxes at $10,000.5
...
-   If the account is a so-called "traditional" plan, the investor gets an immediate tax break equalling the amount they contribute each year, up to a limit that is revised annually. Income taxes on the money [[Will|will]] be owed when it is withdrawn after the saver retires.6 The retiree's [[Taxable Income|taxable income]] will probably be lower then, as will the taxes owed on that income. That's tax avoidance.
-   If it is a Roth plan, the investor saves after-tax money and the tax break [[Will|will]] come after retirement, in the form of tax-free savings.6 In this case, the entire balance of the account is tax-free. Roths allow the saver to permanently avoid income taxes on the money their contributions earn over the year.

### How Congress Encourages Tax Avoidance

Tax avoidance is built into the [[Internal Revenue Code]](https://www.investopedia.com/terms/i/internal-revenue-code.asp). Lawmakers use the Tax Code to manipulate citizen behavior by [[Offering|offering]] tax credits, deductions, or exemptions. By doing so, they are indirectly subsidizing various essential services such as health insurance, retirement saving, and higher education. Or, they may use the Tax Code to advance national goals, such as greater energy efficiency.

Some of these tax policies disproportionately advantage citizens with higher incomes. Federal [[Estate|estate]] taxes have been abolished for everyone who inherits less than $11.58 million. [[Capital gains]](https://www.investopedia.com/terms/c/capitalgain.asp) are taxed at a lower rate than most [[Earned Income|earned income]]. Mortgage interest is deductible on both a first home and a second (but not a third) home.
...
[[Tax Evasion|Tax evasion]], on the other hand, is illegal. It happens when people underreport or fail to report income or revenue earned to a taxing authority. Some practice tax evasion by not paying taxes at all.  Tax evasion is serious and is punishable by jail time, a fine, or both.
