...
The contribution margin is the foundation for [[break-even analysis]](https://www.investopedia.com/terms/b/breakevenanalysis.asp) used in the overall cost and sales price planning for products. The contribution margin helps to separate out the [[Fixed Cost|fixed cost]] and profit components coming from product sales and can be used to determine the selling price range of a product, the profit levels that can be expected from the sales, and structure sales commissions paid to sales team members, distributors or [[Commission|commission]] agents.

### [[Fixed Cost]] Versus [[Variable Cost]]

One-time costs for items such as machinery are a typical example of a [[Fixed Cost|fixed cost]], that stays the same regardless of the number of [[units sold]](https://www.investopedia.com/terms/u/unitsales.asp), although it becomes a smaller percentage of each unit's cost as the number of units sold increases. Other examples include services and utilities that may come at a fixed cost and do not have an impact on the number of units produced or sold. For example, if the government offers unlimited electricity at a [[fixed monthly cost]](https://www.investopedia.com/ask/answers/032515/what-difference-between-variable-cost-and-fixed-cost-[[Economics|economics]].asp) of $100, then [[Manufacturing|manufacturing]] ten units or 10,000 units [[Will|will]] have the same fixed cost towards electricity.

Another example of [[Fixed Cost|fixed cost]] is a website hosting provider that offers unlimited hosting space to its clients at a fixed cost. Whether the client puts one or ten websites, and whether the client uses 100 MB or 2 GB of hosting space, the hosting cost remains the same. In these kinds of scenarios, electricity and web-hosting cost(s) [[Will|will]] not be considered in the contribution margin formula as it represents a fixed cost. Fixed monthly rents or salaries paid to administrative staff also fall in the fixed cost category.

However, if the same electricity cost increases in proportion to the consumption, and the [[web-host charges]](https://www.investopedia.com/articles/personal-[[Finance|finance]]/090715/8-best-cloud-storage-solutions-small-business.asp) increase on the basis of the number of sites hosted and the space consumed, then the costs [[Will|will]] be considered as variable costs. Similarly, wages paid to employees who are getting paid based on the number of units they manufacture (or any of its variations) are variable costs. Each such item will be considered for contribution margin calculations.
...
Say a machine for [[Manufacturing|manufacturing]] ink pens comes at a cost of $10,000. Manufacturing one ink pen requires $0.2 worth of raw materials like plastic, ink and nib, another $0.1 goes towards the electricity charges for running the machine to produce one ink pen, and $0.3 is the labor charge to manufacture one ink pen.

These three components constitute the [[Variable Cost|variable cost]] per unit. The total variable cost of [[Manufacturing|manufacturing]] an ink pen comes to ($0.2 + $0.1 + $0.3) = $0.6 per unit. If a total of 100 ink pens are manufactured, the total variable cost [[Will|will]] come to ($0.6 \* 100 units) = $60, while manufacturing 10,000 ink pens will lead to a total variable cost of ($0.6 \* 10,000 units) = $6,000. Such total variable cost increases in direct proportion to the number of units of the product getting manufactured.

However, the ink pen production [[Will|will]] be impossible without the [[Manufacturing|manufacturing]] machine which comes at a [[Fixed Cost|fixed cost]] of $10,000. This cost of machine represents a [[fixed cost]](https://www.investopedia.com/terms/f/fixedcost.asp) (and not a [[Variable Cost|variable cost]]) as its charges do not increase based on the units produced. Such fixed costs are not considered in the contribution margin calculations.

If a total of 10,000 ink pens are manufactured using the machine at a [[Variable Cost|variable cost]] of $6,000 and at a [[Fixed Cost|fixed cost]] of $10,000, the total [[Manufacturing|manufacturing]] cost comes to $16,000. The per-unit cost [[Will|will]] then be computed as $16,000/10,000 = $1.6 per unit. If each ink pen is sold at a price of $2 per unit, the profit per unit comes to
...
However, contribution margin does not account for [[Fixed Cost|fixed cost]] components and considers only the [[Variable Cost|variable cost]] components. The incremental profit earned for each unit sold as represented by contribution margin [[Will|will]] be:
...
In the above example, if the total number of ink pens manufactured and sold doubles to 20,000, the total cost (fixed + variable) [[Will|will]] be ($10,000/20,000 + 0.6) = $1.1 per unit. The profit per unit will come to:
...
However, the contribution margin, which gets calculated with respect to only the [[Variable Cost|variable cost]], [[Will|will]] be:
...
The contribution margin can help company management select from among several possible products that compete to use the same set of [[Manufacturing|manufacturing]] resources. Say that a company has a pen-manufacturing machine that is capable of producing both ink pens and ball-point pens, and management must make a choice to produce only one of them.

If the contribution margin for an ink pen is higher than that of a ball pen, the former [[Will|will]] be given production preference owing to its higher profitability potential. Such decision-making is common to companies that manufacture a diversified [[Portfolio|portfolio]] of products, and management must allocate available resources in the most efficient manner to products with the highest profit potential.
