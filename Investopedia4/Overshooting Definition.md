...
> ## Excerpt
> Overshooting is a model, or hypothesis in [[Economics|economics]] used to explain why exchange rates are more volatile than we would expect.
...
Thus, there [[Will|will]] be more [[Volatility|volatility]] in the exchange rate due to overshooting and subsequent [[corrections]](https://www.investopedia.com/terms/c/[[Correction|correction]].asp) that would otherwise be expected.
