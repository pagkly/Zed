...
Venture capital funds are pooled investment funds that manage the money of investors who seek private [[Equity|equity]] stakes in [[startups]](https://www.investopedia.com/terms/s/startup.asp) and small- to medium-sized enterprises with strong growth potential. These investments are generally characterized as very high-[[Risk|risk]]/high-[[Return|return]] opportunities.
...
-   Investors in a VC fund [[Will|will]] earn a [[Return|return]] when a [[Portfolio|portfolio]] company exits, either through an IPO, merger, or acquisition.

## Understanding Venture Capital Funds

Venture capital ([VC](https://www.investopedia.com/terms/v/venturecapital.asp)) is a type of [[Equity|equity]] financing that gives entrepreneurial or other small companies the ability to raise funding before they have begun operations or started earning revenues or profits. Venture capital funds are private equity [[investment vehicles]](https://www.investopedia.com/terms/i/investmentvehicle.asp) that seek to invest in firms that have high-[[Risk|risk]]/high-[[Return|return]] profiles, based on a company's size, assets, and stage of product development.

Venture capital funds differ fundamentally from mutual funds and [[Hedge|hedge]] funds in that they focus on a very [[specific type]](https://www.investopedia.com/terms/a/adventure-capitalist.asp) of early-stage investment. All firms that receive venture capital investments have high-growth potential, are risky, and have a long investment horizon. Venture capital funds take a more active role in their investments by providing guidance and often holding a board seat. VC funds therefore play an active and hands-on role in the management and operations of the companies in their [[Portfolio|portfolio]].

Venture capital funds have [[Portfolio|portfolio]] returns that tend to resemble a [[barbell]](https://www.investopedia.com/terms/b/barbell.asp) approach to investing. Many of these funds make small bets on a wide variety of young startups, believing that at least one [[Will|will]] achieve high growth and reward the fund with a comparatively large [[Payout|payout]] at the end. This allows the fund to mitigate the [[Risk|risk]] that some investments will fold.
...
From there, the venture capital fund seeks [[private equity]](https://www.investopedia.com/terms/p/privateequity.asp) investments that have the potential of generating large positive returns for its investors. This normally means the fund's manager or managers review hundreds of [[business plans]](https://www.investopedia.com/terms/b/business-plan.asp) in search of potentially high-growth companies. The fund managers make investment decisions based on the prospectus' mandates and the expectations of the fund's investors. After an investment is made, the fund charges an annual [[Management Fee|management fee]], usually around 2% of assets under management ([AUM](https://www.investopedia.com/terms/a/aum.asp)), but some funds may not charge a fee except as a percentage of returns earned. The management fees help pay for the salaries and expenses of the general partner. Sometimes, fees for large funds may only be charged on invested capital or decline after a certain number of years.

## Venture Capital Fund Returns

Investors of a venture capital fund make returns when a [[Portfolio|portfolio]] company exits, either in an IPO or a merger and acquisition. Two and twenty (or "[2 and 20](https://www.investopedia.com/terms/t/two_and_twenty.asp)") is a common fee arrangement that is standard in venture capital and private [[Equity|equity]]. The "two" means 2% of AUM, and "twenty" refers to the standard performance or [[incentive fee]](https://www.investopedia.com/terms/i/incentive-fee.asp) of 20% of profits made by the fund above a certain predefined benchmark. If a profit is made off the exit, the fund also keeps a percentage of the profits—typically around 20%—in addition to the annual [[Management Fee|management fee]]. 

Though the expected [[Return|return]] varies based on industry and [[Risk|risk]] profile, venture capital funds typically aim for a gross internal rate of return around 30%.

## Venture Capital Firms and Funds

[Venture capitalists](https://www.investopedia.com/terms/v/venturecapitalist.asp) and venture capital firms fund several different types of businesses, from dotcom companies to biotech and peer-to-peer [[Finance|finance]] companies. They generally open up a fund, take in money from high-net-worth individuals, companies seeking alternative investments exposure, and other venture funds, then invest that money into a number of smaller startups known as the VC fund's [[Portfolio|portfolio]] companies.
