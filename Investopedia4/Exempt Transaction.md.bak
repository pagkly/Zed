...
> ## Excerpt
> An [[Exempt Transaction|exempt transaction]] is a type of securities transaction where a business does not need to file registrations with any regulatory bodies.
...
An [[Exempt Transaction|exempt transaction]] is a type of securities transaction where a business does not need to file registrations with any regulatory bodies, provided the number of securities involved is relatively minor compared to the [[Scope|scope]] of the issuer's operations and that no new securities are being issued. Exempt securities are the instruments used that the government backs, which have tax-exempt status.

An [[Exempt Transaction|exempt transaction]] is a securities exchange that would otherwise have to register with the [[Securities and Exchange Commission]](https://www.investopedia.com/terms/s/sec.asp) (SEC) but does not because of the nature of the transaction in question.
...
Exempt transactions cut down the amount of paperwork needed for relatively minor transactions. For example, it would be a big hassle to perform a filing with the SEC every time a non-executive employee wanted to sell back some of the company's common [[Shares|shares]] he or she purchased as part of an employee [[Stock|stock]] purchase plan.

## Types of Exempt Transactions

A private placement or [[Reg D]](https://www.investopedia.com/terms/r/regulationd.asp) [[Offering|offering]] is a type of [[Exempt Transaction|exempt transaction]] in which the securities are not offered to the public, but are instead sold privately to an accredited investor. According to the SEC, an accredited investor can be:
...
-   Someone with at least $1 million in [[Net Worth|net worth]], excluding his or her primary residence
-   A person with more than $200,000 in income, or [[Joint|joint]] income of more than $300,000 with a spouse in both of the previous two years
...
Usually, an [[Exempt Transaction|exempt transaction]] involves a small amount of money or an accredited or sophisticated investor, or does not, for some other reason, [[Warrant|warrant]] a full registration. However, even exempt transactions are subject to some regulations, such as anti-fraud provisions. Investors and companies can still be held liable to misleading or false statements made on behalf of the company, the [[Offering|offering]], or the securities, even if the transaction is exempt.
