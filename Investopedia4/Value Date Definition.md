...
A value date is a future date that is used for determining the present value of a product or [[Security|security]] that fluctuates in price. It is the date at which funds, assets, or money's value becomes effective. Typically, value dates are used in determining the payment of financial products and accounts where there is a possibility for discrepancies due to differences in the timing of valuations. Such financial products can include [[forward currency contracts]](https://www.investopedia.com/terms/f/forward-exchange-contract.asp), option contracts, and the interest payable or receivable on personal accounts.
...
When a [[payee]](https://www.investopedia.com/terms/p/[[Payee|payee]].asp) presents a check to the bank, the bank credits the payee’s account. However, it could take days until the bank receives the funds from the payor’s bank, assuming the payor and payee have accounts with different financial institutions. If the payee has access to the funds immediately, the receiving bank runs the [[Risk|risk]] of recording a negative [[Cash Flow|cash flow]]. To avoid this risk, the bank [[Will|will]] estimate the day it will receive the money from the paying institution, and [[Hold|hold]] the funds in the payee’s account until the expected day of receipt. In effect, the bank will post the amount of the deposit for a couple of days, after which the payee can use the funds. The date the funds are released is referred to as the value date.
