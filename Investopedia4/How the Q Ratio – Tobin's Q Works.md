...
-   The simplified Q ratio is the [[Equity Market|equity market]] value divided by [[Equity|equity]] book value.
...
The Tobin's Q ratio is a quotient popularized by [[James Tobin]](https://www.investopedia.com/terms/j/james-tobin.asp) of Yale University, Nobel laureate in [[Economics|economics]], who hypothesized that the combined [[market value]](https://www.investopedia.com/terms/m/marketvalue.asp) of all the companies on the [[Stock|stock]] market should be about equal to their replacement costs.
...
A low Q ratio—between 0 and 1—means that the cost to replace a firm's assets is greater than the value of its [[Stock|stock]]. This implies that the stock is undervalued. Conversely, a high Q (greater than 1) implies that a firm's stock is more expensive than the [[replacement cost]](https://www.investopedia.com/terms/r/replacementcost.asp) of its assets, which implies that the stock is [[overvalued]](https://www.investopedia.com/terms/o/overvalued.asp).

This measure of [[Stock|stock]] valuation is the driving factor behind investment decisions in Tobin's Q ratio. When applied to the market as a whole, we can gauge whether an entire market is relatively [[Overbought|overbought]] or undervalued; we can represent this relationship as follows:
...
In this scenario, ascertaining the replacement value would be easy because there is a [[Robust|robust]] market for hard drives from which to examine prices. To determine what a one-terabyte hard drive is worth, we would simply need to determine what it would cost to buy a one-terabyte hard drive (of comparable quality and specifications) from one of the many different suppliers on the market. In many cases, however, the replacement value of assets can prove much more elusive than this.
...
The formula for Tobin's Q ratio takes the total market value of the firm and divides it by the total asset value of the firm. For example, assume that a company has $35 million in assets. It also has 10 million [[Shares|shares]] outstanding that are trading for $4 a share. In this example, the Tobin's Q ratio would be:
