...
> ## Excerpt
> The goodness of fit test is a statistical hypothesis test to see how well sample data fit a distribution from a population with a [[Normal Distribution|normal distribution]].
...
-   These tests can show you whether your sample data fit an expected set of data from a population with [[Normal Distribution|normal distribution]].
