...
Generally, a company that has been trading at low [[multiples]](https://www.investopedia.com/terms/m/multiplesapproach.asp) of earnings, [[Cash Flow|cash flow]], or book value for an extended period of time has little promise, and possibly no future—even if the price of their [[Stock|stock]] appears attractive. A stock becomes a value trap to an investor if no material improvements are made in the company's competitive stance, in its ability to innovate, in its ability to contain costs, and/or in its executive management.
...
For an investor who is used to seeing a certain valuation of this company's [[Stock|stock]], a price that appears cheap can be appealing. [[Value investors]](https://www.investopedia.com/terms/v/valueinvesting.asp) are particularly susceptible to value traps. As with any investment decision, thorough research and evaluation is recommended before investing in any company that appears cheap on the basis of conventional valuation metrics.

## Identifying Value Traps

Identifying value traps can be tricky, but a careful [[Fundamental Analysis|fundamental analysis]] of the [[Stock|stock]] can reveal what is a trap and what is a good investment opportunity. Here are some examples of possible value traps:

-   An industrial company whose [[Stock|stock]] has been trading at 10x earnings for the past six months, compared to its trailing 5-year average of 15x.
