...
> ## Excerpt
> The EV/2P ratio is a ratio used to value oil and gas companies. It consists of the enterprise value (EV) divided by the proven and probable (2P) reserves. EV compared to proven and probable reserves is a metric that helps analysts understand how well a company's resources [[Will|will]] support its growth.
...
1.  Obtain or calculate the enterprise value of the company. The EV is often calculated for [[investors]](https://www.investopedia.com/terms/l/letterofcredit.asp) but if not, add the [[Market Capitalization|market capitalization]] and total [[Debt|debt]] together and subtract out cash.
...
When the EV/2P multiple is high, it means the company is trading at a [[Premium|premium]] for a given amount of oil in the ground. Conversely, a low value would suggest a potentially undervalued company.
...
-   Enterprise value compared to proven and probable reserves is a metric that helps analysts understand how well a company's resources [[Will|will]] support its operations and growth.
...
As mentioned earlier, the EV/2P ratio includes total [[Debt|debt]] in its calculation because enterprise value also includes total debt. Oil companies typically carry significant amounts of debt on their balance sheets, which is normal for the industry. Debt is used to top [[Finance|finance]] oil rigs, equipment, and the cost of exploration.

As a result, the extra [[Debt|debt]] would put the EV of oil companies at a much higher valuation than most other industries that carry less debt. Investors should be aware of the unique capital structures of oil and gas companies when using any valuation metric including the EV/2P ratio.
