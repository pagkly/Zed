...
The primary benefit of [[Stock|stock]] appreciation rights is that employees can receive proceeds from stock price increases without having to buy stock.
...
SARs are taxed the same way as non-qualified [[Stock|stock]] options ([NSOs](https://www.investopedia.com/terms/n/nso.asp)). There are no tax consequences of any kind on either the [[Grant|grant]] date or when they are vested. However, participants must recognize [[Ordinary Income|ordinary income]] on the spread at the time of exercise.1 Most employers [[Will|will]] also withhold supplemental [[federal income tax]](https://www.investopedia.com/terms/f/federal_income_tax.asp).2 Furthermore, they will [[Hold|hold]] back funds to pay state and local taxes where applicable.

Many employers [[Will|will]] also withhold taxes on SARs in the form of [[Shares|shares]]. For example, an employer may only give a certain number of shares and withhold the remainder to cover the tax. As with NSOs, the amount of income recognized upon exercise becomes the [[cost basis]](https://www.investopedia.com/terms/c/costbasis.asp) for taxes when holders sell the shares.1

## Special Considerations

SARs are similar in some ways to [[phantom stock]](https://www.investopedia.com/terms/p/phantomstock.asp). The major difference is that phantom [[Stocks|stocks]] are typically reflective of [[Stock|stock]] splits and dividends. Phantom stock is a promise that an employee [[Will|will]] receive either the value of the company's [[Shares|shares]] or the amount that the stock price increases during a specified period. The phantom stock bonus an employee receives is taxed as [[Ordinary Income|ordinary income]] at the time it is received. Phantom stock is not tax-qualified, so it does not have to follow the rules that employee stock ownership plans ([ESOPs](https://www.investopedia.com/terms/e/esop.asp)) and [401(k)s](https://www.investopedia.com/terms/1/401kplan.asp) must follow.3

## Advantages and Disadvantages of SARs

The greatest advantage of SARs is flexibility. Companies can structure SARs in a variety of ways that work best for different individuals. However, this flexibility requires making numerous choices. Companies [[Offering|offering]] SARs must decide which employees receive them, the value of these bonuses, the [[Liquidity|liquidity]] of the SARs, and which vesting rules to adopt.

Employers like SARs because the accounting rules for them are more favorable than in the past. They receive fixed instead of variable accounting treatment, much like conventional [[Stock Option|stock option]] plans. However, SARs require the issuance of fewer [[Shares|shares]] and dilute the share price less than traditional [[Stock|stock]] plans. Like all other forms of [[equity compensation]](https://www.investopedia.com/terms/e/[[Equity|equity]]-compensation.asp), SARs can also serve to motivate and retain employees.

Despite their many benefits, SARs are a high-[[Risk|risk]] form of employee compensation. If the company's [[Stock|stock]] does not appreciate, SARs often expire worthless.

## Example of [[Stock]] Appreciation Rights

Consider an employee who earns 200 SARs as a performance bonus. Furthermore, suppose that the SARs mature after a period of two years. The [[Stock|stock]] of the company then proceeds to increase by $35 a share over those two years. The result is that the employee receives $7,000 (200 SARs x $35 = $7,000) in additional compensation. These SARs could also have a clawback provision where employees lose them if they leave the company before the two-year period ends.
