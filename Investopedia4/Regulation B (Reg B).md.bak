...
All lenders are required to comply with Regulation B when extending credit to borrowers. Reg B implements the Equal Credit Opportunity Act ([ECOA](https://www.investopedia.com/terms/e/ecoa.asp)), which is regulated and enforced by the Consumer Financial Protection Bureau ([CFPB](https://www.investopedia.com/terms/c/consumer-financial-protection-bureau-cfpb.asp)). Congress enacted the ECOA to ensure that financial institutions and firms dealing with credit make it equally available to all [[creditworthy]](https://www.investopedia.com/terms/c/credit-worthiness.asp) customers. That means any feature that is not related to consumer credit cannot be used when making [[Loan|loan]] approval decisions.3

Creditors that fail to comply with Reg B [[Will|will]] be held liable for punitive damages up to $10,000 in individual actions. For [[class actions]](https://www.investopedia.com/terms/c/classaction.asp), the [[Creditor|creditor]] could face a penalty of $500,000 or 1% of the creditor’s [[Net Worth|net worth]], whichever is lower.

Regulation B covers the actions of a [[Creditor|creditor]] before, during, and after a credit transaction. The CFPB lists credit transactions and aspects of credit transactions to include [[consumer credit]](https://www.investopedia.com/terms/c/consumercredit.asp), business credit, mortgage, and [[open-end credit]](https://www.investopedia.com/terms/o/openendcredit.asp). This list also includes [[refinancing]](https://www.investopedia.com/terms/r/refinance.asp), credit applications, information requirements, standards of [[Creditworthiness|creditworthiness]], investigation procedures, and revocation or termination of credit.

When it comes to credit transactions, a [[Creditor|creditor]] cannot discriminate:3
...
Regulation B also mandates that lenders provide oral or written notice of rejection to failed applicants within 30 days of receiving their completed applications. The notice must explain why the applicant was rejected or give instructions for how the applicant can request this information. The spouses of rejected married applicants also have the right to this information. The information provided to applicants about the rejection helps them take constructive steps to build their credit. More importantly, it gives applicants the chance to correct the [[Creditor|creditor]]'s mistakes in evaluating the applicant's [[Creditworthiness|creditworthiness]].2

## Special Considerations

Under Regulation B, a [[Lender|lender]] may not request information about an applicant’s sex, national origin, color, or other information not related to [[Creditworthiness|creditworthiness]].3 However, there are certain times when such information can be collected from the applicant. For example, an applicant who puts down his home as [[collateral]](https://www.investopedia.com/terms/c/[[Collateral|collateral]].asp) [[Will|will]] have additional information collected for monitoring compliance.
...
A [[Creditor|creditor]] may only request information from a [[Loan|loan]] applicant’s spouse if:4

-   The spouse [[Will|will]] be permitted to use the account
-   The spouse [[Will|will]] be contractually liable on the account
