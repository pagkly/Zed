...
> ## Excerpt
> Any charge card that is widely accepted at a variety of merchants and locations is considered an [[Open Loop Card|open loop card]].
...
The opposite of an [[Open Loop Card|open loop card]] is a [[closed loop card]](https://www.investopedia.com/closed-loop-card-definition-4683996), which can only be used to make purchases from a single company or retailer, like a department store.

## The Basics of an [[Open Loop Card]]

Any charge card that is widely accepted at a variety of merchants and locations is considered an [[Open Loop Card|open loop card]]. Open loop cards can take a variety of forms.

### key takeaways

-   An [[Open Loop Card|open loop card]] is a general-purpose charge card that can be used anywhere that brand of card is accepted.
-   The opposite of an [[Open Loop Card|open loop card]] is a card that can only be used at a specific retailer, known as a closed loop card.
