...
-   Avoidance is the best method of loss control. For example, after discovering that a chemical used in [[Manufacturing|manufacturing]] a company’s goods is dangerous for the workers, a factory owner finds a safe substitute chemical to protect the workers’ health.
-   Loss prevention [[accepts a risk]](https://www.investopedia.com/terms/a/accepting-[[Risk|risk]].asp) but attempts to minimize the loss rather than eliminate it. For example, inventory stored in a warehouse is susceptible to theft. Since there is no way to avoid it, a loss prevention program is put in place. The program includes patrolling [[Security|security]] guards, video cameras and secured storage facilities. [[Insurance]](https://www.investopedia.com/terms/i/insurance-coverage.asp) is another example of risk prevention that is outsourced to a [[Third Party|third party]] by contract.
-   Loss reduction accepts the [[Risk|risk]] and seeks to limit losses when a threat occurs. For example, a company storing flammable material in a warehouse installs state-of-the-art water sprinklers for minimizing damage in case of fire.
...
-   [[Diversification]](https://www.investopedia.com/terms/d/[[Diversification|diversification]].asp) allocates business resources for creating multiple lines of business [[Offering|offering]] a variety of products or services in different industries. A significant revenue loss from one line [[Will|will]] not result in irreparable harm to the company’s bottom line. For example, in addition to serving food, a restaurant has grocery stores carry its line of salad dressings, marinades, and sauces.

No one [[Risk|risk]] control technique [[Will|will]] be a golden bullet to keep a company free from potential harm. In practice, these techniques are used in tandem with one another to varying degree and change as the corporation grows, as the economy changes, and as the competitive landscape shifts.
