...
D. That have yielded, or may be likely to [[Yield|yield]], information important in prehistory or history.”

A structure only has to fit one of these criteria to be designated as a [[Historic Structure|historic structure]] by the National Register. The intent of these criteria is to ensure that structures that have some kind of cultural and historical relevance are preserved, but the designation is not to be overused for a building that is simply a certain age but is not otherwise significant.7
