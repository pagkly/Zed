...
> ## Excerpt
> A [[Non-Operating Expense|non-operating expense]] is an expense incurred by a business that is unrelated to its core operations.
...
A [[Non-Operating Expense|non-operating expense]] is a business expense unrelated to the core operations. The most common types of non-operating expenses are interest charges and losses on the [[Disposition|disposition]] of assets. Accountants sometimes remove non-operating expenses and non-operating revenues to examine the performance of the business, ignoring effects of financing and other irrelevant issues.

### Key Takeaways

-   A [[Non-Operating Expense|non-operating expense]] is an expense incurred from activities unrelated to core operations.
...
Most public companies [[Finance|finance]] their growth with a combination of [[Debt|debt]] and [[Equity|equity]]. Regardless of the allocation, any business that has corporate debt also has monthly interest payments on the amount borrowed. This monthly interest payment is considered a [[Non-Operating Expense|non-operating expense]] because it does not arise due to a company's core operations.

If a company sells a building, and it is not in the business of buying and selling real [[Estate|estate]], the sale of the building is a non-operating activity. If the building sold at a loss, the loss is considered a [[Non-Operating Expense|non-operating expense]].

## Recording [[Non-Operating Expense]]

When looking at a company's income statement from top to bottom, [[operating expenses]](https://www.investopedia.com/terms/o/operating_expense.asp) are the first costs displayed just below [[revenue]](https://www.investopedia.com/terms/r/revenue.asp). The company starts the preparation of its income statement with [[top-line]](https://www.investopedia.com/terms/t/topline.asp) revenue. The firm's [[cost of goods sold]](https://www.investopedia.com/terms/c/cogs.asp) (COGS) is then subtracted from its revenue to arrive at its [[gross income]](https://www.investopedia.com/terms/g/grossincome.asp). After [[Gross Income|gross income]] is calculated, all operating costs are then subtracted to get the company's [[operating profit]](https://www.investopedia.com/terms/o/operating_profit.asp), or earnings before interest, tax, depreciation, and amortization (EBITDA). Then, after [[Operating Profit|operating profit]] has been derived, all non-operating expenses are recorded on the financial statement. Non-operating expenses are subtracted from the company's operating profit to arrive at its [[earnings before taxes]](https://www.investopedia.com/terms/e/ebt.asp) (EBT). Taxes are then assessed to derive the company's [[net income]](https://www.investopedia.com/terms/n/netincome.asp).
