...
Form 1120-S: U.S. Income [[Tax Return]] for an S Corporation is a tax document that is used to report the income, losses, and dividends of S corporation shareholders. Essentially, Form 1120-S is an [[S corporation's]](https://www.investopedia.com/articles/investing/091614/understanding-s-corporations.asp) tax [[Return|return]].

The [[Schedule K-1]](https://www.investopedia.com/terms/s/schedule-k-1.asp) is a form that can be attached to Form 1120-S or Form 1065. The [[Schedule K-1]] form identifies the percentage of company [[Shares|shares]] owned by each individual shareholder for the tax year and must be prepared for every shareholder.
...
-   The form serves as the corporation's annual income [[Tax Return|tax return]] as long as the S corporation remains in effect.
-   Corporations with few shareholders use the S corporation status to avoid [[Double Taxation|double taxation]] on a corporation and its shareholders.
...
If the shareholder does not see a change in this percentage during the year, profit and loss are relatively easy to calculate. However, if the individual purchases additional [[Shares|shares]], or sells or transfers any [[Holdings|holdings]] during the course of the year, then profit and loss must be pro-rated on a per-share basis.
...
Corporations with fewer than 100 shareholders may choose to form an S corporation for the purposes of avoiding double federal [[Taxation|taxation]]. That is, the corporation passes its income along to the shareholders for the purposes of taxation. The shareholders are taxed but not the corporation.
...
Both S corporations and C corporations must also file articles of incorporation and [[Hold|hold]] regular meetings for directors and shareholders with detailed minutes. These meetings must be forums that allow shareholders to vote on major corporate decisions such as management restructuring, mergers and acquisitions, and new investments.

Finally, S corporations and C corporations have similar legal and accounting costs of set-up.

While C corporations may issue several classes of [[Stock|stock]], S corporations can only issue one class. It can be argued that this hampers a company's ability to raise capital.2
