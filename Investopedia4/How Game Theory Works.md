...
It is assumed players within the game are rational and [[Will|will]] strive to maximize their payoffs in the game.
...
Game theory has a wide range of applications, including psychology, evolutionary biology, war, politics, [[Economics|economics]], and business. Despite its many advances, game theory is still a young and developing science.
...
-   **Strategy**: A complete plan of action a player [[Will|will]] take given the set of circumstances that might arise within the game
-   **Payoff**: _T_he [[Payout|payout]] a player receives from arriving at a particular outcome (The payout can be in any quantifiable form, from dollars to [utility](https://www.investopedia.com/terms/u/utility.asp).)
...
Non-cooperative game theory deals with how rational economic agents deal with each other to achieve their own goals. The most common non-cooperative game is the strategic game, in which only the available strategies and the outcomes that result from a combination of choices are [[Listed|listed]]. A simplistic example of a real-world non-cooperative game is Rock-Paper-Scissors. 

## Examples of Game Theory

There are several "games" that game theory analyzes. Below, we [[Will|will]] just briefly describe a few of these.

### The Prisoner's Dilemma

The [[Prisoner's Dilemma]](https://www.investopedia.com/terms/p/prisoners-dilemma.asp) is the most well-known example of game theory. Consider the example of two criminals arrested for a crime. Prosecutors have no hard evidence to convict them. However, to [[Gain|gain]] a confession, officials remove the prisoners from their solitary cells and question each one in separate chambers. Neither prisoner has the means to communicate with each other. Officials present four deals, often displayed as a 2 x 2 box.

1.  If both confess, they [[Will|will]] each receive a five-year prison sentence. 
2.  If Prisoner 1 confesses, but Prisoner 2 does not, Prisoner 1 [[Will|will]] get three years and Prisoner 2 will get nine years. 
3.  If Prisoner 2 confesses, but Prisoner 1 does not, Prisoner 1 [[Will|will]] get 10 years, and Prisoner 2 will get two years. 
4.  If neither confesses, each [[Will|will]] serve two years in prison. 

The most favorable strategy is to not confess. However, neither is aware of the other's strategy and without certainty that one [[Will|will]] not confess, both will likely confess and receive a five-year prison sentence. The [[Nash Equilibrium|Nash equilibrium]] suggests that in a prisoner's dilemma, both players will make the move that is best for them individually but worse for them collectively.

The expression "[tit for tat](https://www.investopedia.com/terms/t/tit-for-tat.asp)" has been determined to be the optimal strategy for optimizing a prisoner's dilemma. [[Tit for Tat|Tit for tat]] was introduced by Anatol Rapoport, who developed a strategy in which each participant in an iterated prisoner's dilemma follows a course of action consistent with his opponent's previous turn. For example, if provoked, a player subsequently responds with retaliation; if unprovoked, the player cooperates.
...
Being labeled as a [[Whistleblower|whistleblower]] may also have some repercussions down the line. But if nobody volunteers, the large-scale fraud may result in the company’s eventual bankruptcy and the loss of everyone’s jobs.
