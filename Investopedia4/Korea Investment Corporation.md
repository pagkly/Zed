...
The fund invests in equities, fixed income, [[Hedge|hedge]] funds, private [[Equity|equity]], and real [[Estate|estate]] and infrastructure. KIC’s [[Return|return]] on total assets in 2016 stood at 4.35%, with a five-year annualized return of 5.11% and annualized returns since inception of 3.34%, [the fund reported](http://www.kic.kr/en/02/03/01.jsp). Regarding its investment philosophy, KIC said this: "KIC strives to increase returns while (1) minimizing the risks from individual markets and assets through [[Portfolio|portfolio]] [[Diversification|diversification]]; and (2) exercising flexibility to seize investment opportunities.

Our investments started with traditional asset classes, including [[Stocks|stocks]] and bonds. We broadened our investment [[Scope|scope]] to include inflation-linked bonds and commodities as well as private [[Equity|equity]], real [[Estate|estate]], [[Hedge|hedge]] funds and individual investments. As part of our [[Portfolio|portfolio]] [[Diversification|diversification]], we have also increased our exposure to emerging markets since 2010.

Decisions related to strategic asset allocation are subject to deliberation by the Steering Committee. The investment management agreements signed between KIC and sponsors specify available asset classes and benchmark targets, and they serve as the basis for [[Risk|risk]] management and performance evaluation. KIC pursues benchmark returns (beta) by diversifying investments in the range of currencies and countries, as outlined in its investment management guidelines. We also strive to generate excess [[Return|return]] over the benchmarks (alpha) through active management within an appropriate level of risk.

Regarding traditional assets, we manage [[Risk|risk]] using the ex-ante tracking error from active investing relative to the benchmark. If the weighting of an asset class deviates from a set range relative to the benchmark, adjustments are made so that exposure falls within the set range. The [[Portfolio|portfolio]] is rebalanced at pre-determined times to maintain policy weightings for each asset class."
