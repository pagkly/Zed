...
> ## Excerpt
> West Texas Intermediate is the [[Underlying|underlying]] commodity of the New York Mercantile Exchange's oil [[Futures|futures]] contract and one of the main global oil benchmarks.
...
[[West Texas Intermediate (WTI)]] [[crude oil]](https://www.investopedia.com/terms/c/crude-oil.asp) is a specific grade of [[Crude Oil|crude oil]] and one of the main three benchmarks in oil pricing, along with Brent and Dubai Crude. WTI is known as a light sweet oil because it contains around 0.34% sulfur,1 making it "[sweet](https://www.investopedia.com/terms/s/sweetcrude.asp)," and has a low density (specific gravity), making it "light."

WTI is the [[Underlying|underlying]] commodity of the [[New York Mercantile Exchange]](https://www.investopedia.com/terms/n/nymex.asp)'s (NYMEX) oil [[Futures|futures]] contract and is considered a high-quality oil that is easily refined.

### Key Takeaways

-   [[West Texas Intermediate (WTI)]] is a light, sweet [[Crude Oil|crude oil]] that serves as one of the main global oil benchmarks.
-   It is sourced primarily from inland Texas and is one of the highest quality oils in the world, which is easy to refine.
-   WTI is the [[Underlying|underlying]] commodity for the NYMEX's oil [[Futures|futures]] contract.
...
Theoretically, WTI crude should trade [[at a premium]](https://www.investopedia.com/terms/a/at-a-[[Premium|premium]].asp) to Brent crude, given the quality, but this is not always the case. While the two [[Crude Oil|crude oil]] varieties can trade at similar price points, each one has its own unique [[Supply|supply]] and demand market, and therefore its price reflects its individual market [[Fundamentals|fundamentals]].
...
2020 saw the collapse of [[Crude Oil|crude oil]] prices as demand disappeared due to the global economic shutdown that paralyzed the world's economies. Oil prices fell more than 90% as the industry was plagued with overproduction and disappearing demand. On April 20, the May contract for WTI [[Futures|futures]] fell below zero for the first time, the day before the contract expired.
