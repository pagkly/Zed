...
> ## Excerpt
> A tax [[Loss Carryforward|loss carryforward]] is an opportunity for a [[Taxpayer|taxpayer]] to move a tax loss to a future time to offset a profit.
...
The [[Coronavirus Aid, Relief, and Economic Security (CARES)]](https://www.investopedia.com/coronavirus-aid-relief-and-economic-[[Security|security]]-cares-act-4800707) Act in 2020 further modified the rules surrounding NOL carryforwards, temporarily. According to the IRS, "the CARES Act effectively delays the application of the TCJA amendments until Jan. 1, 2021. Additionally, the CARES Act permits a five-year carryback for NOLs, including farming losses and NOLs of non-life insurance companies, for taxable years beginning after Dec. 2017 and before Jan. 1, 2021."3
...
Assume, for example, that a [[Taxpayer|taxpayer]] sold 1,000 [[Shares|shares]] of XYZ [[Stock|stock]] for a capital loss totaling $10,000, and the taxpayer had owned the stock for three years. Capital gains and losses are reported on Schedule D of the IRS Form 1040 [[Tax Return|tax return]]. If a stock is held for more than a year, the holding period is typically [[Long Term|long term]] (with certain exceptions in 2018 and later for "applicable partnership interests which are considered long-term after three years"). The taxpayer offsets long-term gains with long-term losses.11

Assume that the [[Taxpayer|taxpayer]] also has $3,000 in long-term gains, which reduces the net long-term capital loss to $7,000. The taxpayer can take $3,000 of that loss as a [[deduction to reduce other income]](https://www.investopedia.com/articles/personal-[[Finance|finance]]/100515/heres-how-deduct-your-[[Stock|stock]]-losses-your-tax-bill.asp), called [[ordinary income]](https://www.investopedia.com/terms/o/ordinaryincome.asp), on the current year [[Tax Return|tax return]]. The remaining long-term capital loss is $4,000, which can be carried forward to the next tax year to offset capital gains and [[Ordinary Income|ordinary income]] up to the $3,000 limit. This tax policy allows investors who realize large losses during market downturns to reduce gains recognized over many future years.89
