...
> ## Excerpt
> A death cross pattern is defined as that which occurs when a [[Security|security]]'s short-term moving average drops below its long-term moving average.
...
The death cross is a technical chart pattern indicating the potential for a major [[sell-off]](https://www.investopedia.com/terms/s/sell-off.asp). The death cross appears on a chart when a [[Stock|stock]]’s short-term moving average crosses below its long-term [[moving average]](https://www.investopedia.com/terms/m/movingaverage.asp). Typically, the most common moving averages used in this pattern are the 50-day and 200-day moving averages.
...
-   The death cross appears on a chart when a [[Stock|stock]]’s short-term moving average, usually the 50-day, crosses below its long-term moving average, usually the 200-day.
-   The death cross can be contrasted with a [[Golden Cross|golden cross]] indicating a bull price movement.

The death cross indicator has proven to be a reliable predictor of some of the most severe [[bear markets]](https://www.investopedia.com/terms/b/bearmarket.asp) of the past century: in 1929, 1938, 1974, and 2008. Investors who got out of the [[Stock|stock]] market at the start of these bear markets avoided large losses that were as high as 90% in the 1930s. Because a death cross is a long-term indicator, as opposed to many short-term chart patterns such as the [[doji]](https://www.investopedia.com/terms/d/[[Doji|doji]].asp), it carries more weight for investors concerned about locking in gains before a new bear market gets underway. An increase in [[volume]](https://www.investopedia.com/terms/v/volume.asp) typically accompanies the appearance of the death cross.
...
The following is a historical example of two death crosses that occurred for Facebook Inc. ([FB](https://www.investopedia.com/markets/[[Quote|quote]]?tvwidgetsymbol=fb)) [[Stock|stock]] in 2018. After the first one in April 2018, the stock turned around and began an extended [[Rally|rally]]. The second one in September 2018, however, signaled a prolonged bear market for the stock.

TradingView

Looking back over the most punishing bear markets of the past century, it seems the death cross holds up best once the market has already lost 20% of its value. In those instances, investors who fled [[Stocks|stocks]] minimized their losses. But for smaller corrections of less than 20%, the temporary appearance of the death cross may be reflecting losses already booked, and thus indicates a buying opportunity.

## Death Cross vs. [[Golden Cross]]

The opposite of the death cross occurs with the appearance of the [[golden cross]](https://www.investopedia.com/terms/g/goldencross.asp), when the short-term moving average of a [[Stock|stock]] or index moves above the long-term moving average. Many investors view this pattern as a bullish indicator. The [[Golden Cross|golden cross]] pattern typically shows up after a prolonged downtrend has run out of [[Momentum|momentum]]. As is true with the death cross, investors should confirm the trend [[Reversal|reversal]] after several days or weeks of price movement in the new direction. Much of the process of investing by following patterns is self-fulfilling behavior, as trading volumes increase with the attention of more investors who are driven in part by an increase in financial news stories about a particular stock or the movement of an index.
