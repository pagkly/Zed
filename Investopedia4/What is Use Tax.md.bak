...
> ## Excerpt
> Use tax is applied to purchases made outside one’s state of residence on taxable items that [[Will|will]] be used, stored or consumed in one’s state of residence and on which no tax was collected in the state of purchase.

---

[[What is Use Tax]]?
## [[What is Use Tax|What Is Use Tax]]?

Use tax is a sales tax on purchases made outside one's state of residence for taxable items that [[Will|will]] be used, stored or consumed in one's state of residence and on which no tax was collected in the state of purchase. If the purchase would have been taxed if it was made in the purchaser’s state of residence, then use tax is due.1

## Breaking Down Use Tax

The use tax rate is the same as the resident's local [[sales tax]](https://www.investopedia.com/terms/s/salestax.asp) rate, which includes both state and local sales taxes. A resident who does not pay use tax may be subject to interest and penalties. For example, California residents are required to pay sales tax on purchases of merchandise such as furniture, gifts, toys, clothing, vehicles, mobile homes, and aircraft. If a Californian purchases clothing from a California retailer, the retailer [[Will|will]] collect sales tax from the buyer at the [[point of sale]](https://www.investopedia.com/terms/p/point-of-sale.asp) and remit it to the tax authorities. No additional tax will be due. 2
