...
The U.S. [[Securities and Exchange Commission (SEC)]] is an independent federal government regulatory agency responsible for protecting investors, maintaining fair and orderly functioning of [[the securities markets]](https://www.investopedia.com/ask/answers/08/[[Security|security]]-market-usa.asp), and facilitating capital formation. It was created by Congress in 1934 as the first federal regulator of the securities markets. The SEC promotes full public disclosure, protects [[investors]](https://www.investopedia.com/terms/i/investor.asp) against fraudulent and manipulative practices in the market, and monitors corporate takeover actions in the United States. It also approves registration statements for [[bookrunners]](https://www.investopedia.com/terms/b/bookrunner.asp) among underwriting firms.1

Generally, [[issues]](https://www.investopedia.com/terms/i/issue.asp) of securities offered in interstate [[Commerce|commerce]], through the mail or on the Internet, must be registered with the SEC before they can be sold to investors. Financial services firms—such as broker-dealers, [[advisory firms]](https://www.investopedia.com/articles/financial-advisors/031716/top-ria-firms-2016.asp) and asset managers, as well as their professional representatives—must also register with the SEC to conduct business. In example: they would be responsible for approving any formal [[bitcoin exchange]](https://www.investopedia.com/investing/bitcoin-etfs-explained/).

### Key Takeaways

-   The [[Securities and Exchange Commission (SEC)]] is a U.S. government oversight agency responsible for regulating the securities markets and protecting investors.
-   The SEC was established by the passage of the U.S. [[Securities Act of 1933]] and the Securities and Exchange Act of 1934, largely in response to the [[Stock|stock]] market crash of 1929 that led to the Great Depression.
...
The [[Securities and Exchange Commission (SEC)|Securities And Exchange Commission (SEC)]] was created in 1934 to help restore investor confidence in the wake of the 1929 [[Stock|stock]] market crash.
...
-   **Division of Corporate [[Finance]]:** Ensures investors are provided with material information (that is, information relevant to a company's financial prospects or [[Stock|stock]] price) in order to make informed investment decisions.
...
-   **Division of Economic and [[Risk]] Analysis:** Integrates [[Economics|economics]] and data analytics into the core mission of the SEC.
