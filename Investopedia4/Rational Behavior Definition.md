...
For example, an individual may choose to invest in the [[Stock|stock]] of an organic produce operation, rather than a conventional produce operation, if they have strong beliefs in the value of organic produce. They may choose to do this regardless of the [[present value]](https://www.investopedia.com/terms/p/presentvalue.asp) of the organic operation compared with that of the conventional operation, and despite the fact that the conventional operation would earn a higher [[Return|return]].
