...
## [[What is the Gemini Exchange|What Is the Gemini Exchange]]?
...
Founded in 2014, Gemini is the brainchild of Cameron and Tyler Winklevoss, the famous investors and Harvard classmates of Mark Zuckerberg. Gemini has worked to be at the forefront of the [[cryptocurrency]](https://www.investopedia.com/terms/c/[[Cryptocurrency|cryptocurrency]].asp) exchange world, working alongside [[Nasdaq]](https://www.investopedia.com/terms/n/[[Nasdaq|nasdaq]].asp) to revolutionize the way that transactions are monitored and recorded.

### Key Takeaways

-   Gemini Exchange is a [[Cryptocurrency|cryptocurrency]] trading service that combines an exchange, a [[Fiduciary|fiduciary]] custodial service for digital assets and an advanced trading platform for professionals.
...
As of April 2020, Gemini is in operation in 49 U.S. states, Washington D.C., Puerto Rico, Australia, Canada, Hong Kong, Singapore, South Korea, and the United Kingdom. Like other [[Digital Currency|digital currency]] exchanges, Gemini allows users to buy and sell a variety of digital currencies, either with digital currency (for example, using bitcoin to buy litecoin) or using fiat currency like U.S. dollars to buy digital currencies.

### Gemini Products

Gemini boasts a diverse range of products for small investors who want to stay long on [[Cryptocurrency|cryptocurrency]] to advanced traders who want advanced features like charting and instant trades.

Gemini Exchange is Gemini's platform for buying and selling [[Cryptocurrency|cryptocurrency]]. It is available both through your web browser and as an app on both the iTunes store and Google Play app store. The mobile app also includes the Gemini Wallet, which allows users to pay for goods using their crypto [[Holdings|holdings]].

For advanced traders, Gemini offers its Active Trader Platform. According to its [[website]](https://gemini.com/activetrader), the platform features "advanced charting, multiple order types, auctions, and block trading." They also claim to be able to execute orders in "microseconds," but that may depend on how you define "execute" and what kind of [[Cryptocurrency|cryptocurrency]] you're trading.

The [[Gemini Custody]](https://gemini.com/custody) product is both a cold storage system for assets held by Gemini and a "crypto-native [[Finance|finance]] platform." The Custody product is unique in that it provides insurance coverage of $200 million for crypto [[Holdings|holdings]] and is a [[Fiduciary|fiduciary]] and custodian licensed under New York Banking law, making Gemini arguably the most secure crypto exchange that has ever existed. Gemini also is a clearinghouse for off-exchange trades.1
