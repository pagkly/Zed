...
UTMA accounts can [[Hold|hold]] virtually any kind of asset, including real [[Estate|estate]], intellectual property, and works of art. UGMA accounts are limited to financial assets of cash, securities—[[Stocks|stocks]], bonds, or mutual funds—annuities, and insurance policies. All U.S. states allow UGMA accounts. However, South Carolina does not allow UTMA accounts.
...
As noted above, custodial accounts can invest in a variety of assets. However, the financial institution probably won't allow the manager to use the account to trade on margin or buy [[Futures|futures]], derivatives, or other highly speculative investments.

Once the minor reaches the legal age of adulthood in their state, control of the account officially transfers from the custodian to the [[Named Beneficiary|named beneficiary]], at which point they claim full control and use of the funds. Should the minor die before reaching majority, the account [[Will|will]] become part of the child's [[Estate|estate]].
...
-   The account's [[Holdings|holdings]] irrevocably pass into the minor's control when they come of age depending on their state of residence.
...
While not tax-deferred, as are IRAs, custodial accounts do have some tax advantages. The IRS considers the minor child the owner of the account, so the earnings in it are taxed at the child's tax rate. Every child under 19 years old—24 for full-time students—who files as part of their parents’ [[Tax Return|tax return]] is allowed a certain amount of “[[Unearned Income|unearned income]]” at a reduced tax rate.

As of 2019, the first $1,050 of [[Unearned Income|unearned income]] is tax-free, and the next $1,050 is taxed at the child’s bracket of 10%. Unearned income of more than $2,100 [[Will|will]] be taxed at the parent's rate. However, once the minor reaches the age of majority in their state of residence, they can file a [[Tax Return|tax return]] of their own. At this age, all of the account earnings will be subject to the beneficiary's tax bracket at the age of filing.

Also, an individual can contribute up to $15,000—$30,000 for a married couple filing jointly—to an account in 2019 without incurring the federal [[Gift Tax|gift tax]].
...
A minor's ownership of the custodial account can be a double-edged sword. Since the [[Holdings|holdings]] count as assets, they may reduce a child's financial aid eligibility when they apply for college. It could also reduce their ability to access other forms of governmental or community aid.

Any deposit or gifts made to the account is irrevocable, meaning it cannot be changed or reversed. All of the account's [[Holdings|holdings]] pass, irrevocably, to the minor at the age of majority. In contrast, many college savings plans, such as a [529 account](https://www.investopedia.com/terms/1/529plan.asp), allow parents to retain control of the funds.

Custodial accounts are not as tax-sheltered as other accounts. To mitigate a tax bite, a custodian can transfer funds to an eligible 529 plan. However, to do so, the custodian must [[liquidate]](https://www.investopedia.com/terms/l/[[Liquidate|liquidate]].asp) any non-cash investments in the custodial account.
...
Most brokerages, both digital and brick-and-mortars, [[Offer|offer]] custodial accounts. Custodial account terms usually parallel that of their regular, non-tax-advantaged accounts for individuals.

For example, a Merrill Edge—the digital broker platform from Merrill Lynch—UGMA/UTMA custodial account [[can be set up online]](https://www.merrilledge.com/college-savings/custodial) with funds directly transferred from a checking or savings account at Bank of America, Merrill's parent company. There are no annual account fees or minimum investment amounts. Account-holders pay a flat rate of $6.95 per day for [[Stock|stock]] and ETF trades, mutual funds trades cost $19.95 per transaction or may be priced according to the rate specified in the fund prospectus. However, some mutual funds are load-waived or no load/no transaction fee funds.
