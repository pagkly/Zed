...
To avoid purchasing power [[Erosion|erosion]] through inflation, investors consider the real interest rate, rather than the nominal rate. One way to estimate the real rate of [[Return|return]] in the United States is to observe the interest rates on Treasury Inflation-Protected Securities (TIPS).1 The difference between the [[Yield|yield]] on a [[Treasury bond]](https://www.investopedia.com/terms/t/treasurybond.asp) and the yield on TIPS of the same maturity provides an estimate of inflation expectations in the economy.2

For example, if the nominal interest rate offered on a three-year deposit is 4% and the inflation rate over this period is 3%, the investor’s real rate of [[Return|return]] is 1%. On the other hand, if the nominal interest rate is 2% in an environment of 3% annual inflation, the investor’s purchasing power erodes by 1% per year.
...
Although the nominal rate is the stated rate associated with a [[Loan|loan]], it is typically not the rate that the consumer pays. Rather, the consumer pays an effective rate that varies based on fees and the effect of compounding. To that end, annual percentage rate (APR) differs from the nominal rate, as it takes fees into account, and annual percentage [[Yield|yield]] (APY) takes both fees and compounding into account.
