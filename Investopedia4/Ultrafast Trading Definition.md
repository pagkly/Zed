---
alias: [Ultrafast Trading]
created: 2021-03-03T00:13:11 (UTC +11:00)
tags: [Ultrafast Trading Definition, Ultrafast Trading Definition]
source: https://www.investopedia.com/terms/u/ultrafast-trading.asp
author: Lucas Downey
---
...
> ## Excerpt
> Ultrafast trading is a lucrative and highly competitive method of [[Stock|stock]] trading that uses special software that makes trades in milliseconds.
...
Ultrafast trading is a method of trading [[stocks]](https://www.investopedia.com/terms/s/[[Stock|stock]].asp) by using computers and algorithms to execute trades within milliseconds of market changes.
...
-   Ultrafast trading has been heavily criticized for increasing the severity of [[Stock|stock]] swings and contribution to the manipulation of stock prices. Advocates of the software say it does the opposite, and improves efficacy when it comes to trading.
...
While this form of trading can be very profitable, it requires a vast amount of resources to employ. With that, it is not without its controversy also. Ultrafast trading has been heavily criticized for increasing the severity of [[Stock|stock]] swings and contribution to the manipulation of stock prices. Advocates of the software say it does the opposite, and improves efficacy when it comes to trading.
...
Ultimately, Aleynikov was convicted of stealing proprietary information from Goldman Sachs with the intention of taking it to the company he had recently been hired by, Teza Technologies. It was reported that Teza Technologies were going to pay Aleynikov triple what Goldman Sachs had to create algorithms for a [[Hedge Fund|hedge fund]] trading platform.

These days the codes are largely already written, and many of the bigger brokerage firms have the technology to compete in the ultrafast trading sector. This leaves a smaller section of the market to take advantage of. Since back when Goldman Sachs was fighting their lawsuit, profits have begun to decrease on these types of trades.

In 2017, profits from companies executing high frequency trades fell below $1 billion. This marked the first time trades fell to that range since before the recession in the mid-2000s. With more companies attempting to take advantage of these small market fluctuations, there are less of them available to profit from.

Top ultrafast trading companies include: Virtu Financial, Citadel Securities, Two Sigma Securities, Tower Research Capital, and Jump Trading. While the overall industry is rather quiet on providing publicly available information, a popular book, _Flash Boys: A Wall Street Revolt_ by Michael Lewis describes the world of high speed trading through the accounts of Wall Street participants. The book even reached the number 1 spot on the New York Times Best Seller List for a few weeks.
