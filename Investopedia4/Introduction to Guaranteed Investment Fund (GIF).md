...
> ## Excerpt
> A guaranteed investment fund allows a client to invest in an [[Equity|equity]], bond or index fund with the promise of a predefined minimum value upon fund maturity.
...
For example, suppose an investor near retirement age had invested $500,000 into this fund, and after an incredible bull run, their investment grows to $585,000 in a year. By resetting the guarantee at this point, the investor has now guaranteed that they [[Will|will]], at the very least, receive $585,000.
...
-   Guaranteed investment funds promise that all or part of the invested capital [[Will|will]] be secure at a specific, designated time.

## Concepts of Guaranteed Investment Funds

Guaranteed investment funds, as their name shows, guarantee that all or part of the invested capital [[Will|will]] be secure for a specific date in the future. And in some cases, there is the possibility of almost guaranteed returns.

### Guaranteed Maturity Date

A date in the future when all of the fund's [[Shares|shares]] are guaranteed to reach a specific net asset value (guaranteed net asset value). Only those shareholders that leave their investment until the maturity date [[Will|will]] be entitled to the guarantee. If a redemption is made before that date, then there could be great losses.
...
A marketing period is a period during which [[Shares|shares]] can be purchased from a guaranteed fund without paying subscription fees.
...
These only ensure starting investments on the guarantee's maturity date. They also [[Offer|offer]] the option to [[Gain|gain]] returns linked to how multiple financial assets or indicators perform (according to complex calculation formulas). Investors must take into account that if [[Underlying|underlying]] instruments do not develop as expected, then it is possible not to gain any returns.
