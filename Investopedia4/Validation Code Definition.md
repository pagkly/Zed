...
A validation code—also known as a CVV, CV2, or CVV2 code—is a series of three or four numbers located on the front or back of a [[credit card]](https://www.investopedia.com/terms/c/creditcard.asp). It is intended to provide an additional layer of [[Security|security]] for credit card transactions that take place online or over the phone.

Most credit card issuers place their validation codes on the back of the card, on the far-right side of the signature panel. On American Express ([AXP](https://www.investopedia.com/markets/[[Quote|quote]]?tvwidgetsymbol=AXP)) cards, however, the validation code is printed on the front of the card.1

### Key Takeaways

-   A validation code is one of the [[Security|security]] measures deployed to reduce credit card fraud.
