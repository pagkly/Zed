...
The belief in a hot hand is one shared by many gamblers and investors alike and is believed by psychologists to stem from the same source, the representative [[heuristic]](https://www.investopedia.com/terms/h/[[Heuristics|heuristics]].asp). For example, there is data to suggest that the decision of an investor to buy or sell a mutual fund depends largely on the track record of the fund manager, even though there is evidence that this factor is highly overrated. Hence, it would appear that such investors are making decisions based on whether or not they feel the fund managers are "hot" or not.
