...
> ## Excerpt
> A [[Hobby Loss|hobby loss]] is a non-deductible loss incurred in connection with an activity that is carried on for pleasure and not for profit.
...
The term [[Hobby Loss|hobby loss]] refers to a loss that results from a business deemed to be a recreational activity or hobby by the [[Internal Revenue Service]](https://www.investopedia.com/terms/i/irs.asp) (IRS). Taxpayers cannot claim and recoup this money when the agency says it is spent while pursuing a hobby. That's because losses aren't allowed for [[expenses]](https://www.investopedia.com/terms/e/expense.asp) in excess of hobby [[income]](https://www.investopedia.com/terms/i/income.asp).1 This means these expenses aren't deductible as they are with a business.1

### Key Takeaways

-   A [[Hobby Loss|hobby loss]] refers to any loss incurred while a [[Taxpayer|taxpayer]] conducts business that the IRS considers a hobby.
...
-   Prior to 2018, taxpayers were able to deduct some losses stemming from the activity if they didn't exceed the [[Gross Income|gross income]] for the activity.
...
-   Deductions that a [[Taxpayer|taxpayer]] may claim for certain personal expenses, such as home [[mortgage interest]](https://www.investopedia.com/terms/m/mortgageinterest.asp) and taxes, may be taken in full.
-   Deductions that don’t result in an adjustment to the basis of property, such as advertising, insurance [[premiums]](https://www.investopedia.com/terms/p/[[Premium|premium]].asp), and wages, may be taken next, to the extent [[Gross Income|gross income]] for the activity is more than the deductions from the first category.
...
So how does this affect hobbyists? Once the TCJA was signed, any expenses or hobby losses that a [[Taxpayer|taxpayer]] was able to claim to reduce their hobby income in previous tax years are no longer allowed. This applies to tax returns filed between the 2018 and 2025 tax years.6

## Avoiding a [[Hobby Loss]]

Although the TCJA eliminated miscellaneous itemized deductions, it's still important to know how to avoid the [[Hobby Loss|hobby loss]] rule if provisions aren't made after the 2025 tax year. The easiest way to avoid the hobby loss rules is to frequently turn a profit. The hobby loss rule presumes that an activity is for-profit if the operation is profitable for three out of the previous five years ending with the current taxable year. For actions involving horses, the timeframe is two of the previous seven years.3

If the presumption is not met, then the [[Taxpayer|taxpayer]] must establish a [[profit motive]](https://www.investopedia.com/terms/p/profit-motive.asp). The following nine factors define hobby income and losses:

1.  Does the [[Taxpayer|taxpayer]] have a businesslike manner while carrying on the activity?
2.  Is the [[Taxpayer|taxpayer]] an expert or an adviser?
...
A [[Taxpayer|taxpayer]] that fails to turn a profit or to establish a profit motive is not engaged in a business. The [[Hobby Loss|hobby loss]] rules [[Will|will]] apply. Hobby expenses that fail its three-tier deduction system are not deductible.7 Hobby expenses that exceed hobby income are disallowed as non-deductible hobby losses.1
