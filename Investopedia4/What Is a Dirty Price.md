...
> ## Excerpt
> A dirty price is a bond pricing [[Quote|quote]] that includes the cost of a bond that as well as accrued interest.
...
-   If a bond quotes between coupon payment dates, the price cited includes accrued interest up to the day of the [[Quote|quote]]. 
...
As an example, let's say Apple Inc. issued a bond with a $1,000 face value while $960 is the published price. The bond pays an interest rate—[[Coupon Rate|coupon rate]]—of 4% annually, and these payments are semiannual. As a result, investors would receive $20 every six months for holding the bond.

The price of $960 is the published price or the clean price. However, an investor looking to purchase the bond would receive a [[Quote|quote]] from a broker that includes the $960 plus any accrued interest. The broker would calculate the daily per diem of interest that has accumulated. Let's assume there's no broker [[Commission|commission]]. Depending on the day the investor made the purchase, the accrued interest would vary.
