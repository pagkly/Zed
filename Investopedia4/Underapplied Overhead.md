...
> ## Excerpt
> [[Underapplied Overhead|Underapplied overhead]] refers to the amount of actual factory overhead costs that are not allocated to units of production.
...
When [[Underapplied Overhead|underapplied overhead]] appears on [[financial statements]](https://www.investopedia.com/terms/f/financial-statements.asp), it is generally not considered a negative event. Rather, analysts and interested managers look for patterns that may point to changes in the business environment or [[economic cycle]](https://www.investopedia.com/terms/e/economic-cycle.asp). Should [[Unfavorable Variance|unfavorable variance]] or outcomes arise—because not enough product was produced to absorb all overhead costs incurred—managers [[Will|will]] first look for viable reasons. These may be explained by expected hiccups in production, business, or seasonal variation.

### Key Takeaways

-   [[Underapplied Overhead|Underapplied overhead]] occurs when overhead expenses are more than what a company actually budgets.
...
-   [[Underapplied Overhead|Underapplied overhead]] is an [[Unfavorable Variance|unfavorable variance]] because a business goes over budget.
