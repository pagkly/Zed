...
Individual and institutional investors can also place money in different types of funds with the goal of earning money. Examples include mutual funds, which gather money from numerous investors and invest it in a diversified [[Portfolio|portfolio]] of assets, and [[Hedge|hedge]] funds, which invest the assets of high-net-worth individuals (HNWI) and institutions in a way that is designed to earn above-market returns. Governments use funds, such as special revenue funds, to pay for specific public expenses.

## Common Types of Funds

The following are examples of funds commonly used for personal ventures:

-   **[[Emergency Funds|Emergency funds]]** are personal savings vehicles created by individuals used to cover periods of financial hardships, such as job loss, prolonged illness or a major expense. The [[Rule Of Thumb|rule of thumb]] is to create an emergency fund that contains at least three months worth of net income.
...
-   **Trust funds** are legal arrangement set up by a grantor who appoints a [[Trustee|trustee]] to administer valuable assets for the benefit of a [[Listed|listed]] beneficiary for a period of time, after which all or a portion of the funds are released to the beneficiary or beneficiaries.
...
-   **Mutual funds** are investment funds managed by professional managers who allocate the funds received from individual investors into [[Stocks|stocks]], bonds, and/or other assets.
...
-   **Exchange-traded funds** (ETFs) are similar to mutual funds but traded on the public exchanges like [[Stocks|stocks]].
-   **[[Hedge]] funds** are investment vehicles for high-net-worth individuals or institutions designed to increase the [[Return|return]] on investors’ pooled funds by incorporating high-[[Risk|risk]] strategies such as short selling, derivatives, and [[Leverage|leverage]].
-   **Government bond funds** are for investors looking to put their money away in low-[[Risk|risk]] investments through Treasury securities, such as Treasury bonds, or agency-issued [[Debt|debt]], such as securities issued by Fannie Mae. Both alternatives are backed by the U.S. government.
...
-   **Capital projects fund** resources are used to [[Finance|finance]] the capital projects of a country, such as purchasing, building or renovating equipment, structures, and other [[capital assets]](https://www.investopedia.com/terms/c/capitalasset.asp).
