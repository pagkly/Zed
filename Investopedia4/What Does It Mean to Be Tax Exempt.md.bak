...
> ## Excerpt
> Tax-exempt is to be free from, or not subject to, [[Taxation|taxation]] by regulators or government entities. Discover more about what it means to be tax exempt here.
...
Tax-exempt refers to income or transactions that are free from tax at the federal, state, or local level. The reporting of tax-free items may be on a [[Taxpayer|taxpayer]]'s individual or business [[Tax Return|tax return]] and shown for informational purposes only. The tax-exempt article is not part of any tax calculations.
...
Not to be confused with a [[tax deduction]](https://www.investopedia.com/terms/t/tax-deduction.asp), tax-exempt frees the [[taxpayer]](https://www.investopedia.com/terms/t/[[Taxpayer|taxpayer]].asp) of any tax obligation to submit taxes on the tax-free transaction or income. Whereas, the use of a tax deduction is to reduce the tax obligation by lowering [[gross income]](https://www.investopedia.com/terms/g/grossincome.asp).

One common type of tax-[[Exempt Income|exempt income]] is interest earned on [[municipal bonds]](https://www.investopedia.com/terms/m/municipalbond.asp), which are bonds issued by states and cities to raise funds for general operations or a specific project. When a [[Taxpayer|taxpayer]] makes interest income on municipal bonds issued in their state of residence, the profit is exempt from both federal and state taxes.2
...
A [[Taxpayer|taxpayer]] may buy an asset and subsequently sell that asset for a profit. The profit is a capital [[Gain|gain]], which creates a taxable event. 4 However, several types of capital gains are exempt from [[Taxation|taxation]]. 

A [[Taxpayer|taxpayer]] can offset [[capital gains]](https://www.investopedia.com/articles/tax/09/tax-effects-capital-gains.asp) with other [[capital losses]](https://www.investopedia.com/terms/c/capitalloss.asp) for the tax year. For example, an investor with $5,000 in profits and $3,000 in losses pays taxes on only $2,000 in capital gains. The amount of capital losses a taxpayer may claim in a given year has a cap of $3,000. When capital losses exceed this cap, the excess may be carried forward to offset gains in future years.4 
