...
> ## Excerpt
> A wild card play gives the seller of a T-bond [[Futures|futures]] the right to deliver after the closing price has been set and the contract is no longer trading.
...
-   A wild card play, usually involves a [[Treasury Bond (T-Bond)|Treasury bond (T-Bond)]] [[Futures|futures]] contract, is where the seller of the contract has the right to give notice of intent to deliver after the closing price of that contract has been set, even though the contract is no longer trading.
...
A wild card play occurs when a contract holder retains the right to deliver on the contract for a given period of time following the close of trading at the closing price. This [[Will|will]] end up financially benefiting the contract holder if there is a shift in the value or price of the asset between the time of the closing price and the actual delivery.
