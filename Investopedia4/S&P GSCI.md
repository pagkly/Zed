...
> ## Excerpt
> The [[S&P GSCI]] is an index of 24 exchange-traded [[Futures|futures]] contracts that represent a large portion of the global commodities market.
...
The [[S&P GSCI]] automatically rolls [[Futures|futures]] contracts, which may not be an optimal investment strategy. Futures contracts are affected by [[contango]](https://www.investopedia.com/terms/c/contango.asp) and [[backwardation]](https://www.investopedia.com/terms/b/backwardation.asp), and they can cause commodity futures to perform differently than actual commodities.

In theory, professional commodities traders can also use contango and backwardation to profit at the expense of simple automatic rolling strategies. This may be a significant flaw in the [[S&P GSCI]]. It could also be more theoretical than real, like many early criticisms of [[Stock|stock]] [[Market Index|market index]] funds.

## Other Commodity Indexes

Other widely watched and traded commodity indexes include the Credit Suisse Commodity Benchmark Index and the Bloomberg Commodity Total [[Return]] Index. It is essential to understand how commodity indexes are [[Weighted|weighted]] and rebalanced. These differences [[Will|will]] affect the performance of tracking products over time.
