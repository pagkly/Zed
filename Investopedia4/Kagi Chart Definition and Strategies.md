...
> ## Excerpt
> The Kagi chart is a [[Technical Analysis|technical analysis]] tool developed in Japan in the 1870s. It uses vertical lines to find general [[Supply|supply]] and demand levels.
...
The Kagi chart is a specialized type of [[technical analysis]](https://www.investopedia.com/terms/t/technicalanalysis.asp) developed in Japan in the 1870s. It uses a series of vertical lines to illustrate general levels of [[supply and demand]](https://www.investopedia.com/terms/l/law-of-[[Supply|supply]]-demand.asp) for certain assets, including the price movement of rice, a core Japanese agricultural product. Thick lines are drawn when the price of the [[Underlying|underlying]] asset breaks above the previous high price and is interpreted as an increase in demand for the asset. Thin lines are used to represent increased supply when the price falls below the previous low.

Image by Julie Bang © Investopedia 2020

### Key Takeaways

-   Kagi charts change direction when there is a price [[Reversal|reversal]] of a specified amount, or more.
-   The chart continues to move in that direction until there is price [[Reversal|reversal]] of the specified amount in the other direction.
...
The Kagi chart [[Will|will]] move up and down as the price moves by the [[Reversal|reversal]] amount, or more.

These charts are independent of time and only change direction once a predefined [[Reversal|reversal]] amount is reached. The reversal amount is discussed below.

Kagi charts, having no regard for time, have the advantage of reducing [[noise]](https://www.investopedia.com/terms/n/[[Noise|noise]].asp). Noise is a particular drawback of traditional [[candlestick]](https://www.investopedia.com/terms/c/candlestick.asp) charting methods. Because a change in price direction occurs only after a specific threshold is reached, some traders may find Kagi charts useful in terms of isolating the trend and viewing direction more clearly.
...
A Kagi chart [[Will|will]] reverse direction when the price has moved the other direction by a specified amount (or more). Assume a trader is trading Apple Inc. (AAPL) and they want the chart to show when there is a $10 [[Reversal|reversal]]. A Kagi chart can show that.

If the Kagi chart (and price) is moving higher to $300, the Kagi [[Will|will]] not reverse until the price drops below $290. If the price rises to $350, the Kagi won't reverse until the price drops below $340. If the price falls to $340 the Kagi will not reverse higher until the price moves back above $350.

The $10 [[Reversal|reversal]] is a moving target. The $10 reversal can be based on [[closing prices]](https://www.investopedia.com/terms/c/closingprice.asp) or highs and lows.

The [[Reversal|reversal]] amount doesn't need to be a fixed amount. It can also be based on [[Average True Range]](https://www.investopedia.com/terms/a/atr.asp) (ATR), which means the reversal amount [[Will|will]] change as [[Volatility|volatility]] changes.

When the Kagi chart reverses, it draws a horizontal line at the low or high price (close, high or low, depending on which is selected) and then reverses. It [[Will|will]] continues to move vertically until there is a [[Reversal|reversal]].
...
The follow chart shows a Kagi chart of Apple based on 1-hour closing prices. The [[Reversal|reversal]] amount is $5.
...
Kagi and [[Renko charts]](https://www.investopedia.com/terms/r/renkochart.asp) are both based on [[Reversal|reversal]] amounts. Renko charts are created by bricks that only move at 45-degree angles and never occur beside each other. Each brick is a specified amount. In order to get a reversal on the Renko chart the price must move two brick distances since there are no side-by-side bricks.
...
While trade signals with Kagi charts [[Will|will]] have some similarities to other chart types, like candlesticks, Kagi charts have unique features which may require additional study to take advantage of.
