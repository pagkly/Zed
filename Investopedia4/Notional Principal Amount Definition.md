...
> ## Excerpt
> The notional [[Principal|principal]] amount, in an interest rate [[Swap|swap]], is the predetermined dollar amounts on which the exchanged interest payments are based.
...
The notional [[Principal|principal]] amount, in an [[interest rate swap]](https://www.investopedia.com/terms/i/interestrateswap.asp), is the predetermined dollar amounts, or [[principal]](https://www.investopedia.com/terms/p/principal.asp), on which the exchanged interest payments are based. The notional principal never changes hands in the transaction, which is why it is considered notional, or theoretical. Neither party pays nor receives the notional principal amount at any time; only interest rate payments change hands.

## Understanding Notional [[Principal]] Amount

According to Treasury Regulations, a notional [[Principal|principal]] amount is "a [financial instrument](https://en.wikipedia.org/wiki/Financial_instrument) that provides for the payment of amounts by one party to another at specified intervals calculated by reference to a specified index upon a notional principal amount in exchange for specified consideration or a promise to pay similar amounts."

Notional [[Principal|principal]] refers to the assumed amount of principal involved in a financial transaction, even though it is functionally separated from the transaction. This can include the [[Underlying|underlying]] principal in a [[Debt|debt]] [[Security|security]] in interest rate swaps, as the rates are actual components in the transaction, but the principal is functionally fictitious. A notional principal amount need not necessarily be a cash amount. It can also be equal to [[Equity|equity]] [[Holdings|holdings]] or the value of a basket of [[Stocks|stocks]].

### Key Takeaways

-   Notional [[Principal|principal]] amounts are used in interest rate swaps.
-   They are the theoretical value that each party pays interest to the other at specified intervals.
-   In bonds, the notional [[Principal|principal]] amount is equal to the face-value of a bond.

## Interest Rate Swaps

An interest rate [[Swap|swap]] involves two organizations lending funds to each other but with different terms. The repayment schedule may be for different durations or for different interest rates. In cases where the transactions involve the same amount of [[Principal|principal]] (the amount being lent and received by each party), the principal is notional in nature and does not actually change hands, or may not even functionally exist.

Often, interest rate swaps are used to help shift the [[Risk|risk]] or [[Return|return]] of particular investments up on down, where one organization [[Will|will]] have an asset with a variable rate while the other holds an asset with a fixed rate. Accepted as a zero-sum agreement, one party may benefit from the arrangement while the other experiences a loss.
