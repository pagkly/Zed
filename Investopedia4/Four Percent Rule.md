...
The [[Four Percent Rule]] is a [[rule of thumb]](https://www.investopedia.com/terms/r/rule-of-thumb.asp) used to determine how much a retiree should withdraw from a retirement account each year. This rule seeks to provide a steady income stream to the retiree while also maintaining an account balance that keeps income flowing through retirement. Experts are divided on whether the 4% withdrawal rate is safe, as the withdrawals [[Will|will]] consist primarily of interest and [[dividends]](https://www.investopedia.com/terms/d/dividend.asp).

#### Why The 4% Rule No Longer Works For Retirees

### Key Takeaways

-   The [[Four Percent Rule]] states that you can withdraw 4% of your [[Portfolio|portfolio]] each year in retirement for a comfortable life.
-   It was created using historical data on [[Stock|stock]] and bond returns over a 50-year period.

## Understanding the [[Four Percent Rule]]

The [[Four Percent Rule]] helps [[financial planners]](https://www.investopedia.com/terms/f/financialplanner.asp) and retirees set a [[Portfolio|portfolio]]'s withdrawal rate. [[Life expectancy]](https://www.investopedia.com/terms/l/lifeexpectancy.asp) plays an important role in determining if this rate [[Will|will]] be sustainable, as retirees who live longer need their portfolios to last longer, and medical costs and other expenses can increase as retirees age.
...
Skeptical of whether this amount was sufficient, financial advisor William Bengen conducted an exhaustive study of [[Historical Returns|historical returns]] in 1994, focusing heavily on the severe market downturns of the 1930s and early 1970s. Bengen concluded that, even during untenable markets, no historical case existed in which a four percent annual withdrawal exhausted a retirement [[Portfolio|portfolio]] in less than 33 years.
...
There are several scenarios in which the [[Four Percent Rule]] might not work for a retiree. A severe or protracted market downturn can erode the value of a high-[[Risk|risk]] investment vehicle much faster than it can a typical retirement [[Portfolio|portfolio]].

Further, the [[Four Percent Rule]] does not work unless a retiree remains loyal to it year in and year out. Violating the rule one year to splurge on a major purchase can have severe consequences down the road, as this reduces the [[Principal|principal]], which directly impacts the [[Compound Interest|compound interest]] that the retiree depends on for [[Sustainability|sustainability]].
...
> The 2000 retiree is merely "in line" with the 1929 retiree, and doing better than the rest. And the 2008 retiree—even having started with the global [[Financial Crisis|financial crisis]] out of the gate—is  _already_ doing far better than  _any_ of these historical scenarios! In other words, while the tech crash and especially the global financial crisis were scary, they still haven’t been the kind of scenarios that spell outright doom for the [[Four Percent Rule]].

This is, of course, not a reason to go beyond it. Safety is a key element for retirees, even if following it may leave those who retire in calmer economic times "with a huge amount of money left over," Kitces notes, adding that "in general, a 4% withdrawal rate is really quite modest relative to the long-term historical average [[Return|return]] of almost 8% on a balanced (60/40) [[Portfolio|portfolio]]!"
