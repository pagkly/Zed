...
-   This measurement is considered more accurate than the related price-to-sales, because EV/sales takes into account a company's [[Debt|debt]] load.

## The Formula for Enterprise Value-to-Sales

EV/Sales\=MC+D−CCAnnual Saleswhere:MC\=Market capitalizationD\=DebtCC\=Cash and cash equivalents\\begin{aligned} &\\text{EV/Sales} = \\frac{ \\text{MC} + \\text{D} - \\text{CC} }{ \\text{Annual Sales} } \\\\ &\\textbf{where:}\\\\ &\\text{MC} = \\text{[[Market Capitalization|Market capitalization]]} \\\\ &\\text{D} = \\text{[[Debt]]} \\\\ &\\text{CC} = \\text{Cash and [[Cash Equivalents|cash equivalents]]} \\\\ \\end{aligned}

## How to Calculate Enterprise Value-to-Sales

Enterprise value-to-sales is calculated by:

1.  Adding total [[Debt|debt]] to a company’s market cap
2.  Subtracting out cash and [[Cash Equivalents|cash equivalents]]
...
EV\=MC+D+PS+MI−CCwhere:PS\=Preferred sharesMI\=Minority interest\\begin{aligned} &\\text{EV} = \\text{MC} + \\text{D} + \\text{PS} + \\text{MI} - \\text{CC} \\\\ &\\textbf{where:}\\\\ &\\text{PS} = \\text{Preferred [[Shares|shares]]} \\\\ &\\text{MI} = \\text{Minority interest} \\\\ \\end{aligned}

## What Does Enterprise Value-to-Sales Tell You?

Enterprise value-to-sales is an expansion of the [[price-to-sales]](https://www.investopedia.com/terms/p/price-to-salesratio.asp) (P/S) valuation, which uses [[Market Capitalization|market capitalization]] instead of enterprise value. It is perceived to be more accurate than P/S, in part, because the [[market capitalization]](https://www.investopedia.com/terms/m/marketcapitalization.asp) alone does not take a company's [[Debt|debt]] into account when valuing the company, while enterprise value does.

EV-to-sales multiples are usually found to be between 1x and 3x. Generally, a lower EV/sales multiple [[Will|will]] indicate that a company may be more attractive or undervalued in the market. The EV/sales measure can also be negative when the cash balance of the company is greater than the [[Market Capitalization|market capitalization]] and [[Debt|debt]] structure, signaling that the company can essentially be bought with its own cash.

The EV-to-sales measure can, however, be slightly deceptive in that a higher multiple is not always a signal of over-valuation. A high EV-to-sales can be a positive sign that investors believe that future sales [[Will|will]] greatly increase. A lower EV-to-sales can likewise signal that future sales prospects are not very attractive.
...
-   Its total [[Debt|debt]] as of Dec. 31, 2019 was $42.8 billion.2
-   Cash and [[Cash Equivalents|cash equivalents]] are $6.5 billion as of December 31, 2019.2
...
The EV-to-sales ratio takes into account the [[Debt|debt]] and cash a company has. The price-to-sales ratio, meanwhile, does not. The price-to-sales ratio is quicker to calculate, using only a company’s market cap as the numerator. However, debtholders do have a claim on sales and should theoretically be included in the valuation.

## Limitations of Using Enterprise Value-to-Sales

The EV/sales ratio requires calculating the enterprise value, which involves a little more digging into financial statements. EV is generally used for valuing acquisitions, where the acquirer [[Will|will]] assume the [[Debt|debt]] of the company, but also get the cash. Another limitation to be aware of is that sales do not take into account a company’s expenses or taxes.
