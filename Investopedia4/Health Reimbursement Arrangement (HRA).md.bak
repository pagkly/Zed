...
> ## Excerpt
> A [[Health Reimbursement Arrangement (HRA)|health reimbursement arrangement (HRA)]] is an employer-funded plan that reimburses employees for medical expenses and, sometimes, insurance premiums.
...
A [[Health Reimbursement Arrangement (HRA)|health reimbursement arrangement (HRA)]] is an employer-funded plan that reimburses employees for qualified medical expenses and, in some cases, insurance premiums. Employers are allowed to claim a tax deduction for the reimbursements they make through these plans, and [[Reimbursement|reimbursement]] dollars received by employees are generally tax free.

## How a [[Health Reimbursement Arrangement (HRA)]] Works

A health [[Reimbursement|reimbursement]] arrangement is a plan set up by an employer to cover medical expenses for its employees. The employer decides how much it [[Will|will]] put into the plan, and the employee can request reimbursement for actual medical expenses incurred up to that amount. All employees in the same class must receive the same HRA contribution.

An HRA is not an account. Employees cannot withdraw funds in advance and then use them to pay medical expenses. Instead, they must incur the expense first, then have it reimbursed. [[Reimbursement]] at the time of service is possible if the employer provides an HRA debit card. An employee who uses up all the allocated funds in the HRA before year-end [[Will|will]] have to cover any subsequent health bill out-of-pocket—or with the funds in a [[Flexible Spending Account (FSA)|flexible spending account (FSA)]], also known as a flexible spending arrangement), when available, or a [[Health Savings Account (HSA)|health savings account (HSA)]] for employees who have a [[high-deductible health plan (HDHP)]](https://www.investopedia.com/terms/h/hdhp.asp).
...
Starting in January 2020, HRAs [[Will|will]] change considerably. The government will allow employers to [[Offer|offer]] their employees a new type of HRA called an individual coverage HRA in lieu of [[Group Health Insurance|group health insurance]].
...
In addition, under the new rules, employers that continue to [[Offer|offer]] traditional [[Group Health Insurance|group health insurance]] can offer excepted benefit HRAs to reimburse employees for up to $1,800 a year in qualified medical expenses. Employees can enroll in an "excepted benefit HRA" even if they decline group health insurance coverage, but they cannot use the funds to buy comprehensive health insurance. They can, however, use the funds to pay for short-term health insurance, dental and vision insurance premiums, and qualified medical expenses (click [[here]](https://www.hhs.gov/sites/[[Default|default]]/files/health-[[Reimbursement|reimbursement]]-arrangements.pdf) and scroll to Q 11 for details).
