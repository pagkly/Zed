...
-   A clawback is a contractual provision that requires an employee to [[Return|return]] money already paid by an employer, sometimes with a penalty.
...
Following the [[Financial Crisis|financial crisis]] of 2008, clawback clauses have become more common since they allow company cover incentive pay from CEOs if there is misconduct or any discrepancies in the company's financial reports. 
...
Clawbacks are considered an important part of the business model because they help to restore the confidence and faith of investors and the public into a company or industry. For example, banks implemented clawback provisions following the [[Financial Crisis|financial crisis]] as a way to correct any future mistakes by their executives.
...
In July 2015, a proposed [[Securities and Exchange Commission (SEC)]] rule associated with the Dodd-Frank Act of 2010 would allow companies to claw back [[incentive-based compensation]](https://www.investopedia.com/terms/a/accounting-based-incentive.asp) paid to executives in the event of an accounting restatement. The clawback is limited to the excess of what would have been paid under the restated results. The rule would require [[Stock|stock]] exchanges to prohibit companies that do not have such clawback provisions written into their contracts from listing. This rule has yet to be approved.
...
Clawbacks are calculated when a fund is liquidated. [[Medicaid]](https://www.investopedia.com/articles/personal-[[Finance|finance]]/081114/[[Medicaid|medicaid]]-vs-medicare.asp) can claw back the costs of care from deceased patients' [[estates]](https://www.investopedia.com/terms/a/adjusted-gross-[[Estate|estate]].asp). In some cases, clawbacks may not even refer to money—lawyers can claw back privileged documents accidentally turned over during electronic discovery.

The term clawback also refers to the fall in a [[Stock|stock]]'s price after it increased.
...
-   **Life insurance**: A provision could dictate that the [[policy]](https://www.investopedia.com/terms/l/lifeinsurance.asp) is canceled and payments [[Will|will]] need to be returned.
