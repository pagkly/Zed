...
-   In a management buyout (MBO), a management team pools resources to acquire all or part of a business they manage. Funding usually comes from a mix of personal resources, private [[Equity|equity]] financiers, and seller-financing.
...
A management buyout (MBO) is different from a management buy-in (MBI), in which an external management team [[acquires]](https://www.investopedia.com/terms/a/acquisition.asp) a company and replaces the existing management team. It also differs from a leveraged management buyout (LMBO), where the buyers use the company assets as [[Collateral|collateral]] to obtain [[debt financing]](https://www.investopedia.com/terms/d/debtfinancing.asp). The advantage of an MBO over an LMBO is that the company’s [[debt load]](https://www.investopedia.com/terms/d/[[Debt|debt]]-load.asp) may be lower, giving it more financial flexibility.
