---
alias: [Hire Purchase Agreements]
...
Hire purchase agreements are similar to rent-to-own transactions that give the [[Lessee|lessee]] the option to buy at any time during the agreement, such as [[rent-to-own cars]](https://www.investopedia.com/articles/personal-[[Finance|finance]]/082315/renttoown-car-how-it-works.asp). Like rent-to-own, hire purchase can benefit consumers with poor credit by spreading the cost of expensive items that they would otherwise not be able to afford over an extended time period. It's not the same as an extension of credit, though, because the purchaser technically doesn't own the item until all of the payments are made.

Because ownership is not transferred until the end of the agreement, hire purchase plans [[Offer|offer]] more protection to the vendor than other sales or leasing methods for [[Unsecured|unsecured]] items. That's because the items can be repossessed more easily should the buyer be unable to keep up with the repayments.

## Advantages of Hire Purchase Agreements

Like leasing, hire purchase agreements allow companies with inefficient [[working capital]](https://www.investopedia.com/ask/answers/100915/can-working-capital-be-negative.asp) to deploy assets. It can also be more tax efficient than standard loans because the payments are booked as expenses—though any savings [[Will|will]] be offset by any tax benefits from depreciation.

Businesses that require expensive machinery—such as construction, [[Manufacturing|manufacturing]], plant hire, printing, road freight, transport and engineering—may use hire purchase agreements, as could startups that have little [[Collateral|collateral]] to establish lines of credit.

A hire purchase agreement can flatter a company's [[return on capital employed]](https://www.investopedia.com/terms/r/roce.asp) (ROCE) and [[return on assets]](https://www.investopedia.com/terms/r/returnonassets.asp) (ROA). This is because the company doesn't need to use as much [[Debt|debt]] to pay for assets.
...
Hire purchase buyers can [[Return|return]] the goods, rendering the original agreement void as long as they have made the required minimum payments. However, purchasers suffer a huge loss on returned or repossessed goods, because they lose the amount they have paid towards the purchase up to that point.
