...
However, the number can be obtained within 24 hours at no cost if applying as part of a federal government contract. The authorized representative of the company [[Will|will]] need to provide a legal company name, headquarters company name and address, physical address, mailing address, telephone number, contact name and title, and the number of employees at the physical location.4
...
The [[DUNS Number Lookup]](https://www.dnb.com/duns-number/lookup.html) tool is used to check whether a business has a DUNS number. The D&B database allows for accessing the company's D&B business [[Credit Score|credit score]], review and update an existing D&B credit report, view and print a copy of its D&B credit report, review and dispute payment history, and update financial information.

## Special Considerations

The DUNS number is used to identify a business registered with Dun & Bradstreet. The listing of companies with another [[Credit Bureau|credit bureau]], such as Experian, [[Will|will]] not be found on the D&B database since the credit bureaus each maintain unique databases and do not share data with one another.
