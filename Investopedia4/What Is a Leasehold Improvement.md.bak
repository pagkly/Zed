...
Once the [[Lease|lease]] ends, the improvements generally belong to the landlord, unless otherwise specified in the agreement. If the tenant is able to take them, they must remove them without any damage to the property.
...
Let's take another example from the retail sector. The owner of Store A decides to [[Lease|lease]] space through Company B. The store only has four walls and no other amenities. Through the lease negotiation, Company B—the landlord—agrees to install shelving, a service counter for cash registers, and a display unit with special lighting before Store A opens its doors.
...
-   Enlargements to buildings, elevators and escalators, roofs, fire protection, alarm and [[Security|security]] systems, and HVAC systems do not qualify as leasehold improvements.
...
[Rent](https://www.investopedia.com/terms/r/rent-expense.asp) discounts may be offered for leasehold improvements as well. The landlord offers the tenant free or reduced rent for a set number of months, such as one free month per year on the [[Lease|lease]], as a means for the tenant to save on space alterations. The tenant typically oversees the project and has control over the lease improvements. The tenant is also responsible if costs exceed the budgeted amounts. In addition, rent may be raised at a later date, causing the tenant to pay more for the space [[Long Term|long term]].
