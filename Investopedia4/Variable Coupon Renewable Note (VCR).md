...
> ## Excerpt
> A [[Variable Coupon Renewable Note (VCR)|variable coupon renewable note (VCR)]] is a renewable fixed income [[Security|security]] with variable coupon rates that are periodically reset.
