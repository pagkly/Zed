...
A key ratio is an important [[financial ratio]](https://www.investopedia.com/financial-ratios-4689817), one that is widely used and considered one of the fundamental ways to measure a company’s [[Liquidity|liquidity]], efficiency, or [[profitability]](https://www.investopedia.com/ask/answers/033015/what-difference-between-efficiency-ratios-and-profitability-ratios.asp) in relation to its peers.

These financial ratios illustrate and summarize the current financial condition of a company. Those that are in sound [[financial health]](https://www.investopedia.com/terms/f/financial-health.asp) [[Will|will]] have superior ratios to those that are performing poorly. 
...
Key ratios take data from the subject company's [[financial statements]](https://www.investopedia.com/terms/f/financial-statements.asp), such as the balance sheet, income statement, and [statement of cash flows](https://www.investopedia.com/terms/c/cashflowstatement.asp), and then compare them with other items. These numbers are then calculated together to produce a ratio that represents key aspects of the company's financial picture, such as [[Liquidity|liquidity]], profitability, use of [[Debt|debt]], and earnings strength.
...
-   **[Working capital ratio](https://www.investopedia.com/ask/answers/010915/what-proper-ratio-between-working-capital-current-assets-and-current-liabilities.asp):** [[Current Assets|Current assets]] are divided by current liabilities to establish how capable a company is of meeting its current financial [[obligations]](https://www.investopedia.com/terms/o/obligation.asp).
-   **[Price-Earnings (P/E) Ratio](https://www.investopedia.com/terms/p/price-earningsratio.asp):** Divide the current [[Stock|stock]] price by [earnings per share](https://www.investopedia.com/terms/e/eps.asp) (EPS) to determine the price investors pay for $1 of a company’s profit.
...
-   **[Return on equity](https://www.investopedia.com/terms/r/returnonequity.asp) (ROE)**: Divide net income by [[shareholders' equity]](https://www.investopedia.com/terms/s/shareholdersequity.asp) to see what [[Yield|yield]] is returned to a firm's owners and/or investors.

Of course, other investors and analysts [[Will|will]] consider other ratios to be the key ones.
...
In the case of the latter, it's typical to utilize the capital to assets ratio, the [[Loan|loan]] [loss reserves](https://www.investopedia.com/terms/l/loss-reserve.asp) to total loans ratio, and the [[Liquidity|liquidity]] ratio. For tech [[Stocks|stocks]], on the other hand, analysts and investors usually prefer to examine price-to-sales (P/S) ratios, [return on research capital](https://www.investopedia.com/terms/r/[[Return|return]]-on-research-capital.asp) (RORC), and so forth.
