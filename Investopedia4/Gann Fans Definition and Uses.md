...
> ## Excerpt
> Gann fans are a form of [[Technical Analysis|technical analysis]] based on the idea that the market is geometric and cyclical in nature. Gann fans draw lines at different angles to show potential areas of support and resistance.
...
Gann fans are a form of [[technical analysis]](https://www.investopedia.com/terms/t/technicalanalysis.asp) based on the idea that the market is geometric and cyclical in nature. A Gann fan consists of a series of lines called [[Gann Angles|Gann angles]]. These angles are superimposed over a price chart to show potential [[support and resistance]](https://www.investopedia.com/trading/support-and-resistance-basics/) levels. The resulting image is supposed to help technical analysts predict price changes.
...
Think of a piece of a grid paper, with lots of little squares on it. If the price ascends the height of the square, within a one square time frame, a line can be drawn from the bottom left to the top right of the square. That line's slope degree [[Will|will]] be 45.

If it takes two time boxes to ascend the height of one box (2:1), the angle of ascent [[Will|will]] be flatter than 45 degrees. If the price ascends two box heights within the time frame of one box (1:2) that angle is steeper than 45 degrees. The Gann Fan incorporates angles based on price-to-time moves in the following ratios: 1:8, 1:4, 1:3, 1:2, 1:1, 2:1, 3:1, 4:1, and 8:1.
...
Gann fans are drawn from a central 45-degree angle line that extends out from a specified trend [[Reversal|reversal]] level. Traders [[Will|will]] draw a Gann fan at a [[reversal]](https://www.investopedia.com/terms/r/reversal.asp) point to see support and resistance levels extended into the future.
