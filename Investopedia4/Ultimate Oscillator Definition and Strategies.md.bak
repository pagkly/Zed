...
> ## Excerpt
> The Ultimate Oscillator is a technical indicator developed by Larry Williams to measure the price [[Momentum|momentum]] of an asset across multiple timeframes. It produces buy and sell signals based on divergence.
...
The Ultimate Oscillator is a [[technical indicator]](https://www.investopedia.com/terms/t/technicalindicator.asp) that was developed by Larry Williams in 1976 to measure the price [[Momentum|momentum]] of an asset across multiple timeframes. By using the [[Weighted|weighted]] average of three different timeframes the indicator has less [[volatility]](https://www.investopedia.com/terms/v/[[Volatility|volatility]].asp) and fewer trade signals compared to other oscillators that rely on a single timeframe. Buy and sell signals are generated following [[divergences]](https://www.investopedia.com/terms/d/divergence.asp). The Ultimately Oscillator generates fewer divergence signals than other oscillators due to its multi-timeframe construction.
...
1.  Calculate the Buying Pressure (BP) which is the [[close price]](https://www.investopedia.com/terms/c/closingprice.asp) of the period less the low of that period or prior close, whichever is lower. Record these values for each period as they [[Will|will]] be summed up over the last seven, 14, and 28 periods to create BP Sum.
2.  Calculate the True Range (TR) which is the current period's high or the prior close, whichever is higher, minus the lowest value of the current period's low or the prior close. Record these values for each period as they [[Will|will]] be summed up over the last seven, 14, and 28 periods to create TR Sum.
...
-   Second, the first low in the divergence (the lower one) must have been below 30. This means the divergence started from oversold territory and is more likely to result in an [[Upside|upside]] price [[reversal]](https://www.investopedia.com/terms/r/[[Reversal|reversal]].asp).
...
-   Second, the first high in the divergence (the higher one) must be above 70. This means the divergence started from [[Overbought|overbought]] territory and is more likely to result in a downside price [[Reversal|reversal]].
...
The Ultimate Oscillator has three lookback periods or timeframes. The [[Stochastic Oscillator]](https://www.investopedia.com/terms/s/stochasticoscillator.asp) has only one. The Ultimate Oscillator doesn't typically include a [[signal line]](https://www.investopedia.com/terms/s/signal_line.asp) (one could be added), while the Stochastic does. While both indicators generate trade signals based on divergence, the signals [[Will|will]] be different due to the different calculations. Also, the Ultimate Oscillator uses a three-step method for trading divergence.

## Limitations of Using the Ultimate Oscillator

While the three-step trading method for the indicator may help eliminate some poor trades, it also eliminates many good ones. Divergence is not present at all price [[Reversal|reversal]] points. Also, a reversal won't always occur from [[Overbought|overbought]] or oversold territory. Also, waiting for the oscillator to move above the divergence high (bullish divergence) or below the divergence low (bearish divergence) could mean poor entry point as the price may have already run significantly in the reversal direction.

As with all indicators, the Ultimate Oscillator shouldn't be used in isolation, but rather as part of a complete trading plan. Such a plan [[Will|will]] typically include other forms of analysis such as [[price analysis]](https://www.investopedia.com/terms/p/price-action.asp), other technical indicators, and/or [[fundamental analysis]](https://www.investopedia.com/terms/f/fundamentalanalysis.asp).
