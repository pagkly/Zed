...
While GPUs were initially popular with video editing and computer gaming enthusiasts, the rapid growth of [[cryptocurrencies]](https://www.investopedia.com/terms/c/[[Cryptocurrency|cryptocurrency]].asp) created a new market. This is because cryptocurrency [[Mining|mining]] requires thousands of calculations in order to add transactions to a [[blockchain]](https://www.investopedia.com/terms/b/blockchain.asp), which is something that could be profitable with access to a GPU and an inexpensive [[Supply|supply]] of electricity.

In recent years, two prominent graphics cards manufacturers, Nvidia Corp. ([NVDA](https://www.investopedia.com/markets/[[Quote|quote]]?tvwidgetsymbol=nvda)) and Advanced Micro Devices Inc. ([AMD](https://www.investopedia.com/markets/quote?tvwidgetsymbol=amd)), have experienced a rapid increase in sales and revenue as a result of [[Cryptocurrency|cryptocurrency]] [[Mining|mining]].

This had the side effect of frustrating non-[[Mining|mining]] customers, who saw prices increase and [[Supply|supply]] dries up. As a result, retailers occasionally limited the number of graphics cards that an individual could purchase. While miners of the more popular cryptocurrencies, such as [[bitcoin,]](https://www.investopedia.com/terms/b/bitcoin.asp) have shifted to using specialized and more cost-effective chipsets called application-specific integrated circuits (ASICs), Graphics Processing Units are still used to mine lesser-known currencies.
