...
The EEOC's role is to fairly and accurately assess allegations in the charge and then make a finding. If it finds discrimination has occurred, it [[Will|will]] try to settle the charge. It also has the authority to file a lawsuit to protect individuals and the interests of the public.
