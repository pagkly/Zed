...
The gas guzzler tax is a surcharge added to the sales or [[Lease|lease]] price of cars in the U.S. that have poor fuel economy ratings. The tax, which is paid by the manufacturer or importer of the vehicle, varies depending on the miles-per-gallon efficiency of the vehicle and ranges from $1,000 to $7,700.1
...
Shoppers for a new car [[Will|will]] see the amount of the tax posted on the window sticker of the car if it is subject to the gas guzzler tax.3
...
The adjustment is meant to reflect the differences between real-world driving and laboratory testing conditions. This difference is referred to as in-use [[shortfall]](https://www.investopedia.com/terms/s/[[Shortfall|shortfall]].asp). To calculate the shortfall, mpg values [[Listed|listed]] in the Fuel Economy Guide and shown on fuel economy labels are based on three tests in addition to the standard fuel-economy test.5

The combined city and highway fuel economy that is used to determine [[Tax Liability|tax liability]] is not adjusted to account for in-use [[Shortfall|shortfall]], so it is higher than the mpg values provided in the Fuel Economy Guide and posted on the window stickers of new vehicles.5
