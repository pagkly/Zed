...
[[Return]] on capital employed (ROCE) is a [financial ratio](https://www.investopedia.com/ask/answers/062215/what-are-financial-[[Risk|risk]]-ratios-and-how-are-they-used-measure-risk.asp) that can be used in assessing a company's profitability and capital efficiency. In other words, this ratio can help to understand how well a company is generating profits from its capital as it is put to use.
...
-   Many companies may calculate the following key [[Return|return]] ratios in their performance analysis: return on [[Equity|equity]] (ROE), return on assets (ROA), return on invested capital (ROIC), and return on capital employed.
...
ROCE is a metric for analyzing profitability, and potentially comparing profitability levels across companies in terms of capital. There are two components required to calculate [[Return|return]] on capital employed: earnings before interest and tax and capital employed.
...
[Capital employed](https://www.investopedia.com/terms/c/capitalemployed.asp) is very similar to invested capital, which is used in the ROIC calculation. Capital employed is found by subtracting total assets from current liabilities, which ultimately gives you shareholders’ [[Equity|equity]] plus long-term debts. Instead of using capital employed at an arbitrary point in time, some analysts and investors may choose to calculate ROCE based on the [average capital employed](https://www.investopedia.com/terms/r/[[Return|return]]-on-average-capital-employed-roace.asp), which takes the average of opening and closing capital employed for the time period under analysis.

## What Does [[Return]] on Capital Employed Tell You?

ROCE can be especially useful when comparing the performance of companies in capital-intensive sectors, such as utilities and telecoms. This is because unlike other [[Fundamentals|fundamentals]] such as [return on equity](https://www.investopedia.com/ask/answers/09/[[Return|return]]-on-[[Equity|equity]]-vs-return-on-capital.asp) (ROE), which only analyzes profitability related to a company’s shareholders’ equity, [ROCE considers [[Debt|debt]] and equity](https://www.investopedia.com/ask/answers/011215/what-difference-between-roce-and-roe.asp). This can help neutralize financial performance analysis for companies with significant debt.
...
-   Net [[Operating Profit|operating profit]] after tax / invested capital

Net [[Operating Profit|operating profit]] after tax: This is a measure of EBIT x (1 – tax rate). This takes into consideration a company’s tax obligations, but ROCE usually does not.

[Invested capital](https://www.investopedia.com/terms/i/invested-capital.asp): Invested capital in the ROIC calculation is slightly more complex than the simple calculation for capital employed used in ROCE. Invested capital may be either:

-   Net working capital + property plant and equipment + goodwill and intangibles

Or:

-   Total [[Debt|debt]] and leases + total [[Equity|equity]] and equity equivalents + non-operating cash and investments
...
Businesses use their capital in order to carry on day-to-day operations, invest in new opportunities, and grow. Capital employed simply refers to a company's total assets less its current liabilities. Looking at capital employed is helpful since it's used with other financial metrics to determine the [[Return|return]] on a company's assets as well as how effective management is at employing capital.

### Why is ROCE useful if we already have ROE and ROA measures?

Some analysts prefer [[Return|return]] on capital employed over return on [[Equity|equity]] (ROE) and return on assets (ROA) since it takes both [[Debt|debt]] and equity financing into consideration, and is a better gauge for the performance or profitability of the company over a longer period of time.

### How is ROCE calculated?

[[Return]] on capital employed is calculated by dividing net [[Operating Profit|operating profit]], or earnings before interest and taxes (EBIT), by employed capital. Another way to calculate it is by dividing earnings before interest and taxes by the difference between total assets and current liabilities.

### What is a good ROCE value?

While there is no industry standard, a higher [[Return|return]] on capital employed suggests a more efficient company, at least in terms of capital employment. However, a higher number may also be indicative of a company with a lot of cash on hand since cash is included in total assets. As a result, high levels of cash can sometimes skew this metric.
