...
Most advisors [[Will|will]] [[Offer|offer]] a current Form ADV to any potential client early in the marketing process; in fact, investors should be immediately cautious of an advisor that does not freely offer the form upon request.
...
Finally, it [[Will|will]] always include any disciplinary events involving the advisory firm and/or its employees. The SEC reviews the information from this part of the form to process registrations, and manages its regulatory and examination programs.
...
Part 2 also should include management background—their educational history and business experiences. These bios should extend to key advisory personnel, as well. Section 2 is the most important primary disclosure document, which investment advisers [[Offer|offer]] their clients. Brochures are always available to the public once filed.
