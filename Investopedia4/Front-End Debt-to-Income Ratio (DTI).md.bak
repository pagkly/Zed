...
source: https://www.investopedia.com/terms/f/front-end-[[Debt|debt]]-to-income-ratio.asp
author: Adam Hayes
---
...
> ## Excerpt
> [[Front-End Debt-to-Income Ratio (DTI)|Front-end debt-to-income ratio (DTI)]] calculates the proportion of a person's [[Gross Income|gross income]] that is going to housing costs.

---

[[Front-End Debt-to-Income Ratio (DTI)]]
## What Is the [[Front-End Debt-to-Income Ratio (DTI)|Front-End Debt-To-Income Ratio (DTI)]]?

The [[Front-End Debt-to-Income Ratio (DTI)|front-end debt-to-income ratio (DTI)]] is a variation of the DTI that calculates how much of a person's [[gross income]](https://www.investopedia.com/terms/g/grossincome.asp) is going toward housing costs. If a homeowner has a mortgage, the front-end DTI is typically calculated as housing expenses (such as mortgage payments, mortgage insurance, etc.) divided by [[Gross Income|gross income]]. In contrast, a back-end DTI calculates the percentage of gross income going toward other [[debt]](https://www.investopedia.com/terms/d/[[Debt|debt]].asp) types, such as credit cards or car loans. You may also hear these ratios referred to as "Housing 1" and "Housing 2," or "Basic" and "Broad," respectively.

### Key Takeaways:

-   The [[Front-End Debt-to-Income Ratio (DTI)|front-end debt-to-income ratio (DTI)]], or the housing ratio, calculates how much of a person's [[Gross Income|gross income]] is spent on housing costs.
-   The front-end DTI is typically calculated as housing expenses (such as mortgage payments, mortgage insurance, etc.) divided by [[Gross Income|gross income]].
-   A back-end DTI calculates the percentage of [[Gross Income|gross income]] spent on other [[Debt|debt]] types, such as credit cards or car loans.
-   Lenders usually prefer a front-end DTI of no more than 28%. 

## Understanding the [[Front-End Debt-to-Income Ratio (DTI)|Front-End Debt-To-Income Ratio (DTI)]]
...
### Calculating [[Front-End Debt-to-Income Ratio (DTI)|Front-End Debt-To-Income Ratio (DTI)]]
...
### What Is a Desirable [[Front-End Debt-to-Income Ratio (DTI)|Front-End Debt-To-Income Ratio (DTI)]]?

To qualify for a mortgage, the borrower often must have a front-end [[Debt|debt]]-to-income ratio of less than an indicated level. Paying bills on time, a stable income, and a good [[credit score]](https://www.investopedia.com/terms/c/credit_score.asp) won't necessarily qualify you for a [[mortgage]](https://www.investopedia.com/terms/m/mortgage.asp) [[Loan|loan]]. In the mortgage lending world, how far you are from financial ruin is measured by your DTI. Simply put, this is a comparison of your housing expenses and your monthly debt obligations versus how much you earn.
...
Lenders usually prefer a front-end DTI of no more than 28%. In reality, depending on your [[Credit Score|credit score]], savings, and down payment, lenders may accept higher ratios, although it depends on the type of mortgage [[Loan|loan]]. However, the back-end DTI is actually considered more important by many financial professionals for mortgage loan applications.

## Special Considerations

When preparing for a mortgage application, the most obvious of strategies for lowering the front-end DTI is to pay off [[Debt|debt]]. However, most people don’t have the money to do so when they are in the process of getting a mortgage—most of their savings are going toward the [[down payment]](https://www.investopedia.com/terms/d/down_payment.asp) and [[closing costs]](https://www.investopedia.com/terms/c/closingcosts.asp). If you think you can afford the mortgage, but your DTI is over the limit, a [[co-signer]](https://www.investopedia.com/terms/c/co_sign.asp) might help.
