...
Note that a different term "[fund flows](https://www.investopedia.com/terms/f/fund-flow.asp)" is used to denote the amount of assets moving in and out of different types of mutual funds, e.g. among [[Equity|equity]] and fixed income funds.
...
-   Figures measuring the scale and [[Scope|scope]] of flow of funds in a nation's economy are collected and disseminated by the central bank for economic analysis.
