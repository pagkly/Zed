...
The [[National Registration Database (NRD)]] is a Canadian database that was launched in 2003 to replace the original paper form system. It allows [[Security|security]] dealers and investment advisors to file registration forms electronically.

## Understanding the [[National Registration Database (NRD)]]

The NRD increases the efficiency of the filing and sharing of information between provincial [[Security|security]] regulators. Examples of items that need to be filed include a change in the information of a member firm and the termination of an investment advisor. 
