...
> ## Excerpt
> Trust property includes assets such as securities, cash and property that are managed by a [[Trustee|trustee]] for the benefit of designated individuals.
...
Trust property refers to assets that have been placed into a [[fiduciary]](https://www.investopedia.com/terms/f/[[Fiduciary|fiduciary]].asp) relationship between a trustor and [[trustee]](https://www.investopedia.com/terms/t/[[Trustee|trustee]].asp) for a designated [[beneficiary]](https://www.investopedia.com/terms/b/beneficiary-of-trust.asp). Trust property may include any type of asset, including cash, securities, real [[Estate|estate]], or life insurance policies. Trust property is also referred to as "trust assets" or "trust corpus."

### Key Takeaways

-   Trust property refers to the assets placed into a trust, which are controlled by the [[Trustee|trustee]] on behalf of the trustor's beneficiaries.
-   Trust property removes [[Tax Liability|tax liability]] on the assets from the trustor to the trust itself, in some cases.
-   [[Estate Planning|Estate planning]] allows for trust property to pass directly to the designated beneficiaries upon the trustor's death without [[Probate|probate]].
