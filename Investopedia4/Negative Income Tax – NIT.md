...
To get a negative income tax subsidy, the needy would, along with other taxpayers, simply file [[income tax returns]](https://www.investopedia.com/terms/i/individual-tax-[[Return|return]].asp). The IRS’ computerized system could then quickly and objectively identify taxpayers with income below the threshold as eligible for help.
