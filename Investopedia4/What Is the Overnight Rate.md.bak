...
-   The goal of these lending activities is to ensure the maintenance of federally-mandated [[Reserve Requirements|reserve requirements]].
...
In the United States, the overnight rate is referred to as the [federal funds rate](https://www.investopedia.com/terms/f/federalfundsrate.asp), while in Canada, it is known as the policy interest rate. The rate increases when [[liquidity]](https://www.investopedia.com/terms/l/[[Liquidity|liquidity]].asp) decreases (when loans are more difficult to come by) and falls when liquidity increases (when loans are more readily available). As a result, the overnight rate is a good indicator of the health of a country's overall economy and banking system.

As of August 2020, the Federal Funds rate sits at a target rate of 0% to 0.25%, [[Unchanged|unchanged]] since March. In March, the central bank cut the overnight lending rate to match historic lows, in a bid to temper the economic impact of COVID-19.

## Effects of the Overnight Rate

The overnight rate indirectly affects mortgage rates in that as the overnight rate increases, it is more expensive for banks to settle their accounts, so to compensate they [[Will|will]] raise longer-term rates. 
