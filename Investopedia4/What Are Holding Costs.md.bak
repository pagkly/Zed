...
> ## Excerpt
> Holding costs associated with storing inventory are a major component of [[Supply|supply]] chain management because businesses must determine how much to keep in [[Stock|stock]].
...
-   Minimizing inventory costs is an important [[Supply|supply]]-chain management strategy.
...
Assume that ABC [[Manufacturing]] produces furniture that is stored in a warehouse and then shipped to retailers. ABC must either [[Lease|lease]] or purchase warehouse space and pay for utilities, insurance, and [[Security|security]] for the location.

The company must also pay staff to move inventory into the warehouse and then load the sold merchandise onto trucks for shipping. The firm incurs some [[Risk|risk]] that the furniture may be damaged as it is moved into and out of the warehouse.
...
For example, a company with $1 million in cost of goods sold and an inventory balance of $200,000 has a [[Turnover Ratio|turnover ratio]] of five. The goal is to increase sales and reduce the required amount of inventory so that the turnover ratio increases.

Another important strategy to minimize holding costs and other inventory spending is to calculate a reorder point, or the level of inventory that alerts the company to order more inventory from a supplier. An accurate reorder point allows the firm to fill customer orders without overspending on storing inventory. Companies that use a reorder point avoid shortage costs, which is the [[Risk|risk]] of losing a customer order due to low inventory levels.
