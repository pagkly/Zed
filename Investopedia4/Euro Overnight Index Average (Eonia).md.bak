...
> ## Excerpt
> Eonia is a daily reference rate expressing the [[Weighted|weighted]] average of [[Unsecured|unsecured]] overnight interbank lending in the E.U. and the EFTA.
...
Eonia is a daily reference rate that expresses the [[Weighted|weighted]] average of [[Unsecured|unsecured]] overnight interbank lending in the [[European Union]](https://www.investopedia.com/terms/e/europeanunion.asp) and the European Free Trade Association (EFTA). It is calculated by the [[European Central Bank (ECB)]](https://www.investopedia.com/terms/e/europeancentralbank.asp) based on the loans made by 28 panel banks.2 

Banks must meet certain [[reserve requirements]](https://www.investopedia.com/terms/r/requiredreserves.asp) that are typically set by the central bank. A reserve is the amount or percentage of total deposits that a bank must keep on hand and not lend out. A reserve requirement helps protect banks so that they have enough cash or [[liquidity]](https://www.investopedia.com/terms/l/[[Liquidity|liquidity]].asp) in case of [[Loan|loan]] losses. However, banks can experience short-term [[cash flow]](https://www.investopedia.com/terms/c/cashflow.asp) shortages at the end of a business day, such as when there are unexpected cash withdrawals. As a result, the banks that are short on cash can borrow from other banks that have [[Cash Flow|cash flow]] surpluses. The rate that banks borrow from each other is called the [[overnight rate]](https://www.investopedia.com/terms/o/overnightrate.asp). In Europe, Eonia represents the average overnight rate of 28 of the most established banks called panel banks.2
...
In 2018, the ECB formed a working group to help establish a new benchmark rate for Europe. Historically, bank scandals have occurred using [[Quote|quote]]-based interest rates as benchmarks. As a result, there are reforms underway to replace Eonia with ESTER or €STER, which is short for Euro Short Term Rate.6

ESTER is also an overnight interest rate but represents an average of the [[wholesale]](https://www.investopedia.com/terms/w/wholesalebanking.asp) rates in Europe. These wholesale rates are typically used with banks and institutional investors such as pension funds. One of the key reasons for the switch to ESTER is that there [[Will|will]] more banks contributing to the average ESTER rate than currently with Eonia. As a result, ESTER should be more representative than Eonia of the short-term interest rate market. By January 2022, ESTER is expected to replace Eonia.1
