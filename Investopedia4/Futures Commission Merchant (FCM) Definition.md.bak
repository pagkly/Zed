...
> ## Excerpt
> A [[Futures|futures]] [[Commission|commission]] merchant (FCM) solicits or accepts orders to buy or sell futures contracts or options on futures for a payment from customers.
...
A [[Futures|futures]] [[Commission|commission]] merchant (FCM) plays an essential role in enabling customers to participate in the futures markets. An FCM is an individual or organization involved in the solicitation or acceptance of buy or sell orders for [[futures]](https://www.investopedia.com/terms/f/futures.asp) or options on futures in exchange for payment of money ([commission](https://www.investopedia.com/terms/c/commission.asp)) or other assets from customers. An FCM also has the responsibility of collecting [[margin]](https://www.investopedia.com/terms/m/margin.asp) from customers. The FCM is also responsible for ensuring asset delivery after the futures contract has expired.1

In Europe, FCMs are analogous to clearing members of the [[Futures|futures]] market.

### Key Takeaways

-   A [[Futures|futures]] [[Commission|commission]] merchant (FCM) solicits and accepts trading for future contracts with customers.
...
An FCM may either be a clearing member firm of one or more exchanges (a "clearing FCM") or a non-clearing member firm (a "non-clearing FCM"). Clearing FCMs are required to [[Hold|hold]] substantial deposits with the [[clearing house]](https://www.investopedia.com/terms/c/clearinghouse.asp) of any exchange of which it is a member. A non-clearing FCM must have its customers' trades cleared by a clearing FCM.3
...
A [[Futures|futures]] [[Commission|commission]] merchant is able to handle [[futures contract]](https://www.investopedia.com/video/play/futures-contract-explained/) orders as well as extend credit to customers wishing to enter into such positions. These include many of the brokerages with which investors in the [[futures markets]](https://www.investopedia.com/terms/f/futuresmarket.asp) deal.

If a customer wishes to purchase (or sell) a [[Futures|futures]] contract, they contact an FCM who acts as an intermediary by purchasing (or selling) the contract on the customer's behalf. This is similar to what a [[stockbroker]](https://www.investopedia.com/terms/s/stockbroker.asp) does with [[Stocks|stocks]]. At maturity, or the [[delivery date]](https://www.investopedia.com/terms/d/deliverydate.asp), the FCM also makes sure the contract is fulfilled and either the commodity or cash is delivered to the customer.

FCMs, among other things, enable farmers and companies (called [[commercials]](https://www.investopedia.com/terms/c/commercial.asp)) to [[Hedge|hedge]] their risks and provide customers access to exchanges and clearinghouses. They can be subsidiaries of larger financial firms or smaller, independent firms. However, in recent years, and especially since the enactment of the [Dodd-Frank](https://www.investopedia.com/terms/d/dodd-frank-financial-regulatory-reform-bill.asp) legislation in 2010, the numbers of FCMs, especially small independents, have declined due to the regulatory burden.7
