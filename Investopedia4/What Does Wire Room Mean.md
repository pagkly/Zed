...
Any institution with a wire room should have [[Security|security]] procedures in place to make sure that all incoming and outgoing payment orders are legitimate and accurate. Security procedures can include having a second staff member review outgoing payment orders, using code words and call backs, and authorizing only certain employees to send and receive payment orders.
