...
> ## Excerpt
> A [[Trial Balance|trial balance]] is a bookkeeping worksheet in which the balances of all ledgers are compiled into debit and credit account column totals that are equal.
...
A [[Trial Balance|trial balance]] is a bookkeeping worksheet in which the balance of all [[ledgers]](https://www.investopedia.com/terms/g/generalledger.asp) are compiled into debit and credit account column totals that are equal. A company prepares a trial balance periodically, usually at the end of every reporting period. The general purpose of producing a trial balance is to ensure the entries in a company's bookkeeping system are mathematically correct.

## How a [[Trial Balance]] Works

Preparing a [[Trial Balance|trial balance]] for a company serves to detect any mathematical errors that have occurred in the [[double-entry]](https://www.investopedia.com/terms/d/double-entry.asp) accounting system. If the total debits equal the total credits, the trial balance is considered to be balanced, and there should be no mathematical errors in the ledgers. However, this does not mean there are no errors in a company's accounting system. For example, transactions classified improperly or those simply missing from the system could still be material [[accounting errors]](https://www.investopedia.com/terms/a/accounting-error.asp) that would not be detected by the trial balance procedure.

### Key Takeaways

-   A [[Trial Balance|trial balance]] is a worksheet with two columns, one for debits and one for credits, that ensures a company’s bookkeeping is mathematically correct. 
