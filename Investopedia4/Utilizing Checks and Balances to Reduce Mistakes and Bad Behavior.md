...
> ## Excerpt
> Checks and balances are various procedures set in place to reduce mistakes, prevent improper behavior, or decrease the [[Risk|risk]] of centralization of power.
...
Checks and balances are various procedures set in place to reduce mistakes, prevent improper behavior, or decrease the [[Risk|risk]] of centralization of power. Checks and balances usually ensure that no one person or department has absolute control over decisions, clearly define the assigned duties, and force cooperation in completing tasks. The term is most commonly used in the context of government.
...
Moreover, while the president has veto power, the legislative branch can overturn a president's veto with a two-thirds "[supermajority](https://www.investopedia.com/terms/s/supermajority.asp)" vote by both houses of Congress. This ensures that the president cannot use his power for personal [[Gain|gain]]. The executive branch can also declare executive orders, effectively proclaiming how certain laws should be enforced, but the judicial branch can deem these orders to be unconstitutional.
