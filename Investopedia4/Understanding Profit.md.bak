...
The three major types of profit are [[Gross Profit|gross profit]], [[Operating Profit|operating profit]], and net profit--all of which can be found on the income statement. Each profit type gives analysts more information about a company's performance, especially when it's compared to other competitors and time periods.

## Gross, Operating, and Net Profit

The first level of profitability is [[Gross Profit|gross profit]], which is sales minus the cost of goods sold. Sales are the first line item on the income statement, and the cost of goods sold (COGS) is generally [[Listed|listed]] just below it. For example, if Company A has $100,000 in sales and a COGS of $60,000, it means the gross profit is $40,000, or $100,000 minus $60,000. Divide gross profit by sales for the [[gross profit margin]](https://www.investopedia.com/terms/g/gross_profit_margin.asp), which is 40%, or $40,000 divided by $100,000.

Gross Profit\=Total Sales−COGs\\text{[[Gross Profit]]} = \\text{Total Sales} - \\text{COGs}

The second level of profitability is [[Operating Profit|operating profit]], which is calculated by deducting operating expenses from [[Gross Profit|gross profit]]. Gross profit looks at profitability after direct expenses, and operating profit looks at profitability after operating expenses. These are things like selling, general, and administrative costs (SG&A). If Company A has $20,000 in operating expenses, the operating profit is $40,000 minus $20,000, equaling $20,000. Divide operating profit by sales for the operating [[Profit Margin|profit margin]], which is 20%.
...
The third level of profitably is net profit, which is the income left over after all expenses, including taxes and interest, have been paid. If interest is $5,000 and taxes are another $5,000, net profit is calculated by deducting both of these from [[Operating Profit|operating profit]]. In the example of Company A, the answer is $20,000 minus $10,000, which equals $10,000. Divide net profit by sales for the [[net profit margin]](https://www.investopedia.com/terms/n/net_margin.asp), which is 10%.
