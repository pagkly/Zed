...
Technical skills may also refer to the expertise of a certain type of market participant who uses [[technical analysis]](https://www.investopedia.com/terms/t/technical-analyst.asp) signals to buy and sell [[Stocks|stocks]], bonds, [[futures]](https://www.investopedia.com/terms/f/[[Futures|futures]].asp), and other financial instruments.
...
-   In [[Finance|finance]], technical skills may refer to traders and analysts who follow the procedures of [[Technical Analysis|technical analysis]], using charts, indicators, and patterns to generate buy and sell signals.
...
The acquisition of advanced technical skills requires specific education or training, often with a hands-on learning component and many advanced topical elements. Technical skill requirements are [[Listed|listed]] for the majority of career fields, with the highest concentrations being employment in areas involving scientific, technological, engineering, computational, and mathematical capabilities.

Within the [[financial markets]](https://www.investopedia.com/terms/f/financial-market.asp), trader and investor participation in the [[Technical Analysis|technical analysis]] skillset requires the use of various mathematical and pattern recognition tools. These include the ability and expertise to determine what historical data is required and how it needs to be applied in order to elicit the required information.

Most [[Technical Analysis|technical analysis]] applications in relation to the market and other financial activities are designed to digest historical information measured in days, weeks, months, or years and use the output to predict future directional outcomes in specific [[financial instruments]](https://www.investopedia.com/terms/f/financialinstrument.asp).

## An Example of Technical Skills

In [[Finance|finance]], technical skills consist of an array of knowledge topics that include computing abilities, quantitative analysis, and various financial market forecasting techniques. [[Technical Analysis|Technical analysis]] requires a variety of mathematical skills, often advanced in nature, to produce price chart analysis and model [[trends]](https://www.investopedia.com/terms/t/trend.asp) that look at historical information to predict future price movements.
