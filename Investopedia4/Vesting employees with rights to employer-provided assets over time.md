...
-   When an employee is vested in employer-matching retirement funds or [[Stock|stock]] options, she has nonforfeitable rights to those assets.
...
[Vesting](https://www.investopedia.com/managing-wealth/get-most-out-employee-[[Stock|stock]]-options/) is common in wills and bequests and often takes the form of a set [[Waiting Period|waiting period]] to finalize bequests following the death of the testator. This waiting period before vesting helps reduce conflicts that could arise over the exact time of death and the possibility of double-[[Taxation|taxation]] if multiple heirs die after a disaster.

Startup companies often [[Offer|offer]] grants of [[Common Stock|common stock]] or access to an [[Define Employee Stock Option (ESO)|employee stock option]] plan to employees, service providers, vendors, board members, or other parties as part of their compensation. To encourage loyalty among employees and also keep them engaged and focused on the company's success, such grants or options usually are subject to a vesting period during which they cannot be sold. A common vesting period is three to five years.
