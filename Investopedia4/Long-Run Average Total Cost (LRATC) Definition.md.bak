...
The calculation of the LRATC may be represented as a curve showing the lowest costs that a company [[Will|will]] be able to reach for any degree of output over time. The shape of that curve can closely resemble the curve calculated for short-run average total costs. The LRATC can be seen as made up of a series of short-run curves as a company improves its efficiency. The curve itself can be divided into three segments or phases. During the [[Economies of Scale|economies of scale]] at the beginning of the curve, costs are reduced as the company grows more efficient and its production costs diminish.

The first iterations of product development and assembly carry costs that [[Will|will]] largely be greater at the onset. As more factories and production lines are introduced, the nature of costs shifts more towards the ongoing [[Manufacturing|manufacturing]] of the product. The burden of those expenditures diminishes as it becomes easier for the company to repeat and replicate its operations.

Eventually, the company [[Will|will]] experience constant returns to scale as it pushes closer to [[peak efficiency]](https://www.investopedia.com/terms/p/production_efficiency.asp). Cost of acquisition for raw materials can be reduced by making such purchases in increasingly growing quantities. Furthermore, the processes the company uses to make its product can become more stable and streamlined as it develops a rhythm and pace for its production flow.

If the company continues to scale up production, it [[Will|will]] reach the part of the curve where diseconomies of scale become a factor and costs rise. Though a company might streamline operations, it might see new layers of bureaucracy and management introduced, which can slow overall production and decision making. The more the operation grows at this stage, the costs will rise as the operation loses efficiency.
