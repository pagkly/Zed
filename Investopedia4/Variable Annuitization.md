...
[[Variable Annuitization]] is an annuity option in which the amount of income payments received by the policyholder [[Will|will]] vary according to the investment performance of the [[annuity]](https://www.investopedia.com/terms/a/annuity.asp). Variable annuitization is one option that can be selected by the policyholder during the [[annuitization phase]](https://www.investopedia.com/terms/a/annuitizationphase.asp) of a contract, which is the phase in which the policyholder exchanges the accumulated value of the annuity for a stream of regular income payments guaranteed for life or guaranteed for a specified number of years.

### Key Takeaways

-   A [[Variable Annuity|variable annuity]] is just like it sounds—variable. The payments are based on the performance of the annuity's assets.
-   There is more profit potential with a [[Variable Annuity|variable annuity]]. However, during market downturns, payments [[Will|will]] be lower than an annuity with a fixed rate.
...
During the [[annuitization phase]](https://www.investopedia.com/terms/a/annuitizationphase.asp), for annuities purchased with after-tax dollars, a fixed amount of each payment is treated as a non-taxable [[Return|return]] of the original basis, and the balance is taxed as income. Alternatively, all annuity income received through withdrawals is generally taxed as income until all the earnings have been withdrawn. After all earnings have been withdrawn, withdrawals are non-taxable returns of the original (already taxed) investment in the annuity. For annuities purchased with pre-tax dollars, all income—whether via annuitization or from withdrawals—is fully taxable as [[Ordinary Income|ordinary income]].

## [[Variable Annuity]] Considerations

Choosing how to receive payments from an annuity can be difficult for investors, and often comes down to the amount of [[Risk|risk]] the policyholder is willing to take compared with the amount of returns the policyholder wants. Choosing a [[fixed annuitization]](https://www.investopedia.com/terms/f/fixed-annuitization-method.asp) means that the policyholder [[Will|will]] receive the same amount of money in each periodic annuity income payment over the life of the annuity, regardless of how the [[Portfolio|portfolio]] of the annuity company performs. [[Variable Annuitization|Variable annuitization]] payments differ in that the value received by the policyholder is designed to vary over time. This is because the payments are based on the performance of an [[Underlying|underlying]] [[portfolio]](https://www.investopedia.com/terms/p/portfolio.asp).
...
-   How long [[Will|will]] my money be tied up?
...
-   [[Will]] you be paid a [[Commission|commission]] or receive any type of compensation for selling the [[Variable Annuity|variable annuity]]? How much?
-   What are the risks that my investment could decrease in value?
-   What are all the fees and expenses?

Purchasing an annuity can provide a level of income [[Security|security]], but can also lock in funds into a specific product that may not perform as well as expected. Professionals who sell annuities typically receive a [[commission]](https://www.investopedia.com/terms/c/[[Commission|commission]].asp) based on the type and value of the annuity sold. Variable annuities values are tied to the performance of mutual fund-like instruments called sub-accounts the annuity owner selects.
