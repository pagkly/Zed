...
Of course, in the real world, production rates [[Will|will]] not appear as a perfectly symmetrical curve. Nevertheless, the Hubbert curve is widely used as a close approximation of actual production rates. Once such notable application is the so-called [[Hubbert Peak Theory]](https://www.investopedia.com/terms/h/hubbert-peak-theory.asp), which has been used to predict [[peak oil]](https://www.investopedia.com/terms/p/peak_oil.asp) production around the world.

According to some industry analysts, the Hubbert peak for oil production in the United States was reached in the 1970s, although there is little consensus on when the peak for global oil production [[Will|will]] be reached. One reason for this disagreement is that [[new technologies]](https://www.investopedia.com/terms/e/enhanced-oil-recovery.asp) for extracting oil may have pushed the date for any forced decline in production further into the future.
