...
An [[Enrolled Agent (EA)|enrolled agent (EA)]] is a tax professional authorized by the United States government to represent taxpayers in matters regarding the [[Internal Revenue Service (IRS)]](https://www.investopedia.com/terms/i/irs.asp). EAs must pass an examination or have sufficient experience as an IRS employee and pass a background check.1 2 Enrolled agents first appeared in 1884 due to issues arising with Civil War loss claims.3
