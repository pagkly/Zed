...
> ## Excerpt
> Lead time is the amount of time from the start of a process until its conclusion. Reducing lead time in [[Manufacturing|manufacturing]] can increase output and revenue.
...
Lead time is the amount of time that passes from the start of a process until its conclusion. Companies review lead time in [[manufacturing,]](https://www.investopedia.com/terms/m/[[Manufacturing|manufacturing]].asp) [[supply chain management,]](https://www.investopedia.com/terms/s/scm.asp) and [[project management]](https://www.investopedia.com/terms/p/project-management.asp) during pre-processing, processing, and post-processing stages. By comparing results against established benchmarks, they can determine where inefficiencies exist.

Reducing lead time can [[streamline operations]](https://www.investopedia.com/terms/o/operations-management.asp) and improve [[Productivity|productivity]], increasing output, and [[revenue]](https://www.investopedia.com/terms/r/revenue.asp). By contrast, longer lead times negatively affect sales and [[Manufacturing|manufacturing]] processes.

### Key Takeaways

-   Lead time measures how long it takes to complete a process from beginning to end.
-   In [[Manufacturing|manufacturing]], lead time often represents the time it takes to create a product and deliver it to a consumer.
...
-   In some cases, companies can improve lead times by implementing automated [[Stock|stock]] replenishment and just-in-time (JIT) strategies.
...
Efficient inventory management is necessary to maintain production schedules and meet consumer demand. Stockouts occur when inventory, or [[Stock|stock]], is unavailable preventing the fulfillment of a customer's order or product assembly. Production stops if an organization underestimates the amount of stock needed or fails to place a replenishment order and suppliers cannot replenish materials immediately. This can be costly for a company's bottom line.

One solution is to use a vendor-managed inventory (VMI) program, which provides automated [[Stock|stock]] replenishment. These programs often come from an off-site supplier, using [[just-in-time (JIT)]](https://www.investopedia.com/terms/j/jit.asp) inventory management for ordering and delivering components based on usage.
...
Of course, that lead time can be shortened in some extreme situations if the buyer is willing to pay a [[premium]](https://www.investopedia.com/terms/p/[[Premium|premium]].asp). If T-shirt sales on the first day of the festival exceed expectations, festival organizers may decide to order additional shirts on the second day with the hope that they can be delivered by the third day. Since the shirts have already been designed and approved, that means five days of lead time can be reduced to three. To meet that shortened lead time, the vendor would need to print the additional shirts as quickly as possible in order to ship them overnight for delivery the following morning.

Additional factors can affect lead time in this example. If festival organizers want a certain percentage of the T-shirts to be fuchsia and the vendor does not regularly keep fuchsia T-shirts in [[Stock|stock]], that can increase the lead time because the vendor [[Will|will]] need to order shirts in that color.
