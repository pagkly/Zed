---
alias: [Expanded Accounting Equation]
...
> ## Excerpt
> The expanded accounting equation is derived from the accounting equation and illustrates the different components of stockholder [[Equity|equity]] in a company.
...
By decomposing [[Equity|equity]] into component parts, analysts can get a better idea of how profits are being used—as dividends, reinvested into the company, or retained as cash.

### Key Takeaways

-   The expanded accounting equation is the same as the common accounting equation but decomposes [[Equity|equity]] into component parts.
-   The components of [[Equity|equity]] include contributed capital, [[Retained Earnings|retained earnings]], and revenue minus dividends.
-   Total assets and total liabilities are also accounted for.

## The Formula for the Expanded Accounting Equation Is

The expanded version of the accounting equation details the [[Equity|equity]] role in the basic accounting equation:
...
Sometimes, analysts want to better understand the composition of a company's shareholders' [[Equity|equity]]. Besides assets and liabilities, which are part of the general accounting equation, stockholders' equity is expanded into the following elements:
...
-   _**Beginning [[Retained Earnings|retained earnings]]**_ are the earnings not distributed to the stockholders from the previous period.
...
The accounting equation whereby Assets = Liabilities + Shareholders' [[Equity|equity]] is calculated as follows:

-   **Accounting equation** = $157,797 (total liabilities) + $196,831 ([[Equity|equity]]) equal $354,628, which equals the total assets for the period.

We could also use the expanded accounting equation to see the effect of reinvested earnings ($419,155), other [[Comprehensive Income|comprehensive income]] ($18,370) and treasury [[Stock|stock]] ($225,674). We could also look to XOM's income statement to identify the amount of revenues and dividends the company earned and paid out.
