...
> ## Excerpt
> Ex-ante refers to future events, such as potential returns of a [[Security|security]] or [[Fundamentals|fundamentals]] of a company.
...
Ex-ante refers to future events, such as the potential returns of a particular [[Security|security]], or the returns of a company. Transcribed from Latin, it means “before the event.”

Much of the analysis conducted in the markets is ex-ante, focusing on the impacts of long-term cash flows, earnings and revenue. While this type of ex-ante analysis focuses on company [[Fundamentals|fundamentals]], it often relates back to asset prices. For example, buy-side analysts often use fundamental factors to determine a price target for a [[Stock|stock]], then compare the predicted result to actual performance.
