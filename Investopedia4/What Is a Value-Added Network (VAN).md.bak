...
A value-added network (VAN) is a private, hosted service that provides companies with a secure way to send and share data with its [[counterparties]](https://www.investopedia.com/terms/c/[[Counterparty|counterparty]].asp). Value-added networks were a common way to facilitate electronic data interchange (EDI) between companies. As the Internet created competition for this service with the advent of secure email, VANs responded by expanding their service offerings to include things like message encryption, secure email, and management reporting.
...
-   VANs are important for managing [[Supply|supply]] chains.
