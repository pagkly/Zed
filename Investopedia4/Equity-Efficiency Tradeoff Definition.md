...
> ## Excerpt
> An [[Equity|equity]]-efficiency tradeoff exists whenever activity in a given market simultaneously boosts productive efficiency and lowers distributive equity.
...
An [[Equity|equity]]-efficiency tradeoff is when there is some kind of conflict between maximizing [[economic efficiency]](https://www.investopedia.com/terms/e/economic_efficiency.asp) and maximizing the equity (or fairness) of society in some way. When and if such a trade-off exists, economists or public policymakers may decide to sacrifice some amount of economic efficiency for the sake of achieving a more just or equitable society.

### Key Takeaways

-   The [[Equity|equity]]-efficiency tradeoff is when there is some conflict between maximizing pure economic efficiency and achieving other social goals.
-   Most economic theory uses a utilitarian approach as its ethical framework, but this may conflict with other moral values that people [[Hold|hold]], leading to an [[Equity|equity]]-efficiency tradeoff.
-   Inequality and the redistribution of income is a common example of an [[Equity|equity]]-efficiency tradeoff.

## Understanding the [[Equity]]-Efficiency Tradeoff

An [[Equity|equity]]-efficiency tradeoff results when maximizing the efficiency of an economy leads to a reduction in its equity—as in how equitably its wealth or [[income]](https://www.investopedia.com/terms/i/income.asp) is distributed.
...
This is the most common form of the [[Equity|equity]]-efficiency tradeoff, though it can also involve the production, distribution, and consumption of all kinds of goods and services rather than just incomes.
