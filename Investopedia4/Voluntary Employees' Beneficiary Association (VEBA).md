...
A [[Voluntary Employees' Beneficiary Association (VEBA)]] can be established by employees or by an employer and must consist of employees of the same company or the same [[Labor Union|labor union]]. VEBA benefits normally end when the employee leaves the company or labor union with which the VEBA is associated.
