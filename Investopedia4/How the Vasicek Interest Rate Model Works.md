---
alias: [Vasicek Interest Rate Model]
...
> ## Excerpt
> The Vasicek interest rate model predicts interest rate movement based on market [[Risk|risk]], time and long-term equilibrium interest rate values.
...
The Vasicek interest rate model (or simply the Vasicek model) is a mathematical method of modeling [[interest rate]](https://www.investopedia.com/terms/i/interestrate.asp) movements. The model describes the movement of an interest rate as a factor composed of market [[Risk|risk]], time, and equilibrium value, where the rate tends to revert towards the mean of those factors over time. Essentially, it predicts where interest rates [[Will|will]] end up at the end of a given period of time, given current market [[Volatility|volatility]], the long-run mean interest rate value, and a given market risk factor.

It is important to note that the equation can only test one market [[Risk|risk]] factor at a time. This [[stochastic model]](https://www.investopedia.com/terms/s/stochastic-modeling.asp) is often used in the [[valuation]](https://www.investopedia.com/terms/v/valuation.asp) of interest rate [[Futures|futures]] and is sometimes used in solving for the price of various hard to value bonds.
