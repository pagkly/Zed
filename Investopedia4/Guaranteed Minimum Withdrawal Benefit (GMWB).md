...
> ## Excerpt
> A [[Guaranteed Minimum Withdrawal Benefit (GMWB)|guaranteed minimum withdrawal benefit (GMWB)]] rider guarantees an annuity holder a minimum stream of income despite market [[Volatility|volatility]].
...
A guaranteed minimum withdrawal benefit (GMWB) is a type of rider or contract attached to some annuity insurance policies. It guarantees the policyholder a steady stream of annual withdrawals via the [[Return|return]] of all premiums paid into the contract, regardless of an investment's performance, through a series of annual withdrawals. A GMWB is unlike a [[guaranteed minimum income benefit]](https://www.investopedia.com/terms/g/gmib.asp) (GMIB), where the latter offers a [[Payout|payout]] of specified minimum periodic income after a [[Waiting Period|waiting period]], regardless of the [[Variable Annuity|variable annuity]]'s investment performance.
...
A GMWB protects annuitants against investment losses without losing the benefit of [[Upside|upside]] [[Gain|gain]]. For example, suppose that Jamie's initial investment was $100,000. But because of downturns in the economy, that investment is now only worth $85,000. Since Jamie had purchased a guaranteed minimum withdrawal benefit with a rate of 10%, she [[Will|will]] be able to activate the rider contract to withdraw a certain percentage each year ($8,500 in this case) until she recovers the entire $100,000 initial investment.
...
The terms of GMWB riders including fees vary depending on the provider, which is typically an insurance company. Other available annuity riders include guaranteed lifetime [[Withdrawal Benefits|withdrawal benefits]] and guaranteed minimum accumulation benefits.
