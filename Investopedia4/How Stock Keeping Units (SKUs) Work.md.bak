...
> ## Excerpt
> A [[Stock|stock]]-keeping unit (SKU) is a store or catalog's product and service identification code; it is often in the form of a machine-readable bar code.
