...
> ## Excerpt
> A third-party transaction is a business deal with a buyer, a seller, and a [[Third Party|third party]]. The third party's involvement varies with the type of transaction.
...
A third-party [[transaction]](https://www.investopedia.com/terms/t/transaction.asp) is a business deal that involves a person or entity other than the main participants. Typically, it would involve a buyer, a seller and another party, the [[third party]](https://www.investopedia.com/articles/financialcareers/08/third-party-marketing.asp). The involvement of the [[Third Party|third party]] can vary, based on the type of business transaction.
...
For example, in the insurance industry, insurance brokers are third-party agents that market insurance products to insurance shoppers. The client goes through the broker to secure a good insurance contract that has reasonable rates and terms, while the insurance company works through the broker to bring in a new client. If the broker is successful in bringing a new client to an insurance provider, it is paid a [[Commission|commission]] by the insurer.

In the same light, a [[mortgage broker]](https://www.investopedia.com/terms/m/mortgagebroker.asp) is also considered a facilitator in third-party transactions, as they [[Will|will]] attempt to match the needs of a potential home buyer with the [[Loan|loan]] programs offered by a [[Lender|lender]].
...
[PayPal](https://www.investopedia.com/articles/investing/072815/[[PayPal|paypal]]-vs-venmo-function-versus-fun.asp) is one good example of an online payment portal that acts as a [[Third Party|third party]] in a retail transaction. A seller offers a good or service, and a buyer uses a credit card entered through the PayPal payment service. The payment is run through PayPal and is thus a third-party transaction.
