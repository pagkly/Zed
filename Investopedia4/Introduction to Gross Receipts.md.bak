...
> ## Excerpt
> Gross receipts are the sales of a business that form the basis for corporate [[Taxation|taxation]] in certain individual states.

---

[[Introduction to Gross Receipts]]
Gross receipts are sales of a business that form the basis for corporate [[Taxation|taxation]] in a handful of individual states and certain local tax authorities. The components of gross receipts vary by state and municipality.
...
2.  Each service performed in this state, except that receipts derived from servicing loans secured by [[Real Property|real property]] are in this state if the real property is located in this state
