...
> ## Excerpt
> A VIX option is a [[Derivative|derivative]] [[Security|security]] based on the CBOE [[Volatility]] Index as its [[Underlying|underlying]] asset.
...
A VIX option is a non-[[Equity|equity]] index option that uses the [[CBOE Volatility Index]](https://www.investopedia.com/terms/v/vix.asp) as its [[underlying asset]](https://www.investopedia.com/terms/u/[[Underlying|underlying]]-asset.asp). Call and put VIX options are both available. The call options [[Hedge|hedge]] portfolios against a sudden market decline, and put options hedge against a rapid [[Reversal|reversal]] of short positions on the [[S&P 500 Index|S&P 500 index]]. These options thus allow traders and investors to speculate on future moves in [[volatility]](https://www.investopedia.com/terms/v/[[Volatility|volatility]].asp).

### Key Takeaways

-   VIX Options trade with the S&P 500 [[Volatility]] index as their [[Underlying|underlying]].
-   VIX call options make a natural [[Hedge|hedge]] against downward price shocks.
-   VIX put options can be problematic because the [[S&P 500 Index|S&P 500 index]] does not often rise rapidly.
-   VIX options trade as European style options.

## Understanding VIX Options

The VIX option, which originated in 2006, was the first [[exchange-traded option]](https://www.investopedia.com/terms/e/exchangetradedoption.asp) which gave individual investors the ability to trade on market [[Volatility|volatility]]. The trading of VIX options can be a useful tool for investors. By purchasing a VIX [[call option]](https://www.investopedia.com/terms/c/calloption.asp) a trader can profit from a rapid increase in volatility. Sharp increases in volatility coincide with a short-term price shock in [[Stocks|stocks]]. Volatility increase often, but not always, coincide with a downward trending market. As such, this kind of call option is a [[natural hedge]](https://www.investopedia.com/terms/n/natural-[[Hedge|hedge]].asp) and can be used very strategically over longer periods, and tactically in the short term. It many cases it can be a more efficient hedge than [[Equity|equity]] index options.

The VIX is susceptible to a pattern of slow decline and rapid increase. As such VIX call options, when well timed can be a very effective [[Hedge|hedge]]; however, VIX put options are more difficult to use effectively. The put options can be profitable for traders who correctly anticipate that a market is about to turn around from a downward trend to and upward trend.
