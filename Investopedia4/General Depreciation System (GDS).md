...
> ## Excerpt
> The [[General Depreciation System (GDS)|general depreciation system (GDS)]] is the most commonly used [[Modified Accelerated Cost Recovery System (MACRS)|modified accelerated cost recovery system (MACRS)]] for calculating depreciation.
...
Under MACRS, a [[Taxpayer|taxpayer]] must compute tax deductions for depreciation of tangible property using specified asset lives and methods. Assets are divided into classes by type of asset or by the business in which the asset is used. There are two sub-systems of MACRS: the [[General Depreciation System (GDS)|general depreciation system (GDS)]] and [[alternate depreciation system]](https://www.investopedia.com/terms/a/alternative-depreciation-system.asp) (ADS). GDS is the most relevant and is used for most assets.
