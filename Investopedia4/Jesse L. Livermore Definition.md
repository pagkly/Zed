...
> ## Excerpt
> Jesse L. Livermore was a [[Stock|stock]] trader who made multiple fortunes in his life, which became the basis of a book, "Reminiscences of a Stock Operator."
...
Jesse L. Livermore was a [[Stock|stock]] trader, who rose from a humble farming background to become a stock trader in Boston. Over the course of his career, he won and lost fortunes in many arenas. A self-made man with no formal education or trading background, Livermore focused on making money from the overall market directions and not concentrating on individual [[Stocks|stocks]]. His strategies were based on a combination of price patterns and [[Volume Analysis|volume analysis]]. Livermore is most well-known for shorting the stock market right at the beginning of the [[Great Depression]](https://www.investopedia.com/terms/g/great_depression.asp) in 1929.

## Understanding Jesse L. Livermore

Jesse L. Livermore was born in abject [[Poverty|poverty]] in Massachusetts. He lived from 1877 to 1940. His first job was with Paine Webber - a Boston banking and [[Stock|stock]] broking company - at the age of 14 for a salary of $5 per week. Tom Rubython, who wrote a biography of Livermore in 2014, said that Livermore looked bigger than his age at the time. This encouraged people to trust him and he always repaid that trust, according to Rubython.
...
-   Jesse Livermore was a [[Stock|stock]] trader, who rose from humble beginnings, to become one of the world's most successful stock traders.
-   Two of Livermore's most famous trades are shorting Union Pacific right before the San Francisco earthquake and the [[Stock|stock]] market before the Great Depression.
-   Livermore espoused [[Technical Analysis|technical analysis]] at a time when the tools of [[Fundamental Analysis|fundamental analysis]] - financial statements and research notes - were absent.

Among Livermore's notable trades were his shorting of the Union Pacific Railway [[Stock|stock]] just before the San Francisco earthquake and shorting the stock market just before the 1929 crash. Livermore claimed to have a "psychic" revelation about shorting Union Pacific.

While he made several millions of dollars in a single day in the [[Stock|stock]] market during a time when it was unregulated, Livermore is also in the history books for rescuing it in 1907 when the markets began plunging. Upon advice from J.P.Morgan, he began buying [[Stocks|stocks]] when the market was crashing. Other traders, who had been selling, followed suit. Livermore also became bankrupt several times during his career. But he always regained his fortunes in the following years.
...
Livermore espoused the strategy of buying and holding during bull markets and selling when market [[Momentum|momentum]] began to shift. His strategy of making money was remarkable at a time when companies did not publish financial markets and research for [[Fundamental Analysis|fundamental analysis]] was unavailable.
