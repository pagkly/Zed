...
> ## Excerpt
> A maximum drawdown (MDD) is the maximum loss from a peak to a trough of a [[Portfolio|portfolio]], before a new peak is attained.
...
A maximum drawdown (MDD) is the maximum observed loss from a peak to a trough of a [[Portfolio|portfolio]], before a new peak is attained. Maximum drawdown is an indicator of downside [[Risk|risk]] over a specified time period.
...
MDD\=Trough Value−Peak ValuePeak Value\\begin{aligned} MDD=\\frac{\\textit{Trough Value}-\\textit{Peak Value}}{\\textit{Peak Value}}\\end{aligned}
...
Maximum drawdown (MDD) is an indicator used to assess the relative riskiness of one [[stock screening]](https://www.investopedia.com/terms/s/stockscreener.asp) strategy versus another, as it focuses on [[capital preservation]](https://www.investopedia.com/terms/p/preservationofcapital.asp), which is a key concern for most investors. For example, two screening strategies can have the same average outperformance, tracking error, and [[Volatility|volatility]], but their maximum drawdowns compared to the benchmark can be very different.
...
-   Maximum drawdown is considered to be an indicator of downside [[Risk|risk]], with large MDDs suggesting that down movements could be volatile.
...
Consider an example to understand the concept of maximum drawdown. Assume an investment [[Portfolio|portfolio]] has an initial value of $500,000. The portfolio increases to $750,000 over a period of time, before plunging to $400,000 in a ferocious bear market. It then rebounds to $600,000, before dropping again to $350,000. Subsequently, it more than doubles to $800,000. What is the maximum drawdown?

The maximum drawdown in this case is\=$350,000−750,000$750,000\=−53.33%\\begin{aligned}&\\text{The maximum drawdown in this case is}\\\\&\\qquad\\quad=\\frac{\\$350,000-750,000}{\\$750,000=-53.33\\%}\\end{aligned}

Note the following points:

-   The initial peak of $750,000 is used in the MDD calculation. The interim peak of $600,000 is not used, since it does not represent a new high.
-   The new peak of $800,000 is also not used since the original drawdown began from the $750,000 peak.
-   The MDD calculation takes into consideration the lowest [[Portfolio|portfolio]] value ($350,000 in this case) before a new peak is made, and not just the first drop to $400,000.
