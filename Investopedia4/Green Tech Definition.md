...
> ## Excerpt
> Green tech is a type of technology that is considered environmentally-friendly based on its production process or [[Supply|supply]] chain.
...
Green technology is used in the recycling process, as well as in waste incineration. Recyclable material can be used when [[Manufacturing|manufacturing]] plastics, fertilizer, and fuel. Green technology can also be a part of the production process, such as processes to recycle water or waste in the manufacturing process.
...
Green tech is used in processes that purify the air by reducing carbon emissions and gases that are released into the air from [[Manufacturing|manufacturing]] plants.
...
In 2004, Starbucks Corporation ([SBUX](https://www.investopedia.com/markets/[[Quote|quote]]?tvwidgetsymbol=sbux)) performed a study to measure the company's greenhouse gas emissions. The study revealed that 70% of the company's emissions came from the purchase of electricity used to power their stores. As a result, the company has been working to source all of its power from renewable energy sources for all of its global store operations, including the company's global [[Supply|supply]] chain and corporate offices.
