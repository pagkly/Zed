...
PIMCO, or Pacific Investment Management Company, is an American [[investment management]](https://www.investopedia.com/terms/i/investment-management.asp) firm founded in 1971 in California. The firm focuses on fixed income and manages more than $1.92 trillion in [[assets]](https://www.investopedia.com/terms/a/asset.asp). The firm primarily handles [[Portfolio|portfolio]] management, account management, and business management.1
...
-   The most famous product in PIMCO's [[Portfolio|portfolio]] is its Total [[Return]] Fund, a bond-based mutual fund.
...
As of 2014, Gross had left the firm for Janus Capital Group, Inc. Gross' [[Heir|heir]]-apparent, Mohamed El-Erian, also departed. In April 2015, former Federal Reserve Chairman [[Ben Bernanke]](https://www.investopedia.com/terms/b/benbernanke.asp) was hired as a senior advisor to PIMCO.3

### PIMCO's Strategies

PIMCO's investment process integrates insights from its Cyclical Forums, which anticipate market and economic trends over a 6- to 12-month period, and the annual Secular Forum, which projects trends over a 3- to 5-year period. The company says it believes that an informed [[macroeconomic]](https://www.investopedia.com/terms/m/[[Macroeconomics|macroeconomics]].asp) outlook—over long- and short-term horizons—is key to identifying opportunities and potential risks.4

### PIMCO's Total [[Return]] Fund

The company's Total [[Return]] Fund seeks to maximize capital while preserving [[capital]](https://www.investopedia.com/terms/c/capital.asp). The fund, established in 1987, emphasizes higher-quality, intermediate-term bonds and is more globally diversified, therefore aiming to reduce concentration [[Risk|risk]]. The fund also has a flexibility that helps respond to changing [[Economic Conditions|economic conditions]].5
...
The company partners with different institutions, from corporations, [[central banks]](https://www.investopedia.com/terms/c/centralbank.asp), private and public pension funds, [[endowments]](https://www.investopedia.com/terms/e/[[Endowment|endowment]].asp), and foundations, as well as retirement plans.
