...
> ## Excerpt
> An externality is an economic term referring to a cost or benefit incurred or received by a [[Third Party|third party]] who has no control over how that cost or benefit was created.
...
Some externalities are positive. Positive externalities occur when there is a positive [[Gain|gain]] on both the private level and social level. [[Research and development]](https://www.investopedia.com/terms/r/randd.asp) (R&D) conducted by a company can be a positive externality. R&D increases the private profits of a company but also has the added benefit of increasing the general level of knowledge within a society.
...
Taxes are one solution to overcoming externalities. To help reduce the negative effects of certain externalities such as pollution, governments can impose a tax on the goods causing the externalities. The tax, called a [[Pigovian tax]](https://www.investopedia.com/terms/p/pigoviantax.asp)—named after economist Arthur C. Pigou, sometimes called a Pigouvian tax—is considered to be equal to the value of the negative externality. This tax is meant to discourage activities that impose a net cost to an unrelated [[Third Party|third party]]. That means that the imposition of this type of tax [[Will|will]] reduce the market outcome of the externality to an amount that is considered efficient.
