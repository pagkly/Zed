...
Economists use [[price elasticity]](https://www.investopedia.com/terms/e/elasticity.asp) to understand how [[Supply|supply]] and demand for a product changes when its price changes.
...
For example, gasoline has little price elasticity of demand. Drivers [[Will|will]] continue to buy as much as they have to, as will airlines, the trucking industry, and nearly every other buyer.

Other goods are much more [[elastic]](https://www.investopedia.com/terms/e/elastic.asp), so price changes for these goods cause substantial changes in their demand or their [[Supply|supply]].
...
The more easily a shopper can substitute one product for another, the more the price [[Will|will]] fall.

For example, in a world in which people like coffee and tea equally, if the price of coffee goes up, people [[Will|will]] have no problem switching to tea, and the demand for coffee will fall. This is because coffee and tea are considered good [[substitutes]](https://www.investopedia.com/terms/s/substitution-effect.asp) to each other.

### Urgency Is a Factor

The more [[discretionary]](https://www.investopedia.com/terms/d/discretionary-expense.asp) a purchase is, the more its quantity of demand [[Will|will]] fall in response to price rises. That is, the product demand has greater elasticity.
...
But the less discretionary a product is, the less its [[Quantity Demanded|quantity demanded]] [[Will|will]] fall. Inelastic examples include luxury items that people buy for their brand names. Addictive products are quite inelastic, as are required add-on products like ink-jet printer cartridges.

One thing all of these products have in common is that they lack good substitutes. If you really want an Apple iPad, another tablet brand won't do. Addicts are not dissuaded by higher prices. And only HP ink [[Will|will]] work in HP printers.
...
As a [[Rule Of Thumb|rule of thumb]], if the quantity of a product demanded or purchased changes more than the price changes, the product is termed elastic. (For example, the price changes by +5%, but the demand falls by -10%).
