...
> ## Excerpt
> Horizontal analysis is used in [[Financial Statement Analysis|financial statement analysis]] to compare historical data, such as ratios or line items, over a number of accounting periods.
...
Horizontal analysis allows investors and analysts to see what has been driving a company's financial performance over a number of years, as well as to spot trends and growth patterns such as [[seasonality]](https://www.investopedia.com/terms/s/[[Seasonality|seasonality]].asp). It enables analysts to assess relative changes in different line items over time, and project them into the future. By looking at the [[income statement]](https://www.investopedia.com/terms/i/incomestatement.asp), [[balance sheet]](https://www.investopedia.com/terms/b/balancesheet.asp), and [[cash flow statement]](https://www.investopedia.com/terms/c/cashflowstatement.asp) over time, one can create a complete picture of operational results, and see what has been driving a company’s performance and whether it is operating efficiently and profitably.

The analysis of critical measures of business performance, such as [[profit margins]](https://www.investopedia.com/terms/n/net_margin.asp), [[inventory turnover]](https://www.investopedia.com/terms/i/inventoryturnover.asp), and [[return on equity]](https://www.investopedia.com/terms/r/returnonequity.asp), can detect emerging problems and strengths. For example, [[earnings per share (EPS)]](https://www.investopedia.com/terms/e/eps.asp) may have been rising because the [[cost of goods sold (COGS)]](https://www.investopedia.com/terms/c/cogs.asp) have been falling, or because sales have been growing strongly. And coverage ratios, like the [[Cash Flow|cash flow]]-to-[[Debt Ratio|debt ratio]] and the interest [[Coverage Ratio|coverage ratio]] can reveal whether a company can service its [[Debt|debt]] through sufficient [[liquidity]](https://www.investopedia.com/terms/l/[[Liquidity|liquidity]].asp). Horizontal analysis also makes it easier to compare [[Growth Rates|growth rates]] and profitability among multiple companies.
