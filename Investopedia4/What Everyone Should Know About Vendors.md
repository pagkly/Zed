...
> ## Excerpt
> A vendor is a party in the [[Supply|supply]] chain that makes goods and services available to companies or consumers.
...
-   Large retailers, like Target, rely on many different vendors to [[Supply|supply]] products, which it buys at wholesale prices and sells at higher retail prices.
...
Vendors are found throughout the [[supply chain]](https://www.investopedia.com/terms/s/supplychain.asp), which is the sum of all individuals, organizations, resources, activities, and technologies used in the [[Manufacturing|manufacturing]] and selling of a product or service. The [[Supply|supply]] chain starts with the production and delivery of raw source material. It ends with the sale and final delivery of the product.

Manufacturers and retailers try to eliminate as much of the [[Supply|supply]] chain as possible, as they know that the final cost of a product increases with each link in the supply chain. Typically, the supply chain consists of three parts: a manufacturer, a seller, and a [[reseller]](https://www.investopedia.com/terms/v/value-added-reseller.asp) or, as they are more commonly known, a retailer.
