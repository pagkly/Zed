...
> ## Excerpt
> [[Yield]] equivalence is the interest rate on a taxable [[Security|security]] that would produce a [[Return|return]] equal to that of a tax-exempt security, and vice versa.
...
[[Yield]] equivalence is the [[interest rate]](https://www.investopedia.com/terms/i/interestrate.asp) on a taxable [[Security|security]] that would generate a [[Return|return]] equivalent to the return of a [[tax-exempt security]](https://www.investopedia.com/terms/t/tax_exempt_security.asp), and vice versa.

### Key Takeaways

-   [[Yield]] equivalence is the interest rate on a taxable [[Security|security]] that would generate a [[Return|return]] equivalent to the return of a tax-exempt security, and vice versa.
-   [[Yield]] equivalence is important to municipal bond investors, who want to know if the tax savings of their bonds [[Will|will]] make up for the lower yields relative to similar duration taxable securities.
-   When calculating the [[Yield|yield]] equivalence between tax-free and taxable investments, investors should be aware of the current tax rates.

## Understanding [[Yield]] Equivalence

[[Yield]] equivalence is important to [[municipal bond]](https://www.investopedia.com/terms/m/municipalbond.asp) investors, who want to know if the tax savings of their bonds [[Will|will]] make up for the lower [[yields]](https://www.investopedia.com/terms/[[Y|y]]/yield.asp) relative to similar duration taxable securities. Yield equivalence is a comparison often used by investors when they are attempting to figure out if they’d get a better [[Return|return]] from a tax-exempt or tax-free investment than they would from a taxable alternative.
...
To calculate the [[Yield|yield]] equivalence between tax-exempt and taxable securities, start by dividing the bond’s tax-exempt yield by 1 minus the investor's [[tax rate]](https://www.investopedia.com/terms/t/taxrate.asp). For example, suppose you were considering an investment in a 6% tax-exempt municipal bond, but wanted to know what the interest rate on a taxable [[corporate bond]](https://www.investopedia.com/terms/c/corporatebond.asp) would have to be to give you the same [[Return|return]]. If you have a 24% rate of [[Taxation|taxation]], you would subtract 0.24 minus one, which totals .76. Then, you would divide 6, the tax-exempt yield, by .76, which equals 7.9.

This calculation tells you that you would need a [[return]](https://www.investopedia.com/terms/r/[[Return|return]].asp) of 7.9% on your taxable investment to match the 6% return on the tax-exempt investment. If, on the other hand, you were in the 35% tax bracket, you would need a return of 9.2% on your corporate bond to match the 6% return on your muni investment.

Conversely, if you know your taxable rate of [[Return|return]], you can calculate the equivalent rate on a tax-exempt investment. This is done by multiplying the taxable rate by 1 minus your tax rate. So, if your taxable return is 6% and your rate of [[Taxation|taxation]] is 24%, you need a 4.6% return on a tax-exempt [[Security|security]] to match the after-[[Tax Return|tax return]] on a taxable security.
...
When calculating the [[Yield|yield]] equivalence between tax-free and taxable investments, investors should be aware of these new tax rates and incorporate them accordingly into their yield equivalence equations.
