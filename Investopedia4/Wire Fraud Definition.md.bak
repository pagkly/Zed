...
Wire fraud is a type of [[fraud]](https://www.investopedia.com/terms/f/fraud.asp) that involves the use of some form of telecommunications or the internet. These can include a phone call, a fax, an email, a text, or [[Social Media|social media]] messaging, among many other forms. Wire fraud is punishable by prison and/or fines.

### Key Takeaways

-   Wire fraud is a type of fraud that involves the use of some form of telecommunications or the internet.
-   This type of crime can make use of any and all forms of electronic media including telephone or fax machine, email or [[Social Media|social media]], or SMS and text messaging.
...
Wire fraud is a federal crime that carries a sentence of not more than 20 years’ imprisonment and fines of up to $250,000 for individuals and $500,000 for organizations. The [[statute of limitations]](https://www.investopedia.com/terms/s/statute-of-limitations.asp) to bring a charge is five years unless the wire fraud targeted a financial institution, in which case the [[Statute of Limitations|statute of limitations]] is 10 years. If the wire fraud is related to special circumstances, such as a presidentially declared state of emergency or targets a financial institution, it can carry a prison sentence of up to 30 years and a fine of up to $1 million. A person need not have actually defrauded someone or personally sent a fraudulent communication to be convicted of [[wire fraud]](https://www.investopedia.com/articles/pf/08/stop-scams.asp). It is sufficient to prove the intent to defraud or acting with knowledge of fraudulent communications being sent.2 3
...
A common example of wire fraud is the [[Nigerian prince scam]](https://www.investopedia.com/articles/personal-[[Finance|finance]]/041515/10-tips-avoid-common-financial-scams.asp). In this scam, the scammer sends an email claiming to be a Nigerian prince who is down on his luck in some way, usually exiled, and can’t access the fortune in his Nigerian bank account. He claims to need the target to [[Hold|hold]] his millions for him and promises to give the target a handsome sum in [[Return|return]]. The goal of the scam is to obtain the target’s financial information, which the scammer [[Will|will]] use to access the target’s money.
