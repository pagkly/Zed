...
> ## Excerpt
> Scalability is the ability of a company, project, or other undertaking to be able to adapt to larger demand by allowing greater [[Supply|supply]].
...
Scalability is a characteristic of an organization, system, model, or function that describes its capability to cope and perform well under an increased or expanding workload or [[scope]](https://www.investopedia.com/terms/s/[[Scope|scope]].asp). A system that scales well [[Will|will]] be able to maintain or even increase its level of performance or efficiency even as it is tested by larger and larger operational demands.
...
-   A scalable firm is able to benefit from [[Economies of Scale|economies of scale]], and can quickly ramp up production.
...
At its core, a scalable business is one that focuses on the implementation of processes that lead to an efficient operation. The [[Workflow|workflow]] and structure of the business allow for scalability.
