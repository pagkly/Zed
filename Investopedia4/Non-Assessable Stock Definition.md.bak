...
For example, a share of [[Stock|stock]] with a face value of $20 might be sold for $5. At some point, the issuer would serve the investors with an assessment for more funds—up to the entire discounted amount (In this example, $15). If an investor refused to pay, the stock returned to the issuing company.
