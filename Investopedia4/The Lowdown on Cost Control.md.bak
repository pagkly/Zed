...
Corporate [[payroll]](https://www.investopedia.com/terms/p/[[Payroll|payroll]].asp), for example, is often outsourced, because [[Payroll Tax|payroll tax]] laws change constantly, and employee turnover requires frequent changes to payroll records. A payroll company can calculate the net pay and tax withholdings for each worker, which saves the employer time and expense.

### Key Takeaways

-   Cost control is the practice of identifying and reducing business expenses to increase profits, and it starts with the budgeting process.
-   Cost control is an important factor in maintaining and growing profitability.
-   Outsourcing is a common method to control costs because many businesses find it cheaper to pay a [[Third Party|third party]] to perform a task than to take on the work within the company.
...
Assume, for example, that a retail clothing shop wants to earn $10,000 in net income from $100,000 in sales for the month. To reach the goal, management reviews both fixed and variable costs and attempts to reduce the expenses. Inventory is a [[Variable Cost|variable cost]] that can be reduced by finding other suppliers that may [[Offer|offer]] more competitive prices.

It may take longer to reduce fixed costs, such as a [[Lease|lease]] payment, because these costs are usually fixed in a contract. Reaching a target net income is particularly important for a [[public company]](https://www.investopedia.com/terms/p/publiccompany.asp), since investors purchase the issuer’s [[Common Stock|common stock]] based on the expectation of earnings growth over time.

Outsourcing is used frequently to control costs because many businesses find it cheaper to pay a [[Third Party|third party]] to perform a task than to take on the work within the company.
...
If, for example, a toy manufacturer has a $50,000 [[Unfavorable Variance|unfavorable variance]] in the material expense account, the firm should consider obtaining bids from other material suppliers to lower costs and eliminate the variance moving forward. Some businesses analyze variances and take action on the actual costs that have the largest percentage difference from budgeted costs.
