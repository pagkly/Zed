...
-   It is typically measured using [[Gross Domestic Product (GDP)|gross domestic product (GDP)]] per capita.
...
-   One alternative standard of living data set is the Human Development Index (HDI), which uses many factors from [[Life Expectancy|life expectancy]] and education, to gross national income (GNI), and homicide rates.1
...
The U.S. scored seventeenth on the list, with a combined score of 0.926, a [[Life Expectancy|life expectancy]] at birth of 78.9 years, 16.3 expected years of schooling, and GNI per capita of $63,826.6
