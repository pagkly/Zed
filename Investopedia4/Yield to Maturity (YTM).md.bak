...
> ## Excerpt
> [[Yield to Maturity (YTM)|Yield to maturity (YTM)]] is the total [[Return|return]] expected on a bond if the bond is held until maturity.
...
[[Yield to Maturity (YTM)|Yield to maturity (YTM)]] is the total [[Return|return]] anticipated on a bond if the bond is held until it matures. [[Yield]] to maturity is considered a long-term [[bond yield]](https://www.investopedia.com/terms/b/bond-yield.asp) but is expressed as an annual rate. In other words, it is the [[internal rate of return (IRR)]](https://www.investopedia.com/terms/i/irr.asp) of an investment in a bond if the investor holds the bond until maturity, with all payments made as scheduled and reinvested at the same rate.
...
[[Yield]] to maturity is similar to [[current yield]](https://www.investopedia.com/terms/c/currentyield.asp), which divides annual cash inflows from a bond by the market price of that bond to determine how much money one would make by buying a bond and holding it for one year. Yet, unlike [[Current Yield|current yield]], YTM accounts for the [[present value]](https://www.investopedia.com/terms/p/presentvalue.asp) of a bond's future coupon payments. In other words, it factors in the [[time value of money]](https://www.investopedia.com/terms/t/timevalueofmoney.asp), whereas a simple current yield calculation does not. As such, it is often considered a more thorough means of calculating the [[Return|return]] from a bond.
...
Because [[Yield|yield]] to maturity is the [[interest rate]](https://www.investopedia.com/terms/i/interestrate.asp) an investor would earn by reinvesting every coupon payment from the bond at a constant interest rate until the bond's maturity date, the present value of all the future cash flows equals the bond's market price. An investor knows the current bond price, its coupon payments, and its maturity value, but the [[discount rate]](https://www.investopedia.com/terms/d/discountrate.asp) cannot be calculated directly. However, there is a trial-and-error method for finding YTM with the following present value formula:
...
Solving the equation by hand requires an understanding of the relationship between a bond's price and its [[Yield|yield]], as well as the different types of bond pricings. Bonds can be priced at a [[discount]](https://www.investopedia.com/terms/d/discount.asp), [[at par]](https://www.investopedia.com/terms/a/at-par.asp) or at a [[premium]](https://www.investopedia.com/terms/p/[[Premium|premium]].asp). When the bond is priced at par, the bond's interest rate is equal to its [[coupon rate]](https://www.investopedia.com/terms/c/coupon-rate.asp). A bond priced above par, called a premium bond, has a [[Coupon Rate|coupon rate]] higher than the realized interest rate and a bond priced below par, called a discount bond, has a coupon rate lower than the realized interest rate. If an investor were calculating YTM on a bond priced below par, they would solve the equation by plugging in various annual interest rates that were higher than the coupon rate until finding a bond price close to the price of the bond in question.

Calculations of [[yield to maturity (YTM) assume that all coupon]](https://www.investopedia.com/ask/answers/020215/what-difference-between-[[Yield|yield]]-maturity-and-coupon-rate.asp) payments are reinvested at the same rate as the bond's [[Current Yield|current yield]] and take into account the bond's current market price, par value, coupon interest rate, and [[term to maturity]](https://www.investopedia.com/terms/t/termtomaturity.asp). The YTM is merely a snapshot of the [[Return|return]] on a bond because coupon payments cannot always be reinvested at the same interest rate. As interest rates rise, the YTM [[Will|will]] increase; as interest rates fall, the YTM will decrease.

The complex process of determining [[Yield|yield]] to maturity means it is often difficult to calculate a precise YTM value. Instead, one can approximate YTM by using a bond yield table, financial calculator, or online yield to maturity calculator.

Although [[Yield|yield]] to maturity represents an annualized rate of [[Return|return]] on a bond, coupon payments are usually made on a semiannual basis, so YTM is calculated on a six-month basis as well. When calculating semiannual payments the formulas mentioned previously would need to be slightly modified to calculate the YTM correctly. The correct formula for estimating YTM would be as follows:
...
For example, say an investor currently holds a bond whose par value is $100. The bond is currently priced at a discount of $95.92, matures in 30 months, and pays a semi-annual coupon of 5%. Therefore, the [[Current Yield|current yield]] of the bond is (5% coupon x $100 par value) / $95.92 market price = 5.21%.
...
[Yield to maturity](https://www.investopedia.com/ask/answers/020215/what-difference-between-[[Yield|yield]]-maturity-and-spot-rate.asp) can be quite useful for estimating whether buying a bond is a good investment. An investor [[Will|will]] determine a required yield (the [[Return|return]] on a bond that will make the bond worthwhile). Once an investor has determined the YTM of a bond they are considering buying, the investor can compare the YTM with the required yield to determine if the bond is a good buy.
...
[[Yield]] to maturity has a few common variations that account for bonds that have embedded [[options]](https://www.investopedia.com/terms/o/option.asp).

[Yield to call](https://www.investopedia.com/ask/answers/012615/what-difference-between-[[Yield|yield]]-maturity-and-yield-call.asp) (YTC) assumes that the bond [[Will|will]] be called. That is, a bond is repurchased by the [[issuer]](https://www.investopedia.com/terms/i/issuer.asp) before it reaches maturity and thus has a shorter [[Cash Flow|cash flow]] period. YTC is calculated with the assumption that the bond will be called at soon as it is possible and financially feasible.

[[Yield]] to put (YTP) is similar to YTC, except the holder of a [[put bond]](https://www.investopedia.com/terms/p/putbond.asp) can choose to sell the bond back to the issuer at a fixed price based on the terms of the bond. YTP is calculated based on the assumption that the bond [[Will|will]] be put back to the issuer as soon as it is possible and financially feasible.

[Yield to worst](https://www.investopedia.com/terms/[[Y|y]]/yieldtoworst.asp) (YTW) is a calculation used when a bond has multiple options. For example, if an investor was evaluating a bond with both call and put provisions, they would calculate the YTW based on the option terms that give the lowest [[Yield|yield]].

## Limitations of [[Yield to Maturity (YTM)]]

YTM calculations usually do not account for taxes that an investor pays on the bond. In this case, YTM is known as the gross redemption [[Yield|yield]]. YTM calculations also do not account for purchasing or selling costs.
...
A bond's [[Yield to Maturity (YTM)|yield to maturity (YTM)]] is the internal rate of [[Return|return]] required for the present value of all the future cash flows of the bond (face value and coupon payments) to equal the current bond price. YTM assumes that all coupon payments are reinvested at a [[Yield|yield]] equal to the YTM and that the bond is held to maturity.

Some of the more known bond investments include municipal, treasury, corporate, and foreign. While municipal, treasury, and foreign bonds are typically acquired through local, state, or federal governments, corporate bonds are purchased through brokerages. If you have an interest in corporate bonds then you [[Will|will]] need a [[brokerage account]](https://www.investopedia.com/best-online-brokers-4587872).

## Frequently Asked Questions

### What is a bond’s [[Yield to Maturity (YTM)]]?

The YTM of a bond is essentially the [[internal rate of return (IRR)]](https://www.investopedia.com/terms/i/irr.asp) associated with buying that bond and holding it until its maturity date. In other words, it is the [[Return|return]] on investment associated with buying the bond and reinvesting its coupon payments at a constant interest rate. All else being equal, the YTM of a bond [[Will|will]] be higher if the price paid for the bond is lower, and vice-versa.

### What is the difference between a bond’s YTM and its [[Coupon Rate|coupon rate]]?

The main difference between the YTM of a bond and its [[Coupon Rate|coupon rate]] is that the coupon rate is fixed whereas the YTM fluctuates over time. The coupon rate is contractually fixed, whereas the YTM changes based on the price paid for the bond as well as the interest rates available elsewhere in the marketplace. If the YTM is higher than the coupon rate, this suggests that the bond is being sold at a discount to its par value. If on the other hand the YTM is lower than the coupon rate, then the bond is being sold at a [[Premium|premium]].

### Is it better to have a higher YTM?

Whether or not a higher YTM is positive depends on the specific circumstances. On the one hand, a higher YTM might indicate that a bargain opportunity is available, since the bond in question is available for less than its par value. But the key question is whether or not this discount is justified by [[Fundamentals|fundamentals]] such as the [[Creditworthiness|creditworthiness]] of the company issuing the bond, or the interest rates presented by alternative investments. As is often the case in investing, further due diligence would be required.
