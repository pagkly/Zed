...
The straight line depreciation for this piece of equipment is ($10,500 - $500) / 10 = $1,000. This means that instead of [writing off](https://www.investopedia.com/terms/w/[[Write-Off|write-off]].asp) the full cost of the equipment in the current period, the company only needs to expense $1,000. The company [[Will|will]] continue to expense $1,000 to a [contra account](https://www.investopedia.com/terms/c/contraaccount.asp), referred to as [accumulated depreciation](https://www.investopedia.com/terms/a/accumulated-depreciation.asp), until $500 is left on the books as the value of the equipment.
...
However, the simplicity of straight line basis is also one of its biggest drawbacks. One of the most obvious pitfalls of using this method is that the [[Useful Life|useful life]] calculation is based on guesswork. For example, there is always a [[Risk|risk]] that technological advancements could potentially render the asset obsolete earlier than expected. Moreover, the straight line basis does not factor in the accelerated loss of an asset’s value in the short-term, nor the likelihood that it [[Will|will]] cost more to maintain as it gets older.
