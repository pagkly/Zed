...
source: https://www.investopedia.com/terms/[[Z|z]]/zero-coupon-cd.asp
author: James Chen
---
...
> ## Excerpt
> A [[Zero-Coupon Certificate of Deposit (CD)|zero-coupon certificate of deposit (CD)]] is purchased at a discounted rate and does not pay out interest yearly but as a lump sum at maturity.
...
Zero-coupon CDs are a minimum-[[Risk|risk]] tool for investing and saving. They are generally a good fit for conservative, risk-averse investors for whom generating [[Cash Flow|cash flow]] or ongoing income is not a priority.
...
-   As with other types of CDs, these are low-[[Risk|risk]] investment tools.
...
-   The main disadvantage of zero-coupon CDs is the treatment of interest from a tax perspective. Annual interest income is considered [taxable income](https://www.investopedia.com/ask/answers/070915/what-difference-between-taxable-income-and-gross-income.asp). The taxable status means it [[Will|will]] affect the holder’s [[Tax Liability|tax liability]] throughout the term of the CD, with tax payable every year on the accrued interest. Even though the price of the CD is discounted to far below par to make the purchase enticing, the buyer must be aware of yearly tax obligations. 
-   Zero-coupon CDs are sold mainly through brokerage firms, so the buyer [[Will|will]] likely incur broker fees.
-   Some zero-coupon CDs are [[callable]](https://www.investopedia.com/terms/c/callable-[[Security|security]].asp), meaning they can be called back by the issuing bank prior to maturity and then [[reissued at a current lower interest rate]](https://www.investopedia.com/articles/bonds/07/callable_cd.asp).
-   Zero-coupon CDs provide no steady, ongoing income, as the holder must wait until the time of maturity for the [[Payout|payout]].
