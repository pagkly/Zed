...
The vacancy rate is the percentage of all available units in a [[rental property]](https://www.investopedia.com/articles/mortgages-real-[[Estate|estate]]/11/how-to-value-real-estate-rental.asp), such as a hotel or apartment complex, that are vacant or unoccupied at a particular time.

A vacancy rate is the opposite of the [[occupancy rate]](https://www.investopedia.com/terms/o/occupancy-rate.asp), which is the percentage of units in a rental property that are occupied. High vacancy rates indicate that a property is not renting well while low vacancy rates can point to strong [[rental sales]](https://www.investopedia.com/articles/personal-[[Finance|finance]]/121415/how-prevent-tax-hit-when-selling-rental-property.asp).

In addition to being used for real [[Estate|estate]] analysis, vacancy rates can also be applied to the employment sector.
...
In real [[Estate|estate]], the vacancy rate most often represents units that are vacant and ready to be rented, units that have been turned off upon the exit of a tenant, and units that are not currently rentable because they are in need of repairs or renovations. Low vacancy rates are considered positive because it generally means people want to live in a particular area or building, while higher rates mean the opposite.
...
The U.S. Census Bureau also collects data for the quarterly report regarding rental prices and property information. Much like data for commercial property markets, this information can be used—in conjunction with other information—to help determine the health of an economy's residential real [[Estate|estate]] market by examining changes in the number of units available and the average prices of available or occupied units.

## Investors and Vacancy Rates

As noted above, vacancy rates play a big part in business and can help investors determine whether they're making a good move by putting their money into certain real [[Estate|estate]] deals.
