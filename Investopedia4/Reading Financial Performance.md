...
There are many ways to measure financial performance, but all measures should be taken in aggregate. Line items, such as revenue from operations, [[operating income]](https://www.investopedia.com/terms/o/operatingincome.asp), or [[Cash Flow|cash flow]] from operations can be used, as well as total unit sales. Furthermore, the analyst or investor may wish to look deeper into financial statements and seek out margin [[Growth Rates|growth rates]] or any declining [[Debt|debt]]. [[Six Sigma]](https://www.investopedia.com/articles/investing/102014/guide-six-sigma-black-belt.asp) methods focus on this aspect.
...
The [[balance sheet]](https://www.investopedia.com/terms/b/balancesheet.asp) is a snapshot of the financial balances of an organization. It provides an overview of how well the company manages its assets and liabilities. Analysts can find information about long-term vs. short-term [[Debt|debt]] on the balance sheet. They can also find information about what kind of assets the company owns and what percentage of assets are financed with liabilities vs. stockholders' [[Equity|equity]].

### Income Statement

The [[income statement]](https://www.investopedia.com/terms/i/incomestatement.asp) provides a summary of operations for the entire year. The income statement starts with sales or revenues and ends with net income. Also referred to as the profit and loss statement, the income statement provides the gross [[Profit Margin|profit margin]], the cost of goods sold, [[Operating Profit|operating profit]] margin, and net profit margin. It also provides an overview of the number of [[Shares|shares]] outstanding, as well as a comparison against performance the prior year.
...
The [[Cash Flow Statement|cash flow statement]] is a combination of both the income statement and the balance sheet. For some analysts, the [[Cash Flow|cash flow]] statement is the most important financial statement because it provides a reconciliation between net income and cash flow. This is where analysts see how much the company spent on [[Stock|stock]] repurchases, dividends, and [[capital expenditures]](https://www.investopedia.com/terms/c/capitalexpenditure.asp). It also provides the source and uses of cash flow from operations, investing, and financing.
