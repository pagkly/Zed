...
-   The benefits administered include [[Social Security|social security]] retirement income and disability income programs, among others.
...
The SSA has seen numerous name changes and operational revisions in its lifetime as different administrations have shaped the agency. The SSA provides a wide range of services, including determining citizen eligibility and [[Premium|premium]] payments for the [[Medicare]](https://www.investopedia.com/terms/m/medicare.asp) program.6 It administers the granting of [[Social Security numbers]](https://www.investopedia.com/terms/s/ssn.asp) (SSN), which have become a de-facto national identity number that must be provided to access a number of services such as credit, insurance coverage, and even hunting licenses.7
...
By 2020, [[Social Security]]'s program costs [[Will|will]] exceed its income, at which point the program will have to start dipping into its nearly $3 trillion trust fund. The Old-Age and Survivors Insurance (OASI) Trust Fund is projected to be depleted by 2035; the Disability Insurance (DI) Trust Fund is projected for depletion by 2052.8
