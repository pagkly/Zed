...
> ## Excerpt
> [[Marginal Social Cost (MSC)|Marginal social cost (MSC)]] is the total cost to society as a whole for producing one further unit, or taking one further action, in an economy.
...
When determining the marginal social cost, both fixed and variable costs must be accounted for. Fixed costs are those that don’t fluctuate — such as salaries, or startup costs. Variable costs, on the other hand, change. For example, a [[Variable Cost|variable cost]] could be a cost that changes based on production volume.
