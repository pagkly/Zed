...
> ## Excerpt
> A [[Loan|loan]] production office is an administrative division of a bank that is permitted to provide loan-related information and accept loan applications.
...
-   The LPO can do the research necessary for considering a [[Loan|loan]], and can even suggest whether the loan should be approved or rejected, but then must forward the application to the bank for a final decision. 

## How a [[Loan]] Production Office Works

Located on the bank's premises or at another location, the [[Loan|loan]] production office reviews, and process loan applications, checking for [[underwriting]](https://www.investopedia.com/terms/u/underwriting.asp) standard compliance and completeness of documents. It most often deals with residential mortgages, but services other sorts of loans as well.

An LPO processor or underwriter performs these support duties: the receipt, collection, distribution, and analysis of information required for the processing or underwriting of a [[Loan|loan]]. Also, the LPO processor communicates with applicants to obtain the information necessary for these activities. Other roles in an LPO include loan production leader, loan specialist, operations supervisor, and customer service coordinator.

An LPO can provide clients with educational information about mortgages and loans, either proprietary materials from its parent bank or general ones from a government agency. However, LPO processors may not [[Offer|offer]] or negotiate [[Loan|loan]] rates or terms, nor may they counsel consumers about residential mortgage loan rates or terms.

Once it has finished gathering and analyzing all the data, the [[Loan|loan]] production office then forwards the application to the bank itself for a final decision. The senior processor of the LPO may recommend the approval of an application, but the actual decision should be from the [[Home Office|home office]] or a branch.

If the [[Loan|loan]] is approved, the LPO may also be in charge of delivering the bank's check or funds to the borrower or their account.

A [[Loan|loan]] production office can only act in a branch capacity, providing full loan servicing, if the bank successfully petitions the state banking commissioner for permission.

## Special Considerations for [[Loan]] Production Office

Because it is not a full branch of the bank, the [[Loan|loan]] production office is not required to post [[Federal Deposit Insurance Corporation]](https://www.investopedia.com/terms/f/fdic.asp) (FDIC) or [Availability of Funds and Collection of Checks](https://www.investopedia.com/terms/r/regulation-cc.asp) ([[Regulation CC]]) policies or signage. However, the office should display an Equal Housing [[Lender]] poster, which is a requirement wherever deposits are received or loans made.

## LPO vs. [[Loan]] Servicer

Although they both provide financing support services, an LPO is not the same as a [[Loan|loan]] servicer. In act, the two operate at different ends of the process. LPOs may only administer the process from application to [[Disbursement|disbursement]] of a loan. In contrast, from the time the proceeds of a loan are dispersed until the loan is paid off, the loan servicer administers it.

The confusion often arises because loans are often serviced nowadays by third parties separate from the institution that issued them. Traditionally [[Loan|loan]] servicing was a core function carried out by and housed within, banks. Today the duties may be done by a non-bank entity specializing in loan servicing or a sub-servicer who operates as a third-party vendor for lending institutions.
