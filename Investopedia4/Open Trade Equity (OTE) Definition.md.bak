...
> ## Excerpt
> Open Trade [[Equity]] (OTE) is the net of [[Unrealized Gain|unrealized gain]] or loss on open contract positions.
...
OTE is especially important for [[margin]](https://www.investopedia.com/terms/m/margin.asp) investors as fluctuations impact the available [[Equity|equity]] in their account. If the unrealized losses cause the available equity to drop below their contracted [[maintenance margin]](https://www.investopedia.com/terms/m/maintenancemargin.asp) then a [[margin call]](https://www.investopedia.com/terms/m/margincall.asp) is issued where the investor is forced to deposit additional funds to bring the available equity back above the contracted maintenance margin or [[Liquidate|liquidate]] all or a portion of their open positions.

> Total [[Equity]] = Account Balance ± Open Trade Equity

Because maintenance margins are contracted with a broker, investors are legally bound to maintain their margins. In the event an investor is unable or unwilling to deposit cash or sell [[Holdings|holdings]] at the time of a [[Margin Call|margin call]], their brokerage is empowered to close open positions from their client’s [[Portfolio|portfolio]] at their discretion in order to restore the account to its minimum value.

If she does not [[Liquidate|liquidate]] the position and the price drops to $100, Alice now has a $5,000 [[unrealized loss]](https://www.investopedia.com/terms/u/unrealizedloss.asp) on that holding. Unless Alice sells, or closes, that open position, this loss remains unrealized but her OTE is ($5,000) and the total account [[Equity|equity]] is down to $5,000. A negative OTE indicates a [[paper loss]](https://www.investopedia.com/terms/p/paperprofitorloss.asp); a positive OTE shows a paper [[Gain|gain]].
...
For instance, if Alice has $10,000 in her account and uses it to purchase 50 [[Shares|shares]] of XYZ at $200 per share. Her total investment is $10,000 and her OTE at the instance of the trade being executed is zero. The next day the value of each share increases to $250. Now Alice has $2,500 in [[unrealized gain]](https://www.investopedia.com/terms/u/unrealizedgain.asp) in that trade which means that the OTE for that holding is also up $2500 and the total [[Equity|equity]] in the account is up to $12,500. If she were to [[Liquidate|liquidate]] this position then the gains are said to have been realized, the account balance would have increased by $2,500 to $12,500 and the OTE would be zero.
...
For instance, an investor wants to buy 500 [[Shares|shares]] of a [[Stock|stock]] trading at $20 / share. He doesn't have the $10,000 needed to do this so he opens a $5,000 account with a broker who has a 50% initial margin and a 35% maintenance margin requirement. Investor purchases $10,000 worth of shares which means that he has borrowed $5,000 from the broker. At the instance of execution, the OTE is zero, total value of investment is $10,000, initial margin is $5,000 (50% \* $10,000) and the maintenance margin is $3,500 (35% \* $10,000).

The price begins to decline to where the total value of 500 [[Shares|shares]] falls to $6,000, which means that the OTE is ($4,000). The $5,000 that the investor put up as margin is now worth $3,000 ($5,000 - 50% \* $4,000). This is below the $3,500 maintenance margin requirement so the investor receives a [[Margin Call|margin call]].

At this point, the investor [[Will|will]] be required to make a deposit into the margin account to satisfy the 50% requirement, in this case $2,000. This can take the form of a cash deposit or marginable securities. They may also choose to take a loss on the investment by liquidating all or a portion of their open positions thereby reducing their margin requirements. This usually results in realizing a loss on their trade.
