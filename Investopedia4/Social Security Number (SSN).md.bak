...
> ## Excerpt
> A [[Social Security Number (SSN)|Social Security number (SSN)]] is a numerical identifier assigned to U.S. citizens and some residents to track their income and determine benefits.
...
A [[Social Security]] number (and card) may be obtained by filling out Form SS-5 (Application for a Social [[Security]] Card) from the Social Security Administration. The form covers obtaining an original card, replacing a card, and changing or correcting SSN records. A full list of requirements (such as documentation that proves age, identity, and U.S. citizenship/immigration status) are [[Listed|listed]] in the form.6 There is no cost for [[obtaining a card]](https://www.ssa.gov/forms/) or number. In some circumstances, an individual may [[change their Social Security number]](https://www.investopedia.com/ask/answers/082715/why-would-someone-change-their-social-security-number.asp).
