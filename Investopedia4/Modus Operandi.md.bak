...
> ## Excerpt
> [[Modus Operandi|Modus operandi]] is a Latin term used in English to describe an individual or group's habitual way of operating.
...
[[Modus Operandi|Modus operandi]] is a Latin term used in English-speaking circles to describe an individual's or group's habitual way of operating, which forms a discernible pattern. The term is primarily used when discussing [[criminal behavior]](https://www.investopedia.com/terms/w/white-collar-crime.asp), but it is not exclusively uttered in this context. Modus operandi can also be defined as a specific method of operation.

For example, military strategists refer to an enemy's [[Modus Operandi|modus operandi]] when predicting the next threatening move in an armed conflict. Synonymous with the term "operating mode," modus operandi is routinely shortened to the initials "M.O.," in both written and verbal usage.

### Key Takeaways

-   The term "[[Modus Operandi|modus operandi]]" is a Latin term that describes an individual or group's habitual way of operating, which represents a discernible pattern.
-   A [[Modus Operandi|modus operandi]] (commonly abbreviated as "M.O.") is mainly used to discuss criminal behavior and is often used by professionals to prevent future crimes.
...
Predictive profiling's logical conclusion is the prevention of a crime. Undercover [[Security|security]] forces may confront criminal personalities at locations far from their houses to gather more information. If someone who poses a threat comes face to face with an authoritarian figure, they may become too scared to execute their intended criminal activity.
