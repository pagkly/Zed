---
alias: [Macroeconomic Factor]
created: 2021-03-02T21:52:30 (UTC +11:00)
tags: [Macroeconomic Factor Definition, Understanding Macroeconomic Factors]
source: https://www.investopedia.com/terms/m/macroeconomic-factor.asp
...
> ## Excerpt
> A macroeconomic factor is one that is related to the broad economy at the regional or national level such as national [[Productivity|productivity]] or interest rates.
...
-   The relationships between various macroeconomic factors are extensively studied in the field of [[Macroeconomics|macroeconomics]].
-   Examples of macroeconomic factors include economic outputs, [[Unemployment|unemployment]] rates, and inflation.

## Real World Example

Diseases can also be defined as macroeconomic factors. Case in point: after the [2014 Ebola virus struck West Africa](http://www.worldbank.org/en/topic/[[Macroeconomics|macroeconomics]]/brief/macroeconomic-policy), the [[World Bank Group]]’s Macroeconomics and [[Fiscal Policy]] Global Practice (MFM) stepped in to help support local governments in combating the virus.
