...
> ## Excerpt
> The Ulcer Index is a technical indicator that measures downside [[Risk|risk]] in terms of both depth and duration of price declines.
...
The greater the value of the Ulcer Index, the longer it takes for a [[Stock|stock]] to get back to the former high. Simply stated, it is designed as one measure of [[Volatility|volatility]] only on the downside.

## Understanding Ulcer Index (UI)

The Ulcer Index was developed by Peter Marin and Byron McCann in 1987 for analyzing mutual funds. Marin and McCann first published it in their 1989 book, _The Investor's Guide to Fidelity Funds_. The indicator looks only at downside [[Risk|risk]], not overall [[Volatility|volatility]]. [[Other volatility measures]](https://www.investopedia.com/articles/basics/09/simplified-measuring-interpreting-volatility.asp), like [[Standard Deviation|standard deviation]], treat up and down movement equally, but a trader typically does not mind upward movement; it is the downside that causes stress and stomach ulcers, as the index's name suggests.
...
Martin recommends the Ulcer Index as a measure of [[Risk|risk]] in various contexts where the [[standard deviation]](https://www.investopedia.com/terms/s/standarddeviation.asp) is usually used. The Ulcer Index can also be charted over time and used as a kind of [[Technical Analysis|technical analysis]] indicator, to show [[Stocks|stocks]] going into ulcer-forming territory, or to compare [[Volatility|volatility]] in different stocks.

Investors can use the Ulcer Index to compare different investment options. A lower average Ulcer Index means lower drawdown [[Risk|risk]] compared with an investment with a higher average UI. Applying a moving average to the Ulcer Index [[Will|will]] show which [[Stocks|stocks]] and funds have lower [[Volatility|volatility]] overall.

Watching for spikes in the Ulcer Index that are beyond "normal" can also be used to indicate times of excessive downside [[Risk|risk]], which investors may wish to avoid by exiting long positions.
