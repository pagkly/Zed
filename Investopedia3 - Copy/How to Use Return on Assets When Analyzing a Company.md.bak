...
-   ROA takes into account a company’s debt, unlike other similar metrics like Return on Equity (ROE).
...
ROA is [calculated](https://www.investopedia.com/ask/answers/031215/what-formula-calculating-return-assets-roa.asp) by dividing a company’s [net income](https://www.investopedia.com/terms/n/netincome.asp) by total assets. As a formula, it would be expressed as:
...
Return on assets (ROA), in basic terms, tells you what earnings were generated from [invested capital](https://www.investopedia.com/terms/i/invested-capital.asp) (assets). ROA for public companies can vary substantially and will be highly dependent on the industry. This is why when using ROA as a comparative measure, it is best to compare it against a company's previous ROA numbers or a similar company's ROA.
...
In other words, the impact of taking more debt is negated by adding back the cost of borrowing to the [net income](https://www.investopedia.com/terms/n/netincome.asp) and using the average assets in a given period as the denominator. Interest expense is added because the net income amount on the income statement excludes interest expense.

## Example of How to Use Return on Assets

ROA is most useful for comparing companies in the same industry, as different industries use assets differently. For example, the ROA for service-oriented firms, such as banks, will be significantly higher than the ROA for [capital-intensive](https://www.investopedia.com/terms/c/capitalintensive.asp) companies, such as construction or utility companies.
...
The biggest issue with return on assets (ROA) is that it can't be used across industries. That’s because companies in one industry—such as the technology industry—and another industry like oil drillers will have different [asset bases](https://www.investopedia.com/terms/a/asset-base.asp).
