...
The Law of Supply and Demand is important because it helps investors, entrepreneurs, and economists to understand and predict conditions in the market. For example, a company that is launching a new product might deliberately try to raise the price of their product by increasing consumer demand through advertising. At the same time, they might try to further increase their price by deliberately restricting the number of units they sell, in order to decrease supply. In this scenario, supply would be minimized while demand would be maximized, leading a higher price.
