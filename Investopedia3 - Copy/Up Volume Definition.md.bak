...
-   Up volume is the circumstance where the price of a security rises, also accompanied by high or increasing trading volume.
...
[PVI](https://www.investopedia.com/terms/p/pvi.asp): If current volume is greater than the previous day's volume, PVI = Previous PVI + {\[(Today's Closing Price-Yesterday's Closing Price)/Yesterday's Closing Price)\] x Previous PVI}. If current volume is lower than the previous day's volume, PVI is unchanged.

[NVI](https://www.investopedia.com/terms/n/nvi.asp): If current volume is less than the previous day’s volume, NVI = Previous NVI + {\[(Today's Closing Price-Yesterday's Closing Price)/Yesterday's Closing Price)\] x Previous NVI}. If current volume is higher than the previous day's volume, NVI is unchanged.
