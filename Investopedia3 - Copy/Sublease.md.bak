...
source: https://www.investopedia.com/terms/s/sublease.asp
author: James Chen
---
...
Because a lease is generally for a predefined term, situations can arise that make it difficult or impossible for the original tenant to complete the lease term. For example, if a tenant is renting an apartment in Chicago with a 12-month lease and in month four that tenant receives a job offer in Boston, the tenant may decide to sublease the apartment to another tenant for the remaining eight months. The sublease means that the original tenant can accept the job and move and does not have to pay expensive fees to get out of the lease or pay rent on two apartments.
