...
tags: [Mode Definition, Mode Definition]
...
A set of numbers can have more than one mode (this is known as _bimodal_ if there are two modes) if there are multiple numbers that occur with equal frequency, and more times than the others in the set.
