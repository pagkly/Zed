...
A reverse stock split is a type of [[corporate action]](https://www.investopedia.com/terms/c/corporateaction.asp) that consolidates the number of existing shares of stock into fewer, proportionally more valuable, shares. Reducing the total number of [[outstanding shares]](https://www.investopedia.com/terms/o/outstandingshares.asp) in the open market can be pursued for a number of reasons, and often signals a company in distress.
...
Reverse stock splits are proposed by company management and are subject to consent from the [[shareholders]](https://www.investopedia.com/terms/s/shareholder.asp) through their [[voting rights]](https://www.investopedia.com/terms/v/votingright.asp).
...
The proportionate change in share price also supports the fact that the company has not created any real value simply by performing the reverse stock split. Its overall value, represented by [[market capitalization]](https://www.investopedia.com/terms/m/marketcapitalization.asp), before and after the corporate action should remain the same.

-   _Earlier Market Cap_ = Earlier no. of total shares \* earlier price per share = 10 million \* $5 = $50 million
-   _New Market Cap_ = New no. of total shares \* new price per share = 2 million \* $25 = $50 million
...
In April 2002, the largest communications company in the U.S., AT&T Inc. ([T](https://www.investopedia.com/markets/quote?tvwidgetsymbol=t)), announced that it was planning a 1-for-5 reverse stock split, in addition to plans of spinning off its cable TV division and merging it with Comcast Corp. ([CMCSA](https://www.investopedia.com/markets/quote?tvwidgetsymbol=cmcsa)). The corporate action was planned as AT&T feared that the spinoff could lead to a significant decline in its share price and could impact liquidity, business, and its ability to raise capital.34
...
Reverse splits are usually done when the share prices falls too low, putting it at risk for de-listing from an exchange for not meeting certain minimum price requirements. Having a higher share price can also attract certain investors who would not consider penny stocks for their portfolios.
