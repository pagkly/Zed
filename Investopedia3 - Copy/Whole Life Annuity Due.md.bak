...
[Annuities](https://www.investopedia.com/terms/a/annuity.asp) are financial products that are often purchased as part of a retirement plan to ensure income during the retirement years. Investors make payments into the annuity, and then, upon [annuitization](https://www.investopedia.com/terms/a/annuitization.asp), the annuitant will receive regular payments.
...
Thus, if you receive a $100,000 lump sum payout today, you'll want to compare that with receiving a stream of payments over many years. Which is worth more depends on a number of factors such as the implied [interest rate](https://www.investopedia.com/terms/i/interestrate.asp) or [discount rate](https://www.investopedia.com/terms/d/discountrate.asp) of the payments, the risk and return of investing the lump sum, and your need for immediate cash.

[Lump sum payments](https://www.investopedia.com/terms/l/lump-sum-payment.asp) open you to risk. If the money is invested aggressively, you could earn outsized returns beyond what the periodic payments could provide, or you could lose it all if the markets or your investments sour. You might also be forced or tempted to spend all of a lump sum, leaving you with nothing. It's the reason many people opt for periodic payments when given the chance. In addition, there are tax consequences tied to each method.
