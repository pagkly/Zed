...
> ## Excerpt
> Reflexivity is George Soros' theory that positive feedback between prices, expectations, and economic fundamentals prevents economic equilibrium.
...
Reflexivity in economics is the theory that a feedback loop exists in which investors' perceptions affect economic fundamentals, which in turn changes investor perception. The theory of reflexivity has its roots in sociology, but in the world of economics and finance, its primary proponent is [George Soros](https://www.investopedia.com/terms/g/soros.asp). Soros believes that reflexivity disproves much of mainstream economic theory and should become a major focus of economic research, and even makes grandiose claims that it "gives rise to a new morality as well as a new epistemology."
