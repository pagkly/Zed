...
Monte Carlo simulations are used to model the probability of different outcomes in a process that cannot easily be predicted due to the intervention of [random variables](https://www.investopedia.com/terms/r/random-variable.asp). It is a technique used to understand the impact of risk and uncertainty in prediction and forecasting models.
...
[Telecoms](https://www.investopedia.com/ask/answers/070815/what-telecommunications-sector.asp) use them to assess network performance in different scenarios, helping them to optimize the network. Analysts use them to assess the risk that an entity will default, and to analyze [derivatives](https://www.investopedia.com/terms/d/derivative.asp) such as [options](https://www.investopedia.com/terms/o/option.asp).
...
One way to employ a Monte Carlo simulation is to model possible movements of asset prices [using Excel](https://www.investopedia.com/articles/investing/093015/create-monte-carlo-simulation-using-excel.asp) or a similar program. There are two components to an asset's price movement: drift, which is a constant directional movement, and a random input, which represents market [volatility](https://www.investopedia.com/terms/v/volatility.asp).
...
To take _e_ to a given power _x_ in Excel, use the EXP function: EXP(x). Repeat this calculation the desired number of times (each repetition represents one day) to obtain a simulation of future price movement. By generating an arbitrary number of simulations, you can assess the probability that a security's price will follow a given trajectory.

Here is an example, showing around 30 projections for Time Warner Inc's stock for a portion of November 2015:

The frequencies of different outcomes generated by this simulation will form a [normal distribution](https://www.investopedia.com/terms/n/normaldistribution.asp), that is, a [bell curve](https://www.investopedia.com/terms/b/bell-curve.asp). The most likely return is in the middle of the curve, meaning there is an equal chance that the actual return will be higher or lower than that value.
