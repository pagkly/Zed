---
alias: [Mean-Variance Analysis]
created: 2021-03-02T22:01:11 (UTC +11:00)
tags: [Mean-Variance Analysis Definition, Mean-Variance Analysis]
...
> ## Excerpt
> Mean-variance analysis is the process of weighing risk against expected return.
...
-   The variance shows how spread out the returns of a specific [security](https://www.investopedia.com/terms/s/security.asp) are on a daily or weekly basis. 
...
Mean-variance analysis is one part of [modern portfolio theory](https://www.investopedia.com/terms/m/modernportfoliotheory.asp), which assumes that investors will make rational decisions about investments if they have complete information. One assumption is that investors seek low risk and high reward. There are two main components tof mean-variance analysis: variance and expected return. [Variance](https://www.investopedia.com/terms/v/variance.asp) is a number that represents how varied or spread out the numbers are in a set. For example, variance may tell how spread out the returns of a specific [security](https://www.investopedia.com/terms/s/security.asp) are on a daily or weekly basis. The expected return is a probability expressing the estimated return of the investment in the security. If two different securities have the same expected return, but one has lower variance, the one with lower variance is the better pick. Similarly, if two different securities have approximately the same variance, the one with the higher return is the better pick.

In [modern portfolio theory](https://www.investopedia.com/terms/m/modernportfoliotheory.asp), an investor would choose different securities to invest in with different levels of variance and expected return. The goal of this strategy is to differentiate investments, which reduces the risk of catastrophic loss in the event of rapidly changing market conditions.
