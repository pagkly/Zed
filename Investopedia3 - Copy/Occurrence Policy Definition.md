...
[Liability insurance](https://www.investopedia.com/terms/l/liability_insurance.asp) policies generally fall into one of two categories: [Claims-made](https://www.investopedia.com/terms/c/claimsmade-policy.asp) or occurrence. The latter offers protection against financial loss on incidents that happened while the policy was in effect, regardless of when they're flagged and became apparent. In other words, it's possible to file a claim later, long after the contract has expired, provided there's evidence that its cause or triggering event took place during the period the insurance was active.
...
Claims-made policies are used to cover the risks associated with business operations, such as the potential for mistakes associated with errors and omissions in [financial statements](https://www.investopedia.com/terms/f/financial-statements.asp). They are also applied to cover businesses from claims made by employees, including wrongful termination, sexual harassment, and discrimination allegations. This type of liability is referred to as [employment practices liability](https://www.investopedia.com/terms/e/employers-liability-insurance.asp) (EPLI), and might also cover the actions of directors and officers of the business.
...
Another advantage is that occurrence policy costs tend to be fixed. [Premiums](https://www.investopedia.com/terms/i/insurance-premium.asp) generally don’t increase unless the [risk profile](https://www.investopedia.com/terms/r/risk-profile.asp) of the insured changes.
