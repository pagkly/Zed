...
Rolling returns, also known as "rolling period returns" or "rolling time periods," are annualized [[average returns]](https://www.investopedia.com/terms/a/averagereturn.asp) for a period, ending with the listed year. Rolling returns are useful for examining the behavior of returns for [[holding periods]](https://www.investopedia.com/terms/h/holdingperiod.asp), similar to those actually experienced by investors.
...
A common rolling return period is [[trailing 12 months]](https://www.investopedia.com/terms/t/ttm.asp) (TTM). Trailing 12 months is the term for the data from the past 12 consecutive months used for reporting financial figures. A company's trailing 12 months represents its financial performance for a 12-month period; it does not typically represent a [fiscal-year ending period](https://www.investopedia.com/terms/f/fiscalyearend.asp).

Using trailing 12-month (TTM) returns is an effective way to analyze the most recent financial data in an annualized format. Annualized data is important because it helps neutralize the effects of [seasonality](https://www.investopedia.com/terms/s/seasonality.asp) and dilutes the impact of non-recurring abnormalities in financial results, such as temporary changes in demand, expenses, or cash flow.
