---
created: 2021-02-27T22:20:22 (UTC +11:00)
tags: []
source: https://docs.microsoft.com/en-us/learn/modules/csharp-write-first/3-how-it-works
author: bobtabor-msft
---

# How it works - Learn | Microsoft Docs

> ## Excerpt
> Why does the exercise code work?  What do those words and symbols mean?
...
At this point, the code can be updated and changed by a software developer, but the computer can't understand the code. It first must be _compiled_ into a format that the computer can understand.
...
Why do we need to compile our code? Even though most programming languages seem cryptic at first, they can be more easily understood by humans than the computer's _preferred_ language, which is expressed by turning thousands or millions of tiny switches either on or off. Compilers bridge these two worlds by translating your human-readable instructions into a computer-understandable set of instructions.
...
There was also a dot, or period, that separated the class name `Console` and the method name `WriteLine()`. The period is the _member access operator_. In other words, the dot is how you "navigate" from the class to one of its methods.

Finally, the semi-colon is the _end of statement operator_. A **statement** is a complete instruction in C#. The semi-colon tells the compiler that we're finished entering the command.
...
-   Use the correct _punctuation_ because they have a special role in C#
